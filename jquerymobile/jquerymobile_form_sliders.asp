...
<HTML lang=zh-cn><HEAD><TITLE>jQuery Mobile 表单 - 滑块</TITLE>
<META charset=gbk>
...
<UL>
  ...
  <LI class=currentLink><A title="jQuery Mobile 表单 - 滑块" 
...
<DIV id=maincontent>
<H1>jQuery Mobile 表单 - 滑块</H1>
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 表单 - 选择" 
  href="jquerymobile_form_select.asp">jQuery Mobile 表单选择</A> </LI>
  <LI class=next><A title="jQuery Mobile 主题" 
  href="jquerymobile_themes.asp">jQuery Mobile 主题</A> </LI></UL></DIV>
<DIV>
<H2>jQuery Mobile 滑块控件</H2>
<P>滑块允许您从一定范围内的数字中选取值：</P><IFRAME height=70 src="tjm_slider.html" frameBorder=0 
width="100%" scrolling=no></IFRAME>
<P>如需创建滑块，请使用 &lt;input type="range"&gt;：</P>
<H3>实例</H3><PRE>&lt;form method="post" action="demoform.asp"&gt;
  &lt;div data-role="fieldcontain"&gt;
    &lt;label for="points"&gt;Points:&lt;/label&gt;
    &lt;input <SPAN class=marked>type="range"</SPAN> name="points" id="points" value="50" min="0" max="100"&gt;
  &lt;/div&gt;
&lt;/form&gt;
</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_forms_slider">亲自试一试</A></P>
<P>使用下列属性来规定限定：</P>
<UL>
  <LI>max - 规定允许的最大值 
  <LI>min - 规定允许的最小值 
  <LI>step - 规定合法的数字间隔 
  <LI>value - 规定默认值 </LI></UL>
<P class=tip><SPAN>提示：</SPAN>如果您希望突出显示截止滑块值的这段轨道，请添加 data-highlight="true"：</P>
<H3>实例</H3><PRE>&lt;input type="range" <CODE>data-hightlight="true"</CODE>&gt;</PRE>
<P><A 
href="../tiy/t.asp@f=jquerymobile_forms_slider_highlight">亲自试一试</A></P></DIV>
<DIV>
<H2>切换开关</H2>
<P>切换开关常用于开/关或对/错按钮：</P><IFRAME height=70 src="tjm_switch.html" frameBorder=0 
width="100%" scrolling=no></IFRAME>
<P>如需创建切换，请使用 data-role="slider" 的 &lt;select&gt; 元素，并添加两个 &lt;option&gt; 
元素：</P>
<H3>实例</H3><PRE>&lt;form method="post" action="demoform.asp"&gt;
  &lt;div data-role="fieldcontain"&gt;
    &lt;label for="switch"&gt;Toggle Switch:&lt;/label&gt;
    &lt;select name="switch" id="switch" <SPAN class=marked>data-role="slider"</SPAN>&gt;
...
<P><A href="../tiy/t.asp@f=jquerymobile_forms_select_switch">亲自试一试</A></P>
<P class=tip><SPAN>提示：</SPAN>请使用 "selected" 属性来把选项之一设置为预选（突出显示）：</P>
<H3>实例</H3><PRE>&lt;option value="off" <CODE>selected</CODE>&gt;Off&lt;/option&gt;</PRE>
<P><A 
href="../tiy/t.asp@f=jquerymobile_forms_select_switch_selected">亲自试一试</A></P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 表单 - 选择" 
  href="jquerymobile_form_select.asp">jQuery Mobile 表单选择</A> </LI>
  <LI class=next><A title="jQuery Mobile 主题" 
  href="jquerymobile_themes.asp">jQuery Mobile 主题</A> </LI></UL></DIV></DIV><!-- maincontent end -->
<DIV id=sidebar>
<DIV id=searchui>
