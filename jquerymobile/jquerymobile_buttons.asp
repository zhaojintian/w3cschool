...
<HTML lang=zh-cn><HEAD><TITLE>jQuery Mobile 按钮</TITLE>
<META charset=gbk>
...
<UL>
  ...
  Mobile 过渡</A> 
  <LI class=currentLink><A title="jQuery Mobile 按钮" 
  href="jquerymobile_buttons.asp">jQuery Mobile 按钮</A> 
...
<DIV id=maincontent>
<H1>jQuery Mobile 按钮</H1>
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 过渡" 
  href="jquerymobile_transitions.asp">jQuery Mobile 过渡</A> </LI>
  <LI class=next><A title="jQuery Mobile 图标" 
  href="jquerymobile_icons.asp">jQuery Mobile 图标</A> </LI></UL></DIV>
<DIV>
<P>移动应用程序构建于触控操作的便利性之上。</P></DIV>
<DIV><IFRAME style="MARGIN-TOP: 15px" height=287 src="tjm_button_app.html" 
frameBorder=0 width="100%" scrolling=no></IFRAME></DIV>
<DIV>
<H2>在 jQuery Mobile 中创建按钮</H2>
<P>jQuery Mobile 中的按钮可通过三种方法创建：</P>
<UL>
  <LI>使用 &lt;button&gt; 元素 
  <LI>使用 &lt;input&gt; 元素 
  <LI>使用 data-role="button" 的 &lt;a&gt; 元素 </LI></UL>
<H3>&lt;button&gt;</H3><PRE>&lt;button&gt;按钮&lt;/button&gt;</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_button_button">亲自试一试</A></P>
<H3>&lt;input&gt;</H3><PRE>&lt;input type="button" value="按钮"&gt;</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_button_input">亲自试一试</A></P>
<H3>&lt;a&gt;</H3><PRE>&lt;a href="#" <CODE>data-role="button"</CODE>&gt;按钮&lt;/a&gt;</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_button_a">亲自试一试</A></P>
<P class=tip><SPAN>提示：</SPAN>jQuery Mobile 
中的按钮会自动获得样式，这增强了他们在移动设备上的交互性和可用性。我们推荐您使用 data-role="button" 的 &lt;a&gt; 
元素来创建页面之间的链接，而 &lt;input&gt; 或 &lt;button&gt; 元素用于表单提交。</P></DIV>
<DIV>
<H2>导航按钮</H2>
<P>如需通过按钮来链接页面，请使用 data-role="button" 的 &lt;a&gt; 元素：</P>
<H3>实例</H3><PRE>&lt;a href="#pagetwo" <CODE>data-role="button"</CODE>&gt;转到页面二&lt;/a&gt;</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_button">亲自试一试</A></P></DIV>
<DIV>
<H2>行内按钮</H2>
<P>默认情况下，按钮会占据屏幕的全部宽度。如果您需要按钮适应其内容，或者如果您需要两个或多个按钮并排显示，请添加 
data-inline="true"：</P>
<H3>实例</H3><PRE>&lt;a href="#pagetwo" data-role="button" <CODE>data-inline="true"</CODE>&gt;转到页面二&lt;/a&gt;</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_button_inline">亲自试一试</A></P></DIV>
<DIV>
<H2>组合按钮</H2>
<P>jQuery Mobile 提供了对按钮进行组合的简单方法。</P>
<P>请将 data-role="controlgroup" 属性与 data-type="horizontal|vertical" 
一同使用，以规定水平或垂直地组合按钮：</P>
<H3>实例</H3><PRE>&lt;div <CODE>data-role="controlgroup"</CODE> <CODE>data-type="horizontal"</CODE>&gt;
  &lt;a href="#anylink" data-role="button"&gt;按钮 1&lt;/a&gt;
  &lt;a href="#anylink" data-role="button"&gt;按钮 2&lt;/a&gt;
  &lt;a href="#anylink" data-role="button"&gt;按钮 3&lt;/a&gt;
&lt;/div&gt;
</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_button_group">亲自试一试</A></P>
<P 
class=tip><SPAN>提示：</SPAN>默认情况下，组合按钮是垂直分组的，彼此间没有外边距和空白。并且只有第一个和最后一个按钮拥有圆角，在组合后就创造出了漂亮的外观。</P></DIV>
<DIV>
<H2>后退按钮</H2>
<P>如需创建后退按钮，请使用 data-rel="back" 属性（会忽略锚的 href 值）：</P>
<H3>实例</H3><PRE>&lt;a href="#" data-role="button" <CODE>data-rel="back"</CODE>&gt;返回&lt;/a&gt;</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_button_back">亲自试一试</A></P></DIV>
<DIV>
<H2>更多用于按钮的 data-* 属性</H2>
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TD>true | false</TD>
    <TD>规定按钮是否有圆角。</TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_button_corners">测试</A></TD></TR>
  <TR>
    <TD>data-mini</TD>
    <TD>true | false</TD>
    <TD>规定是否是小型按钮。</TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_button_mini">测试</A></TD></TR>
  <TR>
    <TD>data-shadow</TD>
    <TD>true | false</TD>
    <TD>规定按钮是否有阴影。</TD>
    <TD><A 
  href="../tiy/t.asp@f=jquerymobile_button_shadow">测试</A></TD></TR></TBODY></TABLE>
<P>如需有关 jQuery Mobile data-* 属性的完整信息，请访问我们的 <A title="jQuery Mobile Data 属性" 
href="jquerymobile_ref_data.asp">jQuery Mobile Data 属性参考手册</A>。</P>
<P>下一节演示如何为按钮添加图标。</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 过渡" 
  href="jquerymobile_transitions.asp">jQuery Mobile 过渡</A> </LI>
  <LI class=next><A title="jQuery Mobile 图标" 
  href="jquerymobile_icons.asp">jQuery Mobile 图标</A> </LI></UL></DIV></DIV><!-- maincontent end -->
<DIV id=sidebar>
<DIV id=searchui>
