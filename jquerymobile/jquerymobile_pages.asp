...
<HTML lang=zh-cn><HEAD><TITLE>jQuery Mobile 页面</TITLE>
<META charset=gbk>
...
<UL>
  ...
  安装</A> 
  <LI class=currentLink><A title="jQuery Mobile 页面" 
  href="jquerymobile_pages.asp">jQuery Mobile 页面</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 安装" 
  href="jquerymobile_install.asp">jQuery Mobile 安装</A> </LI>
  <LI class=next><A title="jQuery Mobile 过渡" 
  href="jquerymobile_transitions.asp">jQuery Mobile 过渡</A> </LI></UL></DIV>
<DIV>
<H2>使用 jQuery Mobile 入门</H2>
<P class=tip><SPAN>提示：</SPAN>尽管 jQuery Mobile 
适用于所有移动设备，它在台式计算机上仍然可能存在兼容性问题（由于有限的 CSS3 支持）。</P>
<P>因此在本教程中，我们推荐您使用谷歌的 Chrome 浏览器，以获得最好的阅读体验。</P>
<H3>实例</H3><PRE>&lt;body&gt;
&lt;div <CODE>data-role="page"</CODE>&gt;

  &lt;div <CODE>data-role="header"</CODE>&gt;
    &lt;h1&gt;欢迎访问我的主页&lt;/h1&gt;
  &lt;/div&gt;

  &lt;div <CODE>data-role="content"</CODE>&gt;
    &lt;p&gt;我是一名移动开发者！&lt;/p&gt;
  &lt;/div&gt;

  &lt;div <CODE>data-role="footer"</CODE>&gt;
    &lt;h1&gt;页脚文本&lt;/h1&gt;
  &lt;/div&gt;
...
<P><A href="../tiy/t.asp@f=jquerymobile_start">亲自试一试</A></P>
<H3>例子解释：</H3>
<UL>
  <LI>data-role="page" 是显示在浏览器中的页面 
  <LI>data-role="header" 创建页面上方的工具栏（常用于标题和搜索按钮） 
  <LI>data-role="content" 定义页面的内容，比如文本、图像、表单和按钮，等等 
  <LI>data-role="footer" 创建页面底部的工具栏 </LI></UL>
<P>在这些容器中，您可以添加任意 HTML 元素 - 段落、图像、标题、列表等等。</P>
<P class=tip><SPAN>提示：</SPAN>HTML5 data-* 属性用于通过 jQuery Mobile 
为移动设备创建“对触控友好的”交互外观。</P></DIV>
<DIV>
<H2>在 jQuery Mobile 中添加页面</H2>
<P>在 jQuery Mobile，您可以在单一 HTML 文件中创建多个页面。</P>
<P>请通过唯一的 id 来分隔每张页面，并使用 href 属性来连接彼此：</P>
<H3>实例</H3><PRE>&lt;div data-role="page" <CODE>id="pageone"</CODE>&gt;
  &lt;div data-role="content"&gt;
    &lt;a href="#pagetwo"&gt;转到页面二&lt;/a&gt;
  &lt;/div&gt;
&lt;/div&gt;

&lt;div data-role="page" <CODE>id="pagetwo"</CODE>&gt;
  &lt;div data-role="content"&gt;
    &lt;a href="#pageone"&gt;转到页面一&lt;/a&gt;
  &lt;/div&gt;
&lt;/div&gt;
</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_pages">亲自试一试</A></P>
<P class=note><SPAN>注释：</SPAN>包含大量内容的 web 
应用程序会影响加载时间（比如文本、链接、图像和脚本等等）。如果您不希望在内部链接页面，请使用外部文件：</P><PRE>&lt;a <SPAN class=marked>href="externalfile.html"</SPAN>&gt;转到外部页面&lt;/a&gt;</PRE></DIV>
<DIV>
<H2>将页面用作对话框</H2>
<P>对话框是用来显示信息或请求输入的视窗类型。</P>
<P>如需在用户点击（轻触）链接时创建一个对话框，请向该链接添加 data-rel="dialog"：</P>
<H3>实例</H3><PRE>&lt;div data-role="page" id="pageone"&gt;
  &lt;div data-role="content"&gt;
    &lt;a href="#pagetwo" <CODE>data-rel="dialog"</CODE>&gt;转到页面二&lt;/a&gt;
  &lt;/div&gt;
&lt;/div&gt;
...
<P><A href="../tiy/t.asp@f=jquerymobile_dialog">亲自试一试</A></P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 安装" 
  href="jquerymobile_install.asp">jQuery Mobile 安装</A> </LI>
  <LI class=next><A title="jQuery Mobile 过渡" 
  href="jquerymobile_transitions.asp">jQuery Mobile 过渡</A> </LI></UL></DIV></DIV><!-- maincontent end -->
<DIV id=sidebar>
<DIV id=searchui>
