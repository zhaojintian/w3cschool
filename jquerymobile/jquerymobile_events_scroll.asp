...
<HTML lang=zh-cn><HEAD><TITLE>jQuery Mobile 滚动事件</TITLE>
<META charset=gbk>
...
<UL>
  ...
  Mobile 触控</A> 
  <LI class=currentLink><A title="jQuery Mobile 滚动" 
  href="jquerymobile_events_scroll.asp">jQuery Mobile 滚动</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 触控" 
  href="jquerymobile_events_touch.asp">jQuery Mobile 触控</A> </LI>
  <LI class=next><A title="jQuery Mobile 方向" 
  href="jquerymobile_events_orientation.asp">jQuery Mobile 方向</A> </LI></UL></DIV>
<DIV>
<P>jQuery Mobile 提供两种滚动事件：在滚动开始和当滚动结束。</P></DIV>
<DIV>
<H2>jQuery Mobile Scrollstart</H2>
<P>scrollstart 事件在用户开始滚动页面时被触发：</P>
<H3>实例</H3><PRE>$(document).on(<SPAN class=marked>"scrollstart"</SPAN>,function(){
  alert("开始滚动！");
});
</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_events_scrollstart">亲自试一试</A></P>
<P class=note><SPAN>注释：</SPAN>iOS 设备会在滚动事件发生时冻结 DOM 操作，这意味着当用户滚动时无法改变任何事物。不过 
jQuery 团队正致力于解决该问题。</P></DIV>
<DIV>
<H2>jQuery Mobile Scrollstop</H2>
<P>scrollstop 事件在用户停止滚动页面时被触发：</P>
<H3>实例</H3><PRE>$(document).on(<SPAN class=marked>"scrollstop"</SPAN>,function(){
  alert("结束滚动！");
});
</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_events_scrollstop">亲自试一试</A></P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 触控" 
  href="jquerymobile_events_touch.asp">jQuery Mobile 触控</A> </LI>
