...
<HTML lang=zh-cn><HEAD><TITLE>jQuery Mobile 列表内容</TITLE>
<META charset=gbk>
...
<UL>
  ...
  Mobile 列表视图</A> 
  <LI class=currentLink><A title="jQuery Mobile 列表内容" 
  href="jquerymobile_list_content.asp">jQuery Mobile 列表内容</A> </LI></UL>
...
<DIV id=maincontent>
<H1>jQuery Mobile 列表内容</H1>
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 列表视图" 
  href="jquerymobile_list_views.asp">jQuery Mobile 列表视图</A> </LI>
  <LI class=next><A title="jQuery Mobile 表单基础" 
  href="jquerymobile_form_basic.asp">jQuery Mobile 表单基础</A> </LI></UL></DIV>
<DIV 
style="PADDING-BOTTOM: 0px; PADDING-TOP: 0px; PADDING-LEFT: 0px; PADDING-RIGHT: 0px"><IFRAME 
height=270 src="tjm_list_content.html" frameBorder=0 width="95%" 
scrolling=no></IFRAME></DIV>
<DIV>
<H2>jQuery Mobile 列表缩略图</H2>
<P>对于大于 16x16px 的图像，请在链接中添加 &lt;img&gt; 元素。</P>
<P>jQuery Mobile 将自动把图像调整至 80x80px：</P>
<H3>实例</H3><PRE>&lt;ul data-role="listview"&gt;
  &lt;li&gt;&lt;a href="#"&gt;<CODE>&lt;img src="chrome.png"&gt;</CODE>&lt;/a&gt;&lt;/li&gt;
&lt;/ul&gt;
</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_lists_thumbs">亲自试一试</A></P>
...
<P><A href="../tiy/t.asp@f=jquerymobile_lists_thumbs_text">亲自试一试</A></P></DIV>
<DIV>
<H2>jQuery Mobile 列表图标</H2>
<P>如需向您的列表添加 16x16px 的图标，请向 &lt;img&gt; 元素添加 class="ui-li-icon" 属性：</P>
<H3>实例</H3><PRE>&lt;li&gt;&lt;a href="#"&gt;&lt;img src="us.png" alt="USA" <CODE>class="ui-li-icon"</CODE>&gt;USA&lt;/a&gt;&lt;/li&gt;</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_lists_icons">亲自试一试</A></P></DIV>
<DIV>
<H2>拆分按钮</H2>
...
<P><A href="../tiy/t.asp@f=jquerymobile_lists_split">亲自试一试</A></P>
...
<P><A href="../tiy/t.asp@f=jquerymobile_lists_split2">亲自试一试</A></P></DIV>
<DIV>
<H2>计数泡沫</H2>
<P>计数泡沫用于显示与列表项相关的数目，例如邮箱中的消息：</P><IFRAME height=190 
src="tjm_count_bubbles.html" frameBorder=0 width="95%" scrolling=no></IFRAME>
<P>如需添加计数泡沫，请使用行内元素，比如 &lt;span&gt;，设置 class "ui-li-count" 属性并添加数字：</P>
<H3>实例</H3><PRE>&lt;ul data-role="listview"&gt;
  &lt;li&gt;&lt;a href="#"&gt;Inbox<CODE>&lt;span class="ui-li-count"&gt;335&lt;/span&gt;</CODE>&lt;/a&gt;&lt;/li&gt;
  &lt;li&gt;&lt;a href="#"&gt;Sent<CODE>&lt;span class="ui-li-count"&gt;123&lt;/span&gt;</CODE>&lt;/a&gt;&lt;/li&gt;
  &lt;li&gt;&lt;a href="#"&gt;Trash<CODE>&lt;span class="ui-li-count"&gt;7&lt;/span&gt;</CODE>&lt;/a&gt;&lt;/li&gt;
&lt;/ul&gt;
</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_lists_count">亲自试一试</A></P>
<P class=note><SPAN>注释：</SPAN>如需在计数泡泡中显示正确的数字，就必须进行程序化更新。我们将在下一章种讲解。</P></DIV>
<DIV class=example>
<H2>更多实例</H2>
<DL>
  <DT><A href="../tiy/t.asp@f=jquerymobile_lists_change_icons">更改列表项的默认链接图标</A> 
  <DD>如何为列表项设置不同的链接图标（右箭头是默认的）。 
  <DT><A href="../tiy/t.asp@f=jquerymobile_lists_collapsible">可折叠列表</A> 
  <DD>如何创建隐藏和显示内容的列表。 
  <DT><A href="../tiy/t.asp@f=jquerymobile_lists_formatting">更多内容格式</A> 
  <DD>如何制作日历。 </DD></DL></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 列表视图" 
  href="jquerymobile_list_views.asp">jQuery Mobile 列表视图</A> </LI>
  <LI class=next><A title="jQuery Mobile 表单基础" 
  href="jquerymobile_form_basic.asp">jQuery Mobile 表单基础</A> </LI></UL></DIV></DIV><!-- maincontent end -->
<DIV id=sidebar>
<DIV id=searchui>
