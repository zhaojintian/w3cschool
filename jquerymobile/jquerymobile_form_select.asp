...
<HTML lang=zh-cn><HEAD><TITLE>jQuery Mobile 表单选择菜单</TITLE>
<META charset=gbk>
...
<UL>
  ...
  <LI class=currentLink><A title="jQuery Mobile 表单 - 选择" 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 表单 - 输入" 
  href="jquerymobile_form_inputs.asp">jQuery Mobile 表单输入</A> </LI>
  <LI class=next><A title="jQuery Mobile 表单 - 滑块" 
  href="jquerymobile_form_sliders.asp">jQuery Mobile 表单滑块</A> </LI></UL></DIV>
<DIV>
...
<P><A href="../tiy/t.asp@f=jquerymobile_forms_select">亲自试一试</A></P>
<P class=tip><SPAN>提示：</SPAN>如果列表中包含了一长列相关的选项，请在 &lt;select&gt; 中使用 
&lt;optgroup&gt; 元素：</P>
<H3>实例</H3><PRE>&lt;select name="day" id="day"&gt;
...
<P><A 
href="../tiy/t.asp@f=jquerymobile_forms_select_optgroup">亲自试一试</A></P></DIV>
<DIV>
<H2>自定义选择菜单</H2>
<P>本页上方的图片，展示了移动平台显示选择菜单的独特方式。</P>
<P>如果您希望在所有移动设备上显示一致外观的选择菜单，请使用 jQuery 的自定义选择菜单，data-native-menu="false" 属性：</P>
<H3>实例</H3><PRE>&lt;select name="day" id="day" <CODE>data-native-menu="false"</CODE>&gt;</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_forms_select_native">亲自试一试</A></P></DIV>
<DIV>
<H2>Multiple Selections</H2>
<P>如需在选择菜单中选取多个选项，请在 &lt;select&gt; 元素中使用 multiple 属性：</P>
<H3>实例</H3><PRE>&lt;select name="day" id="day" <CODE>multiple</CODE> data-native-menu="false"&gt;</PRE>
<P><A 
href="../tiy/t.asp@f=jquerymobile_forms_select_multiple">亲自试一试</A></P></DIV>
<DIV class=example>
<H2>更多实例</H2>
<DL>
  <DT><A href="../tiy/t.asp@f=jquerymobile_forms_select_group">使用 
  data-role="controlgroup"</A> 
  <DD>如何组合一个或多个选择菜单。 
  <DT><A href="../tiy/t.asp@f=jquerymobile_forms_select_horizontal">使用 
  data-type="horizontal"</A> 
  <DD>如何水平地组合选择菜单。 
  <DT><A href="../tiy/t.asp@f=jquerymobile_forms_select_selected">预选选项</A> 
  <DD>如何预选择一个选项。 
  <DT><A href="../tiy/t.asp@f=jquerymobile_forms_collapsible">可折叠表单</A> 
  <DD>如何创建可折叠表单。 </DD></DL></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 表单 - 输入" 
  href="jquerymobile_form_inputs.asp">jQuery Mobile 表单输入</A> </LI>
  <LI class=next><A title="jQuery Mobile 表单 - 滑块" 
  href="jquerymobile_form_sliders.asp">jQuery Mobile 表单滑块</A> 
