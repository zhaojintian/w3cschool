...
<HTML lang=zh-cn><HEAD><TITLE>jQuery Mobile 图标</TITLE>
<META charset=gbk>
...
<UL>
  ...
  Mobile 事件</A> 
  <LI class=currentLink><A title="jQuery Mobile 图标" 
  href="jquerymobile_ref_icons.asp">jQuery Mobile 图标</A> </LI></UL></DIV>
<DIV id=selected>
<H2>建站手册</H2>
<UL>
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 事件" 
  href="jquerymobile_ref_events.asp">jQuery Mobile 事件</A> </LI>
  <LI class=next><A title="jQuery Mobile 教程" href="index.asp">jQuery Mobile 
  教程</A> </LI></UL></DIV>
<DIV>
<H2>jQuery 图标</H2>
<P>如需在 jQuery Mobile 中向按钮添加图标，请使用 data-icon 属性：</P><PRE>&lt;a href="#anylink" data-role="button" data-icon="refresh"&gt;Refresh Page&lt;/a&gt;</PRE>
<P class=tip><SPAN>提示：</SPAN>您也可以在 &lt;button&gt; 或 &lt;input&gt; 元素中使用 
data-icon 属性。</P>
...
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TD>左箭头</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -96px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="arrow-r"</TD>
    <TD>右箭头</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -72px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="arrow-u"</TD>
    <TD>上箭头</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -120px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="arrow-d"</TD>
    <TD>下箭头</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -144px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="plus"</TD>
    <TD>加</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px 0px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="minus"</TD>
    <TD>减</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -24px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="delete"</TD>
    <TD>删除</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -48px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="check"</TD>
    <TD>检查</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -168px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="home"</TD>
    <TD>首页</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -384px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="info"</TD>
    <TD>信息</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -360px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="grid"</TD>
    <TD>网格</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -288px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="gear"</TD>
    <TD>齿轮</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -192px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="search"</TD>
    <TD>搜索</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -408px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="back"</TD>
    <TD>后退</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -264px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="forward"</TD>
    <TD>向前</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -240px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="refresh"</TD>
    <TD>刷新</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -216px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="star"</TD>
    <TD>星</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -312px"></TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR>
  <TR>
    <TD>data-icon="alert"</TD>
    <TD>提醒</TD>
    <TD 
    style="BACKGROUND: url(../i/jquery_icons.png) #eee no-repeat 0px -336px"></TD>
    <TD><A 
href="../tiy/t.asp@f=jquerymobile_header">测试</A></TD></TR></TBODY></TABLE></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 事件" 
  href="jquerymobile_ref_events.asp">jQuery Mobile 事件</A> </LI>
  <LI class=next><A title="jQuery Mobile 教程" href="index.asp">jQuery Mobile 
  教程</A> </LI></UL></DIV></DIV><!-- maincontent end -->
<DIV id=sidebar>
<DIV id=searchui>
