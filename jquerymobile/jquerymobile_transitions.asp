...
<HTML lang=zh-cn><HEAD><TITLE>jQuery Mobile 过渡</TITLE>
<META charset=gbk>
...
<UL>
  ...
  页面</A> 
  <LI class=currentLink><A title="jQuery Mobile 过渡" 
  href="jquerymobile_transitions.asp">jQuery Mobile 过渡</A> 
...
<DIV id=maincontent>
<H1>jQuery Mobile 过渡</H1>
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 页面" href="jquerymobile_pages.asp">jQuery 
  Mobile 页面</A> </LI>
  <LI class=next><A title="jQuery Mobile 按钮" 
  href="jquerymobile_buttons.asp">jQuery Mobile 按钮</A> </LI></UL></DIV>
<DIV>
<P>jQuery Mobile 包含了允许您选择页面打开方式的 CSS 效果。</P></DIV>
<DIV>
<H2>jQuery Mobile 过渡效果</H2>
<P>jQuery Mobile 拥有一系列关于如何从一页过渡到下一页的效果。</P>
<P class=note><SPAN>注释：</SPAN>如需实现过渡效果，浏览器必须支持 CSS3 3D 转换：</P></DIV>
<DIV>
<H2>浏览器支持</H2>
<UL>
  <LI>Internet Explorer 10 支持 3D 转换（更早的版本不支持） 
  <LI>Opera 仍然不支持 3D 转换 </LI></UL>
<P>过渡效果可应用于任意链接或通过使用 data-transition 属性进行的表单提交：</P><PRE>&lt;a href="#anylink" <CODE>data-transition="slide"</CODE>&gt;滑动到页面二&lt;/a&gt;</PRE>
...
<TABLE class=dataintable>
  ...
  <TR>
    <TD>fade</TD>
    <TD>默认。淡入淡出到下一页。</TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_transition_fade">测试</A></TD></TR>
  <TR>
    <TD>flip</TD>
    <TD>从后向前翻动到下一页。</TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_transition_flip">测试</A></TD></TR>
  <TR>
    <TD>flow</TD>
    <TD>抛出当前页面，引入下一页。</TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_transition_flow">测试</A></TD></TR>
  <TR>
    <TD>pop</TD>
    <TD>像弹出窗口那样转到下一页。</TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_transition_pop">测试</A></TD></TR>
  <TR>
    <TD>slide</TD>
    <TD>从右向左滑动到下一页。</TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_transition_slide">测试</A></TD></TR>
  <TR>
    <TD>slidefade</TD>
    <TD>从右向左滑动并淡入到下一页。</TD>
    <TD><A 
href="../tiy/t.asp@f=jquerymobile_transition_slidefade">测试</A></TD></TR>
  <TR>
    <TD>slideup</TD>
    <TD>从下到上滑动到下一页。</TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_transition_slideup">测试</A></TD></TR>
  <TR>
    <TD>slidedown</TD>
    <TD>从上到下滑动到下一页。</TD>
    <TD><A 
href="../tiy/t.asp@f=jquerymobile_transition_slidedown">测试</A></TD></TR>
  <TR>
    <TD>turn</TD>
    <TD>转向下一页。</TD>
    <TD><A href="../tiy/t.asp@f=jquerymobile_transition_turn">测试</A></TD></TR>
  <TR>
    <TD>none</TD>
    <TD>无过渡效果。</TD>
    <TD><A 
  href="../tiy/t.asp@f=jquerymobile_transition_none">测试</A></TD></TR></TBODY></TABLE>
<P class=tip><SPAN>提示：</SPAN>在 jQuery Mobile 中，淡入淡出效果在所有链接上都是默认的（如果浏览器支持）。</P>
<P class=tip><SPAN>提示：</SPAN>以上所有效果同时支持反向动作，例如，如果您希望页面从左向右滑动，而不是从右向左，请使用值为 
"reverse" 的 data-direction 属性。在后退按钮上是默认的。</P>
<H3>实例</H3><PRE>&lt;a href="#pagetwo" data-transition="slide" <CODE>data-direction="reverse"</CODE>&gt;滑动&lt;/a&gt;</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_transition_reverse">亲自试一试</A></P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 页面" href="jquerymobile_pages.asp">jQuery 
  Mobile 页面</A> </LI>
  <LI class=next><A title="jQuery Mobile 按钮" 
  href="jquerymobile_buttons.asp">jQuery Mobile 按钮</A> </LI></UL></DIV></DIV><!-- maincontent end -->
<DIV id=sidebar>
<DIV id=searchui>
