...
<HTML lang=zh-cn><HEAD><TITLE>jQuery Mobile 安装</TITLE>
<META charset=gbk>
...
<UL>
  ...
  简介</A> 
  <LI class=currentLink><A title="jQuery Mobile 安装" 
  href="jquerymobile_install.asp">jQuery Mobile 安装</A> 
...
<DIV id=maincontent>
<H1>jQuery Mobile 安装</H1>
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 简介" href="jquerymobile_intro.asp">jQuery 
  Mobile 简介</A> </LI>
  <LI class=next><A title="jQuery Mobile 页面" 
  href="jquerymobile_pages.asp">jQuery Mobile 页面</A> </LI></UL></DIV>
<DIV>
<H2>向您的网页添加 jQuery Mobile</H2>
<P>有多个办法可供您在网站上开始使用 jQuery Mobile。您可以：</P>
<UL>
  <LI>从 CDN 引用 jQuery Mobile（推荐） 
  <LI>从 jQuerymobile.com 下载 jQuery Mobile 库 </LI></UL></DIV>
<DIV>
<H2>从 CDN 引用 jQuery Mobile</H2>
<P class=tip><SPAN>提示：</SPAN>CDN (Content Delivery Network) 用于通过 web 
来分发常用的文件，以此加快用户的下载速度。</P>
<P>与 jQuery 类似，无需在您的计算机上安装任何程序；您只需直接在 HTML 页面中引用以下样式表和 JavaScript 库，这样 jQuery 
Mobile 就可以工作了：</P>
<H3>jQuery Mobile CDN:</H3><PRE>&lt;head&gt;
&lt;link rel="stylesheet" href="http://code.jquery.com/mobile/1.3.2/jquery.mobile-1.3.2.min.css"&gt;
&lt;script src="http://code.jquery.com/jquery-1.8.3.min.js"&gt;&lt;/script&gt;
&lt;script src="http://code.jquery.com/mobile/1.3.2/jquery.mobile-1.3.2.min.js"&gt;&lt;/script&gt;
&lt;/head&gt;
</PRE>
<P><A href="../tiy/t.asp@f=jquerymobile_lib_jquery">亲自试一试</A></P></DIV>
<DIV>
<H2>下载 jQuery Mobile</H2>
<P>如果您希望在服务器上存放 jQuery Mobile，您可以从 <A 
href="../../jquerymobile.com/download/default.htm">jQuerymobile.com</A> 
下载文件。</P><PRE>&lt;head&gt;
...
<P class=tip><SPAN>提示：</SPAN>请将下载的文件放到您希望使用的文件夹中。</P>
<P class=tip><SPAN>提示：</SPAN>您是不是奇怪为什么 &lt;script&gt; 标签中没有 
type="text/javascript" 属性？</P>
<P>在 HTML5 中该属性不是必需的。JavaScript 是 HTML5 以及所有现代浏览器中的默认脚本语言！</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 简介" href="jquerymobile_intro.asp">jQuery 
  Mobile 简介</A> </LI>
  <LI class=next><A title="jQuery Mobile 页面" 
  href="jquerymobile_pages.asp">jQuery Mobile 页面</A> </LI></UL></DIV></DIV><!-- maincontent end -->
<DIV id=sidebar>
<DIV id=searchui>
