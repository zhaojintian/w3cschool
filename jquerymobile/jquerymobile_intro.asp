...
<HTML lang=zh-cn><HEAD><TITLE>jQuery Mobile 简介</TITLE>
<META charset=gbk>
...
<UL>
  ...
  <LI class=currentLink><A title="jQuery Mobile 简介" 
  href="jquerymobile_intro.asp">jQuery Mobile 简介</A> 
...
<DIV id=maincontent>
<H1>jQuery Mobile 简介</H1>
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 教程" href="index.asp">jQuery Mobile 
  教程</A> </LI>
  <LI class=next><A title="jQuery Mobile 安装" 
  href="jquerymobile_install.asp">jQuery Mobile 安装</A> </LI></UL></DIV>
<DIV>
<P>jQuery Mobile 是一种 web 框架，用于创建移动 web 应用程序。</P></DIV>
<DIV>
<H2>您应该具备的基础知识</H2>
<P>在您开始学习 jQuery Mobile 之前，您应该对以下知识有基本的了解：</P>
<UL>
  <LI>HTML 
  <LI>CSS 
  <LI>jQuery </LI></UL>
<P>如果您需要首先学习这些项目，请在我们的<A title="W3School 在线教程" 
href="../index.html">首页</A>访问这些教程。</P></DIV>
<DIV>
...
<P>它使用 HTML5、CSS3、JavaScript 和 AJAX 通过尽可能少的代码来完成对页面的布局。</P></DIV>
<DIV>
<H2>为什么使用 jQuery Mobile？</H2>
<P>jQuery Mobile 将“写得更少、做得更多”这一理念提升到了新的层次：它会自动为网页设计交互的易用外观，并在所有移动设计上保持一致。</P>
<P class=tip><SPAN>提示：</SPAN>您不需要为每种移动设备或 OS 编写一个应用程序：</P>
<UL>
  <LI>Android 和 Blackberry 用 Java 编写 
  <LI>iOS 用 Objective C 编写 
  <LI>Windows Phone 用 C# 和 .net 编写 </LI></UL>
<P>jQuery Mobile 解决了这个问题，因为它只用 HTML、CSS 和 JavaScript，这些技术都是所有移动 web 
浏览器的标准。</P></DIV>
<DIV>
<H2>最佳阅读体验</H2>
<P>尽管 jQuery Mobile 工作于所有移动设备，它可能在桌面计算机上存在兼容性问题（“归功于”有限的 CSS3 支持）。</P>
<P>因此在本教程中，我们推荐您使用谷歌的 Chrome 浏览器，以获得最好的阅读体验。</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="jQuery Mobile 教程" href="index.asp">jQuery Mobile 
  教程</A> </LI>
  <LI class=next><A title="jQuery Mobile 安装" 
  href="jquerymobile_install.asp">jQuery Mobile 安装</A> </LI></UL></DIV></DIV><!-- maincontent end -->
<DIV id=sidebar>
<DIV id=searchui>
