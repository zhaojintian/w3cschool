...
<li class="currentLink"><a href="vbscript_ref_keywords.asp" title="VBScript 关键字">VB 关键字</a></li>
</ul>
</div><div id="selected">
<h2>建站手册</h2>
<ul>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="vbscript_ref_functions.asp" title="VBScript 函数">VB 函数</a></li>
<li class="next"><a href="index.asp" title="VBScript 教程">VB 教程</a></li>
</ul>
</div>
