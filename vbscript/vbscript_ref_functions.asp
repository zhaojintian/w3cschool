...
<h2>VBScript 参考手册</h2>
<ul>
<li class="currentLink"><a href="vbscript_ref_functions.asp" title="VBScript 函数">VB 函数</a></li>
...
<li class="next"><a href="vbscript_ref_keywords.asp" title="VBScript 关键字">VB 关键字</a></li>
</ul>
</div>
