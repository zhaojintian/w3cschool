...
<li class="currentLink"><a href="json_intro.asp" title="JSON 简介">JSON 简介</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="index.asp" title="JSON 教程">JSON 教程</a></li>
<li class="next"><a href="json_syntax.asp" title="JSON 语法">JSON 语法</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=json_create">亲自试一试</a></p>
</div>
