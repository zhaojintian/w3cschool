...
<li class="currentLink"><a href="json_eval.asp" title="JSON 使用">JSON 使用</a></li>
</ul>
</div><div id="selected">
<h2>建站手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="json_syntax.asp" title="JSON 语法">JSON 语法</a></li>
<li class="next"><a href="index.asp" title="JSON 教程">JSON 教程</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=json_eval">亲自试一试</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=json_parse">亲自试一试</a></p>
...
<p>JSON 格式最初是<a href="../../developer.yahoo.com/yui/theater/video.php@v=crockford-json">由 Douglas Crockford 制定的</a>。</p>
</div>
