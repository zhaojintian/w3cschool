...
<UL class=prenext>
  ...
  <LI class=next><A title="DHTML 事件句柄（Event Handlers）" 
  href="dhtml_events.asp">DHTML 事件</A> </LI></UL></DIV>
<DIV id=intro>
<P><STRONG>DOM （文档对象模型）是我们有能力访问一个文档中的每个元素。</STRONG></P></DIV>
<DIV class=example>
<H2>实例</H2>
<P class=note><SPAN>注释：</SPAN>大多数 DHTML 实例需要IE 4.0+、Netscape 7+ 或者 Opera 7+！</P>
<DL>
  <DT><A href="../tiy/t.asp@f=dhtm_dom_color">元素访问</A> 
  <DD>如何访问一个元素并改变它的样式。 
  <DT><A href="../tiy/t.asp@f=dhtm_dom_image">属性改变</A> 
  <DD>如何访问一个图像元素并修改 "src" 属性。 
  <DT><A href="../tiy/t.asp@f=dhtm_dom_innertext">innerHTML</A> 
  <DD>如何访问并修改一个元素的内容。 </DD></DL></DIV>
<DIV>
<H2>如何访问一个元素？</H2>
<P>元素必须拥有被定义的 id 属性，且需要一段脚本语言。JavaScript 是浏览器兼容性最好的脚本语言，所以我们使用 JavaScript。</P><PRE>&lt;html&gt;
&lt;body&gt;
...
&lt;/body&gt;
&lt;/html&gt;</PRE>
<P>这段脚本可改变标题元素的颜色，并生成输出。</P><PRE style="FONT-SIZE: 16px; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; COLOR: red">My header</PRE></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="DHTML CSS Positioning (CSS-P)" 
  href="dhtml_css.asp">DHTML CSS</A> </LI>
  <LI class=next><A title="DHTML 事件句柄（Event Handlers）" 
  href="dhtml_events.asp">DHTML 事件</A> </LI></UL></DIV></DIV>
<DIV id=sidebar>
<DIV id=searchui>
