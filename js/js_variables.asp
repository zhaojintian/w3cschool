...
<li class="currentLink"><a href="js_variables.asp" title="JavaScript 变量">JS 变量</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_comments.asp" title="JavaScript 注释">JS 注释</a></li>
<li class="next"><a href="js_datatypes.asp" title="JavaScript 数据类型">JS 数据类型</a></li>
</ul>
</div>
