...
<li class="currentLink"><a href="js_obj_regexp.asp" title="JavaScript RegExp 对象">JS 正则表达式</a></li>
</ul>
<h2>JS Window</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_obj_math.asp" title="JavaScript Math 对象">JS 算数</a></li>
<li class="next"><a href="js_window.asp" title="JavaScript Window - 浏览器对象模型">JS Window</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jseg_regexp_test">TIY</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jseg_regexp_exec">TIY</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jseg_regexp_exec_2">TIY</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jseg_regexp_compile">TIY</a></p>
</div>
