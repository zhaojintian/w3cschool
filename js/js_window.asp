...
<h2>JS Window</h2>
<ul>
<li class="currentLink"><a href="js_window.asp" title="JavaScript Window - 浏览器对象模型">JS Window</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_obj_regexp.asp" title="JavaScript RegExp 对象">JS 正则表达式</a></li>
<li class="next"><a href="js_window_screen.asp" title="JavaScript Window Screen">JS Screen</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=js_window_innerwidth_innerheight">亲自试一试</a></p>
