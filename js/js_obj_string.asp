...
<li class="currentLink"><a href="js_obj_string.asp" title="JavaScript String 对象">JS 字符串</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_obj_number.asp" title="JavaScript Number 对象">JS 数字</a></li>
<li class="next"><a href="js_obj_date.asp" title="JavaScript Date 对象">JS 日期</a></li>
</ul>
</div>
...
<pre>
var txt=&quot;Hello world!&quot;
document.write(txt.<code>toUpperCase()</code>)
</pre>
