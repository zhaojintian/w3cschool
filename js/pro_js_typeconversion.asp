...
<li class="currentLink"><a href="pro_js_typeconversion.asp" title="ECMAScript 类型转换">ECMAScript 类型转换</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="pro_js_primitivetypes.asp" title="ECMAScript 原始类型">ECMAScript 原始类型</a></li>
<li class="next"><a href="pro_js_referencetypes.asp" title="ECMAScript 引用类型">ECMAScript 引用类型</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=js_pro_parsefloat">亲自试一试</a></p>
