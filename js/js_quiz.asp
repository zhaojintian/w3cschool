...
<li class="currentLink"><a href="js_quiz.asp" title="JavaScript 测验">JS 测验</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="../example/jsrf_examples.asp" title="JavaScript 对象实例">JS 对象实例</a></li>
<li class="next"><a href="js_summary.asp" title="JavaScript 总结">JS 总结</a></li>
</ul>
</div>
