...
<li class="currentLink"><a href="pro_js_operators_bitwise.asp" title="ECMAScript 位运算符">位运算符</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="pro_js_operators_unary.asp" title="ECMAScript 一元运算符">一元运算符</a></li>
<li class="next"><a href="pro_js_operators_boolean.asp" title="ECMAScript 逻辑运算符">逻辑运算符</a></li>
</ul>
</div>
