...
<li class="currentLink"><a href="pro_js_functions_arguments_object.asp" title="ECMAScript arguments 对象">arguments 对象</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="pro_js_functions.asp" title="ECMAScript 函数概述">函数概述</a></li>
<li class="next"><a href="pro_js_functions_function_object.asp" title="ECMAScript Function 对象（类）">Function 对象</a></li>
</ul>
</div>
