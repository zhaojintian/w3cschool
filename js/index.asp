...
<ul>
<li class="currentLink"><a href="index.asp" title="JavaScript 教程">JS 教程</a></li>
...
<li class="next"><a href="js_intro.asp" title="JavaScript 简介">JS 简介</a></li>
</ul>
</div>
...
<p><a href="../jsref/index.asp" title="JavaScript 和 HTML DOM 参考手册">完整的 JavaScript 对象参考手册（包含实例）</a></p>

<p><a href="../jsref/index.asp" title="JavaScript 和 HTML DOM 参考手册">完整的 HTML DOM 对象参考手册（包含实例）</a></p>
</div>
