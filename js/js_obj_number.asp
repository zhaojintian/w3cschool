...
<li class="currentLink"><a href="js_obj_number.asp" title="JavaScript Number 对象">JS 数字</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_objects.asp" title="JavaScript 对象">JS 对象</a></li>
<li class="next"><a href="js_obj_string.asp" title="JavaScript String 对象">JS 字符串</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=js_inaccurate">亲自试一试</a></p>
</div>
