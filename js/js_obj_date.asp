...
<li class="currentLink"><a href="js_obj_date.asp" title="JavaScript Date 对象">JS 日期</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_obj_string.asp" title="JavaScript String 对象">JS 字符串</a></li>
<li class="next"><a href="js_obj_array.asp" title="JavaScript Array 对象">JS 数组</a></li>
</ul>
</div>
...
<pre>
var myDate=new Date()
myDate.<code>setFullYear</code>(2008,7,9)
</pre>
...
<pre>
var myDate=new Date()
myDate.<code>setDate</code>(myDate.getDate()+5)
</pre>
