...
<li class="currentLink"><a href="js_summary.asp" title="JavaScript 总结">JS 总结</a></li>
</ul>
<h2>JS 参考手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_quiz.asp" title="JavaScript 测验">JS 测验</a></li>
<li class="next"><a href="index.asp" title="JavaScript 教程">JS 教程</a></li>
</ul>
</div>
