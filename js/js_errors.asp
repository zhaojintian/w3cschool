...
<li class="currentLink"><a href="js_errors.asp" title="JavaScript 错误 - Throw 和 Try to Catch">JS 错误</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_break.asp" title="JavaScript Break 和 Continue 语句">JS Break</a></li>
<li class="next"><a href="js_form_validation.asp" title="JavaScript 表单验证">JS 验证</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=js_try_catch">亲自试一试</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=js_throw_error">亲自试一试</a></p>
