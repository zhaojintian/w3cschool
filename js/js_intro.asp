...
<li class="currentLink"><a href="js_intro.asp" title="JavaScript 简介">JS 简介</a></li>
...
<li><a href="js_loop_for.asp" title="JavaScript For 循环">JS For</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="index.asp" title="JavaScript 教程">JS 教程</a></li>
<li class="next"><a href="js_howto.asp" title="JavaScript 实现">JS 实现</a></li>
</ul>
</div>

<div>
<p><strong>JavaScript 是世界上最流行的编程语言。</strong></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=js_intro_document_write">亲自试一试</a></p>

<p class="tip"><span>提示：</span>您只能在 HTML 输出中使用 document.write。如果您在文档加载后使用该方法，会覆盖整个文档。</p>
</div>


<div>
<h2>JavaScript：对事件作出反应</h2>

<h3>实例</h3>

<pre>&lt;button type=&quot;button&quot; onclick=&quot;alert('Welcome!')&quot;&gt;点击这里&lt;/button&gt;</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=js_intro_alert">亲自试一试</a></p>
...
<pre>
x=document.getElementById(&quot;demo&quot;)  <span>//查找元素</span>
x.innerHTML=&quot;Hello JavaScript&quot;;    <span>//改变内容</span>
</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=js_intro_inner_html">亲自试一试</a></p>

<p>您会经常看到 document.getElementByID(&quot;<i>some id</i>&quot;)。这个方法是 HTML DOM 中定义的。</p>

<p>DOM（文档对象模型）是用以访问 HTML 元素的正式 W3C 标准。</p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=js_lightbulb">亲自试一试</a></p>
...
<pre>
x=document.getElementById(&quot;demo&quot;)  <span>//找到元素</span>
x.style.color=&quot;#ff0000&quot;;           <span>//改变样式</span>
</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=js_intro_style">亲自试一试</a></p>
</div>
...
<pre>if isNaN(x) {alert(&quot;Not Numeric&quot;)};</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=js_intro_validate">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>JavaScript 与 Java 是两种完全不同的语言，无论在概念还是设计上。</p>

<p>Java（由 Sun 发明）是更复杂的编程语言。</p>

<p>ECMA-262 是 JavaScript 标准的官方名称。</p>

<p>JavaScript 由 Brendan Eich 发明。它于 1995 年出现在 Netscape 中（该浏览器已停止更新），并于 1997 年被 ECMA（一个标准协会）采纳。</p>
</div>
