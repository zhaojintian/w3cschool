...
<li class="currentLink"><a href="pro_js_object_scope.asp" title="ECMAScript 对象作用域">对象作用域</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="pro_js_object_types.asp" title="ECMAScript 对象类型">对象类型</a></li>
<li class="next"><a href="pro_js_object_defining.asp" title="ECMAScript 定义类或对象">定义类或对象</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jseg_pro_object_scope_static">TIY</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jseg_pro_object_scope_this_1">TIY</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jseg_pro_object_scope_this_2">TIY</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jseg_pro_object_scope_this_3">TIY</a></p>
