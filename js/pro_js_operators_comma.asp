...
<li class="currentLink"><a href="pro_js_operators_comma.asp" title="ECMAScript 逗号运算符">逗号运算符</a></li>
</ul>
<h2>ECMAScript 语句</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="pro_js_operators_assignment.asp" title="ECMAScript 赋值运算符">赋值运算符</a></li>
<li class="next"><a href="pro_js_statements_if.asp" title="ECMAScript if 语句">if 语句</a></li>
</ul>
</div>
