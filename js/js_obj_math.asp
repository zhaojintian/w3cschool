...
<li class="currentLink"><a href="js_obj_math.asp" title="JavaScript Math 对象">JS 算数</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_obj_boolean.asp" title="JavaScript Boolean 对象">JS 逻辑</a></li>
<li class="next"><a href="js_obj_regexp.asp" title="JavaScript RegExp 对象">JS 正则表达式</a></li>
</ul>
</div>
