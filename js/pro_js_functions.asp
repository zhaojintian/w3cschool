...
<h2>ECMAScript 函数</h2>
<ul>
<li class="currentLink"><a href="pro_js_functions.asp" title="ECMAScript 函数概述">函数概述</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="pro_js_statements_switch.asp" title="ECMAScript switch 语句">switch 语句</a></li>
<li class="next"><a href="pro_js_functions_arguments_object.asp" title="ECMAScript arguments 对象">arguments 对象</a></li>
</ul>
</div>
