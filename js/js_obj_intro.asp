...
<li class="currentLink"><a href="js_obj_intro.asp" title="JavaScript 对象">JS 对象</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_datatypes.asp" title="JavaScript 数据类型">JS 数据类型</a></li>
<li class="next"><a href="js_functions.asp" title="JavaScript 函数">JS 函数</a></li>
</ul>
</div>
