...
<h2>JS 对象</h2>
<ul>
<li class="currentLink"><a href="js_objects.asp" title="JavaScript 对象">JS 对象</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_htmldom_elements.asp" title="JavaScript HTML DOM 元素（节点）">DOM 节点</a></li>
<li class="next"><a href="js_obj_number.asp" title="JavaScript Number 对象">JS 数字</a></li>
</ul>
</div>
