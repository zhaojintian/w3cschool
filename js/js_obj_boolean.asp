...
<li class="currentLink"><a href="js_obj_boolean.asp" title="JavaScript Boolean 对象">JS 逻辑</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_obj_array.asp" title="JavaScript Array 对象">JS 数组</a></li>
<li class="next"><a href="js_obj_math.asp" title="JavaScript Math 对象">JS 算数</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jseg_obj_boolean_create_false">亲自试一试</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jseg_obj_boolean_create_true">亲自试一试</a></p>
</div>
