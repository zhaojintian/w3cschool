...
<li class="currentLink"><a href="pro_js_value.asp" title="ECMAScript 值">ECMAScript 值</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="pro_js_reservedwords.asp" title="ECMAScript 保留字">ECMAScript 保留字</a></li>
<li class="next"><a href="pro_js_primitivetypes.asp" title="ECMAScript 原始类型">ECMAScript 原始类型</a></li>
</ul>
</div>
