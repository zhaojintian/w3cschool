...
<li class="currentLink"><a href="quality_styles.asp" title="Web 品质 - 样式表">样式表</a></li>
<li><a href="quality_readability.asp" title="Web 品质 - 可读性">可读性</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="quality_elements.asp" title="Web 品质 - 重要的 HTML 元素">HTML 元素</a></li>
<li class="next"><a href="quality_readability.asp" title="Web 品质 - 可读性">可读性</a></li>
</ul>
</div>
