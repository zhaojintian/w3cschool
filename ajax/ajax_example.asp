...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>AJAX 实例</TITLE>
...
<UL>
  ...
  <LI class=currentLink><A title="AJAX 实例" href="ajax_example.asp">AJAX 实例</A> 
  </LI></UL>
<H2>AJAX XHR</H2>
<UL>
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="AJAX 简介" href="ajax_intro.asp">AJAX 简介</A> </LI>
  <LI class=next><A title="AJAX - 创建 XMLHttpRequest 对象" 
  href="ajax_xmlhttprequest_create.asp">XHR 创建对象</A> </LI></UL></DIV>
<DIV id=intro>
<P><STRONG>为了帮助您理解 AJAX 的工作原理，我们创建了一个小型的 AJAX 应用程序。</STRONG></P></DIV>
<DIV>
<H2>实例</H2>
<DIV id=myDiv>
<H3>Let AJAX change this text</H3></DIV><BUTTON onclick=loadXMLDoc()>通过 AJAX 
改变内容</BUTTON> </DIV>
<DIV>
<H2>AJAX 实例解释</H2>
<P>上面的 AJAX 应用程序包含一个 div 和一个按钮。</P>
<P>div 部分用于显示来自服务器的信息。当按钮被点击时，它负责调用名为 loadXMLDoc() 的函数：</P><PRE>&lt;html&gt;
&lt;body&gt;
...
<P>接下来，在页面的 head 部分添加一个 &lt;script&gt; 标签。该标签中包含了这个 loadXMLDoc() 函数：</P><PRE>&lt;head&gt;
&lt;script type="text/javascript"&gt;
function loadXMLDoc()
{
...
<P>下面的章节会为您讲解 AJAX 的工作原理。</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="AJAX 简介" href="ajax_intro.asp">AJAX 简介</A> </LI>
  <LI class=next><A title="AJAX - 创建 XMLHttpRequest 对象" 
  href="ajax_xmlhttprequest_create.asp">XHR 创建对象</A> </LI></UL></DIV></DIV>
<DIV id=sidebar>
<DIV id=searchui>
