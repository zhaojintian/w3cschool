...
<UL>
  ...
  <LI class=currentLink><A title="AJAX 简介" href="ajax_intro.asp">AJAX 简介</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="AJAX 教程" href="index.asp">AJAX 教程</A> </LI>
  <LI class=next><A title="AJAX 实例" href="ajax_example.asp">AJAX 实例</A> 
</LI></UL></DIV>
<DIV id=intro>
<P><STRONG>AJAX 是一种在无需重新加载整个网页的情况下，能够更新部分网页的技术。</STRONG></P></DIV>
<DIV>
<H2>您应当具备的基础知识</H2>
...
<UL>
  <LI>HTML / XHTML 
  <LI>CSS 
  <LI>JavaScript / DOM </LI></UL>
<P>如果您希望首先学习这些项目，请在我们的<A title="W3School 在线教程" 
...
<P>有很多使用 AJAX 的应用程序案例：新浪微博、Google 地图、开心网等等。</P></DIV>
<DIV>
<H2>Google Suggest</H2>
<P>在 2005 年，Google 通过其 Google Suggest 使 AJAX 变得流行起来。</P>
<P>Google Suggest 使用 AJAX 创造出动态性极强的 web 界面：当您在谷歌的搜索框输入关键字时，JavaScript 
会把这些字符发送到服务器，然后服务器会返回一个搜索建议的列表。</P></DIV>
<DIV>
<H2>今天就开始使用 AJAX</H2>
<P>AJAX 基于已有的标准。这些标准已被大多数开发者使用多年。</P>
<P>请阅读下一章，看看 AJAX 是如何工作的！</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="AJAX 教程" href="index.asp">AJAX 教程</A> </LI>
  <LI class=next><A title="AJAX 实例" href="ajax_example.asp">AJAX 实例</A> 
