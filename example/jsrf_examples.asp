...
<h2>JS 实例和测验</h2>
<ul>
<li><a href="jseg_examples.asp" title="JavaScript 实例">JS 实例</a></li>
<li class="currentLink"><a href="jsrf_examples.asp" title="JavaScript 对象实例">JS 对象实例</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="jseg_examples.asp" title="JavaScript 实例">JS 实例</a></li>
