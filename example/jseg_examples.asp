...
<h2>JS 实例和测验</h2>
<ul>
<li class="currentLink"><a href="jseg_examples.asp" title="JavaScript 实例">JS 实例</a></li>
<li><a href="jsrf_examples.asp" title="JavaScript 对象实例">JS 对象实例</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="../js/js_library_prototype.asp" title="JavaScript 测试 Prototype">JS Prototype</a></li>
<li class="next"><a href="jsrf_examples.asp" title="JavaScript 对象实例">JS 对象实例</a></li>
</ul>
</div>
