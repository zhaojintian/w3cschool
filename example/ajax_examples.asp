...
<h2>AJAX 实例</h2>
<ul>
<li class="currentLink"><a href="ajax_examples.asp" title="AJAX 实例">AJAX 实例</a></li>
</ul>
</div><div id="selected">
<h2>建站手册</h2>
<ul>
...
<p class="tiy"><a  href="../tiy/t.asp@f=ajax_httprequest_js_1">通过 XML HTTP 把文本文件载入 HTML 元素</a></p>

<p class="tiy"><a  href="../tiy/t.asp@f=ajax_httprequest_js">通过 XML HTTP 加载 XML 文件</a></p>

<p class="tiy"><a  href="../tiy/t.asp@f=ajax_httprequest_js_2">通过 XML HTTP 进行一次 HEAD 请求</a></p>

<p class="tiy"><a  href="../tiy/t.asp@f=ajax_httprequest_js_3">通过 XML HTTP 进行一次指定的 HEAD 请求</a></p>

<p class="tiy"><a  href="../tiy/t.asp@f=ajax_httprequest_js_4">把 XML 文件显示为 HTML 表格</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=ajax_httpsuggest">当用户键入文本时，通过使用 XML HTTP 与服务器进行在线通信</a></p>
