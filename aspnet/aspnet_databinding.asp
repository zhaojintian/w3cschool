...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP.NET - 数据绑定</TITLE>
...
<UL>
  ...
  <LI class=currentLink><A title="WebForms Data Binding" 
  href="aspnet_databinding.asp">WebForms 数据绑定</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="WebForms Button" href="aspnet_button.asp">WebForms 
  Button</A> </LI>
  <LI class=next><A title="WebForms ArrayList" 
  href="aspnet_arraylist.asp">WebForms ArrayList</A> </LI></UL></DIV>
<DIV id=intro>
<P><STRONG>我们可以使用数据绑定（Data Binding）来完成带有可选项目的列表，这些可选项目来自某个导入的数据源，比如数据库、XML 
文件或脚本。</STRONG></P></DIV>
<DIV>
<H2>数据绑定</H2>
...
<P>通常在一个或多个 asp:ListItem 控件中定义以上每个控件中的可选项目，类似这样：</P><PRE>&lt;html&gt;
&lt;body&gt;
...
<P>在下面的三节中，我们将描述如何从脚本化的数据源中绑定数据。</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="WebForms Button" href="aspnet_button.asp">WebForms 
  Button</A> </LI>
  <LI class=next><A title="WebForms ArrayList" 
  href="aspnet_arraylist.asp">WebForms ArrayList</A> </LI></UL></DIV></DIV>
<DIV id=sidebar>
<DIV id=searchui>
