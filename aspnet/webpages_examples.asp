...
<HTML lang=zh-cn><HEAD><TITLE>ASP.NET Web Pages - C# 和 VB 中的例子</TITLE>
<META charset=gb2312>
...
<UL>
  ...
  <LI class=currentLink><A title="WebPages 实例" 
  href="webpages_examples.asp">WebPages 实例</A> </LI></UL>
<H2>WP 参考手册</H2>
<UL>
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="WebPages 发布" href="webpages_publish.asp">WebPages 
  发布</A> </LI>
  <LI class=next><A title="WebPages 类" href="webpages_ref_classes.asp">WebPages 
  类</A> </LI></UL></DIV>
<DIV id=intro>
<P>通过 C# 和 Visual Basic 实例来学习 ASP.NET Web Pages。</P></DIV>
<DIV>
  ...
  <TR>
    <TD>
      ...
      <UL>
        <LI>显示日期和事件 
        <LI>可重复使用的页面和页脚 
        <LI>基本的 HTML 表单 </LI></UL>
      <P style="FONT-WEIGHT: bold; MARGIN-TOP: 15px">例子解释</P></TD>
    <TD>
      <H2 style="MARGIN-BOTTOM: 15px; FONT-SIZE: 12px">基本的 Web Pages</H2>
      <UL>
        <LI>显示日期和事件 
        <LI>可重复使用的页面和页脚 
        <LI>基本的 HTML 表单 </LI></UL>
      <P style="FONT-WEIGHT: bold; MARGIN-TOP: 15px">例子解释</P></TD></TR>
  <TR>
    <TD>
  ...
  <TR>
    ...
    <TD>
      ...
      <UL>
        ...
        <LI>显示来自 XML 文件的饼图 </LI></UL>
      <P 
style="FONT-WEIGHT: bold; MARGIN-TOP: 15px">例子解释</P></TD></TR></TBODY></TABLE></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="WebPages 发布" href="webpages_publish.asp">WebPages 
  发布</A> </LI>
  <LI class=next><A title="WebPages 类" href="webpages_ref_classes.asp">WebPages 
  类</A> </LI></UL></DIV></DIV><!-- maincontent end -->
<DIV id=sidebar>
<DIV id=searchui>
