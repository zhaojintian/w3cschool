...
<HTML lang=zh-cn><HEAD><TITLE>ASP.NET Web Pages - WebMail 帮助器</TITLE>
<META charset=gb2312>
...
<UL>
  ...
  <LI class=currentLink><A title="WebPages 电邮" 
  href="webpages_email.asp">WebPages 电邮</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="WebPages 图表" href="webpages_chart.asp">WebPages 图表</A> 
  </LI>
  <LI class=next><A title="WebPages PHP" href="webpages_php.asp">WebPages 
  PHP</A> </LI></UL></DIV>
<DIV id=intro>
<P>WebMail 帮助器 - 众多有用的 ASP.NET Web 帮助器之一。</P></DIV>
<DIV>
<H2>WebMail 帮助器</H2>
<P>WebMail 帮助器使我们更容易从 web 应用程序中使用 SMTP 来发送电邮。</P></DIV>
<DIV>
<H2>脚本: Email 支持</H2>
<P>为了演示电子邮件的使用，我们将创建用于技术支持的输入页面，让用户向另一个页面提交该页面，然后发送一封有关支持问题的电子邮件。</P></DIV>
<DIV>
...
<P><EM>From</EM>: 出现在 from 栏中的电邮地址（通常与 UserName 相同）。</P></DIV>
<DIV>
<H2>第二：创建电邮输入页面</H2>
<P>然后创建输入页面，名为 Email_Input：</P>
<H3>Email_Input.cshtml</H3><PRE>&lt;!DOCTYPE html&gt; 
&lt;html&gt; 
&lt;body&gt; 
...
<P>输入页面的作用是收集信息，然后把数据提交到一个能够将信息作为邮件来发送的新页面。</P></DIV>
<DIV>
<H2>第三：创建邮件发送页面</H2>
<P>然后创建用于发送电邮的页面，名为 Email_Send：</P>
<H3>Email_Send.cshtml</H3><PRE>@{ // Read input
...
<P>如需更多有关从 ASP.NET Web Pages 应用程序发送电子邮件的信息，请参阅：<A 
title="ASP.NET Web Pages - WebMail 对象" href="webpages_ref_webmail.asp">WebMail 
对象参考手册</A>。</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="WebPages 图表" href="webpages_chart.asp">WebPages 图表</A> 
  ...
  <LI class=next><A title="WebPages PHP" href="webpages_php.asp">WebPages 
  PHP</A> </LI></UL></DIV></DIV><!-- maincontent end -->
<DIV id=sidebar>
<DIV id=searchui>
