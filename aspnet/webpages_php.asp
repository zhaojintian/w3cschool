...
<HTML lang=zh-cn><HEAD><TITLE>ASP.NET Web Pages - PHP</TITLE>
<META charset=gb2312>
...
<UL>
  ...
  <LI class=currentLink><A title="WebPages PHP" href="webpages_php.asp">WebPages 
  PHP</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="WebPages 电邮" href="webpages_email.asp">WebPages 电邮</A> 
  </LI>
  <LI class=next><A title="WebPages 发布" href="webpages_publish.asp">WebPages 
  发布</A> </LI></UL></DIV>
<DIV id=intro>
<P>PHP 开发者请注意。可以使用 PHP 来编写 Web Pages。</P></DIV>
<DIV>
<H2>WebMatrix 支持 PHP</H2>
<P>WebMatrix 给人的第一印象是仅支持微软的技术。这并不准确。在 WebMatrix 中，您能够编写搭配 MySQL 的完整 PHP 
应用程序。</P></DIV>
<DIV>
<H2>创建 PHP 站点</H2>
<P>在 ASP.NET Web Pages - 创建网站这章中，我们创建了一个名为 "Demo" 的空网站，并在其中创建了类型 "CSHTML" 
的新的空页面。</P>
<P>创建名为 "Demo_PHP" 的空站点，启用 PHP（见下图），创建 PHP 类型的新的空页面，名为 "index.php"，这样您就创建好了您的第一个 
PHP 站点。</P><IMG alt="WebMatrix 启用 PHP" src="../i/webmatrix_php.jpg"> </DIV>
<DIV>
<H2>创建 PHP 页面</H2>
<P>在文件 "index.php" 中编写如下代码：</P>
<H3>index.php</H3><PRE>&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;body&gt;
...
<P>运行该文件即可看到 PHP 已能运行。</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="WebPages 电邮" href="webpages_email.asp">WebPages 电邮</A> 
  </LI>
  <LI class=next><A title="WebPages 发布" href="webpages_publish.asp">WebPages 
  发布</A> </LI></UL></DIV></DIV><!-- maincontent end -->
<DIV id=sidebar>
<DIV id=searchui>
