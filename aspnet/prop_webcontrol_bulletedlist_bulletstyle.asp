...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP.NET BulletStyle 属性</TITLE>
...
<P><A title="ASP.NET BulletedList 控件" href="control_bulletedlist.asp">返回 ASP.NET 
BulletedList 控件参考手册</A></P></DIV>
<DIV>
<H2>定义和用法</H2>
<P>BulletStyle 属性用于获取或设置项目列表符号的样式。</P>
<H3>语法</H3><PRE>&lt;asp:BulletedList <CODE>BulletStyle="style"</CODE> runat="server"&gt;
  ...
  <TR>
    ...
    <TD>
      ...
      <UL>
        ...
        <LI>LowerAlpha - 小写字母 
        <LI>UpperAlpha - 大写字母 
        <LI>LowerRoman - 小写罗马数字 
        <LI>UpperRoman - 大写罗马数字 
        <LI>CustomImage - 定制图像（由 "BulletImageUrl" 属性定义） 
</LI></UL></TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>实例</H2>
<P>下面的例子设置了 BulletedList 控件的 BulletStyle 属性：</P><PRE>&lt;form runat="server"&gt;
...
<H2>实例</H2>
<DL>
  <DT>设置 BulletedList 控件的 BulletStyle 属性 </DT></DL></DIV>
<DIV class=backtoreference>
<P><A title="ASP.NET BulletedList 控件" href="control_bulletedlist.asp">返回 ASP.NET 
BulletedList 控件参考手册</A></P></DIV></DIV>
<DIV id=sidebar>
<DIV id=searchui>
