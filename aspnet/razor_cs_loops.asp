...
<HTML lang=zh-cn><HEAD><TITLE>ASP.NET Razor - C# 循环和数组</TITLE>
<META charset=gb2312>
...
<UL>
  ...
  <LI class=currentLink><A title="Razor C# 循环" href="razor_cs_loops.asp">Razor 
  C# 循环</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="Razor C# 变量" href="razor_cs_variables.asp">Razor C# 
  变量</A> </LI>
  <LI class=next><A title="Razor 外边距合并" href="razor_cs_logic.asp">Razor C# 
  逻辑</A> </LI></UL></DIV>
<DIV id=intro>
