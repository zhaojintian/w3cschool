...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP.NET - SortedList 对象</TITLE>
...
<UL>
  ...
  Hashtable</A> 
  <LI class=currentLink><A title="WebForms SortedList" 
  href="aspnet_sortedlist.asp">WebForms SortedList</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="WebForms Hashtable" 
  href="aspnet_hashtable.asp">WebForms Hashtable</A> </LI>
  <LI class=next><A title="WebForms XML 文件" href="aspnet_xml.asp">WebForms XML 
  文件</A> </LI></UL></DIV>
<DIV id=intro>
<P><STRONG>SortedList 对象兼有 ArrayList 和 Hashtable 对象的特性。</STRONG></P></DIV>
<DIV class=example>
<H2>实例</H2>
<DL>
  <DT><A href="../tiy/s.asp@f=demo_aspnet_sortedlist_radio_1">SortedList 
  RadiobuttonList 1</A> 
  <DT><A href="../tiy/s.asp@f=demo_aspnet_sortedlist_radio_2">SortedList 
  RadiobuttonList 2</A> 
  <DT><A href="../tiy/s.asp@f=demo_aspnet_sortedlist_drop_1">SortedList 
...
<P>下面的代码创建了一个名为 mycountries 的 SortedList，并添加了四个元素：</P><PRE>&lt;script runat="server"&gt;
sub Page_Load
...
<P>如需把数据绑定到 RadioButtonList 控件，首先请在 aspx 文件中创建一个 RadioButtonList 控件（没有任何 
...
&lt;/body&gt;
&lt;/html&gt;</PRE>
<P>然后我们添加一个子例程，该子例程会在用户点击 RadioButtonList 控件中的项目时执行。当单选按钮被点击时，文本将出现在 label 
中：</P><PRE>&lt;script runat="server"&gt;
sub Page_Load
if Not Page.IsPostBack then
  dim mycountries=New SortedList
  mycountries.Add("C","China")
...
&lt;/html&gt;</PRE>
<P class=tiy><A 
href="../tiy/s.asp@f=demo_aspnet_sortedlist_radio_1">显示这个例子</A></P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="WebForms Hashtable" 
  href="aspnet_hashtable.asp">WebForms Hashtable</A> </LI>
