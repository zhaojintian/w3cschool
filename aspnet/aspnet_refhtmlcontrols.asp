...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>HTML 服务器控件</TITLE>
...
<H2>WF 参考手册</H2>
<UL>
  <LI class=currentLink><A title="WebForms HTML" 
  href="aspnet_refhtmlcontrols.asp">WebForms HTML</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="WebForms 实例" href="aspnet_examples.asp">WebForms 
  实例</A> </LI>
  <LI class=next><A title="WebForms Controls" 
  href="aspnet_refwebcontrols.asp">WebForms Controls</A> </LI></UL></DIV>
<DIV id=intro>
<P><STRONG>HTML 服务器控件是服务器可理解的 HTML 标签。</STRONG></P></DIV>
<DIV>
<H2>HTML 服务器控件</H2>
<P>ASP.NET 文件中的 HTML 元素默认作为文本进行处理。为了使这些元素可编程化，需要向 HTML 元素添加 runat="server" 
属性。该属性指示该元素应作为服务器控件进行处理。</P>
<P class=note><SPAN>注释：</SPAN>所有 HTML 服务器控件必须位于带有 runat="server" 属性的 
&lt;form&gt; 标签内！</P>
...
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TH>描述</TH></TR>
  <TR>
    <TD><A title="ASP.NET HtmlAnchor 控件" 
      href="control_htmlanchor.asp">HtmlAnchor</A></TD>
    <TD>控制 &lt;a&gt; HTML 元素</TD></TR>
  <TR>
    <TD><A title="ASP.NET HtmlButton 控件" 
      href="control_htmlbutton.asp">HtmlButton</A></TD>
    <TD>控制 &lt;button&gt; HTML 元素</TD></TR>
  <TR>
    <TD><A title="ASP.NET HtmlForm 控件" 
    href="control_htmlform.asp">HtmlForm</A></TD>
    <TD>控制 &lt;form&gt; HTML 元素</TD></TR>
  <TR>
    <TD><A title="ASP.NET HtmlGeneric 控件" 
      href="control_htmlgeneric.asp">HtmlGeneric</A></TD>
    <TD>控制其他未被具体的 HTML 服务器控件规定的 HTML 元素，比如 &lt;div&gt;。</TD></TR>
  <TR>
    <TD><A title="ASP.NET HtmlImage 控件" 
      href="control_htmlimage.asp">HtmlImage</A></TD>
    <TD>控制 &lt;image&gt; HTML 元素</TD></TR>
  <TR>
    <TD><A title="ASP.NET HtmlInputButton 控件" 
      href="control_htmlinputbutton.asp">HtmlInputButton</A></TD>
    <TD>控制 &lt;input type="button"&gt; 、&lt;input type="submit"&gt; 以及 
      &lt;input type="reset"&gt;</TD></TR>
  <TR>
    <TD><A title="ASP.NET HtmlInputCheckBox 控件" 
      href="control_htmlinputcheckbox.asp">HtmlInputCheckBox</A></TD>
    <TD>控制 &lt;input type="checkbox"&gt; HTML 元素</TD></TR>
  <TR>
    <TD><A title="ASP.NET HtmlInputFile 控件" 
      href="control_htmlinputfile.asp">HtmlInputFile</A></TD>
    <TD>控制 &lt;input type="file"&gt; HTML 元素</TD></TR>
  <TR>
    <TD><A title="ASP.NET HtmlInputHidden 控件" 
      href="control_htmlinputhidden.asp">HtmlInputHidden</A></TD>
    <TD>控制 &lt;input type="hidden"&gt; HTML 元素</TD></TR>
  <TR>
    <TD><A title="ASP.NET HtmlInputImage 控件" 
      href="control_htmlinputimage.asp">HtmlInputImage</A></TD>
    <TD>控制 &lt;input type="image"&gt; HTML 元素</TD></TR>
  <TR>
    <TD><A title="ASP.NET HtmlInputRadioButton 控件" 
      href="control_htmlinputradiobutton.asp">HtmlInputRadioButton</A></TD>
    <TD>控制 &lt;input type="radio"&gt; HTML 元素</TD></TR>
  <TR>
    <TD><A title="ASP.NET HtmlInputText 控件" 
      href="control_htmlinputtext.asp">HtmlInputText</A></TD>
    <TD>控制 &lt;input type="text"&gt; 和 &lt;input type="password"&gt; HTML 
  元素</TD></TR>
  <TR>
    <TD><A title="ASP.NET HtmlSelect 控件" 
      href="control_htmlselect.asp">HtmlSelect</A></TD>
    <TD>控制 &lt;select&gt; HTML 元素</TD></TR>
  <TR>
    <TD><A title="ASP.NET HtmlTable 控件" 
      href="control_htmltable.asp">HtmlTable</A></TD>
    <TD>控制 &lt;table&gt; HTML 元素</TD></TR>
  <TR>
    <TD><A title="ASP.NET HtmlTableCell 控件" 
      href="control_htmltablecell.asp">HtmlTableCell</A></TD>
    <TD>控制 &lt;td&gt; 和 &lt;th&gt; HTML 元素</TD></TR>
  <TR>
    <TD><A title="ASP.NET HtmlTableRow 控件" 
      href="control_htmltablerow.asp">HtmlTableRow</A></TD>
    <TD>控制 &lt;tr&gt; HTML 元素</TD></TR>
  <TR>
    <TD><A title="ASP.NET HtmlTextArea 控件" 
      href="control_htmltextarea.asp">HtmlTextArea</A></TD>
    <TD>控制 &lt;textarea&gt; HTML 元素</TD></TR></TBODY></TABLE></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="WebForms 实例" href="aspnet_examples.asp">WebForms 
  实例</A> </LI>
  <LI class=next><A title="WebForms Controls" 
  href="aspnet_refwebcontrols.asp">WebForms Controls</A> </LI></UL></DIV></DIV>
<DIV id=sidebar>
<DIV id=searchui>
