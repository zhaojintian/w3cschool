...
<HTML lang=zh-cn><HEAD><TITLE>ASP.NET Web Pages - 帮助器</TITLE>
<META charset=gb2312>
...
<UL>
  ...
  <LI class=currentLink><A title="WebPages 帮助器" 
  href="webpages_helpers.asp">WebPages 帮助器</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="WebPages 文件" href="webpages_files.asp">WebPages 文件</A> 
  </LI>
  <LI class=next><A title="WebPages WebGrid" 
  href="webpages_webgrid.asp">WebPages WebGrid</A> </LI></UL></DIV>
<DIV id=intro>
<P>Web Helpers 极大地简化了 web 开发和常见的编程任务。</P></DIV>
<DIV>
<H2>ASP.NET 帮助器</H2>
...
<P>下面是对一些有用的 Razor 帮助器的简要描述：</P></DIV>
<DIV>
<H2>WebGrid 帮助器</H2>
<P>WebGrid 帮助器简化了显示数据的方法：</P>
<UL>
  <LI>自动建立显示数据的 HTML 表格 
  <LI>支持不同的格式化选项 
  <LI>支持对数据的分页（第一页、下一页、上一页、最后一页） 
  <LI>支持通过点击列标题进行排序 </LI></UL></DIV>
<DIV>
<H2>Chart 帮助器</H2>
<P>"Chart Helper" 能够显示出带有不同格式选项和标记的不同类型的图表图片。</P>
<P>Chart 帮助器能够显示数组、数据库或文件中的数据。</P></DIV>
<DIV>
<H2>WebMail 帮助器</H2>
<P>WebMail 帮助器提供了使用 SMTP (Simple Mail Transfer Protocol) 来发送电邮消息的功能。</P></DIV>
<DIV>
<H2>WebImage 帮助器</H2>
<P>WebImage 帮助器提供了在网页中管理图片的功能。</P>
<P>关键词：剪裁、旋转、调整尺寸、水印。</P></DIV>
<DIV>
<H2>第三方帮助器</H2>
<P>通过 Razor，您能够利用内建的第三方帮助器来简化对电邮、数据库、多媒体和社交网络的使用，以及许多其他的问题比如导航和网络安全。</P></DIV>
<DIV>
<H2>安装帮助器</H2>
<P>WebMatrix 已包含了一些帮助器，但是您同样可以安装其他帮助器。</P>
<P>在 <A title="ASP.NET Web Pages - 更多帮助器" 
href="webpages_ref_helpers.asp">W3School 的 Helper 
参考手册</A>中，我们提供了相关的快速参考，关于您能够安装的（属于名为 ASP.NET Web Helpers Library 
的一部分的）内建帮助器和其他帮助器。</P>
<P>如果您的网站在 WebMatrix 中创建，请使用如下步骤来安装帮助器：</P>
<OL>
  <LI>在 WebMatrix 中，打开 <B>Site</B> workspace 
  <LI>点击 <B>Web Pages Administration</B> 
  <LI>使用密码登陆 Web Pages Administration 
  <LI>使用<B>搜索字段</B>搜素帮助器 
  <LI>点击<B>安装</B>来安装您需要的帮助器 </LI></OL>
<P>（* 首次使用 Web Pages Administration 时，将提示您创建密码）</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="WebPages 文件" href="webpages_files.asp">WebPages 文件</A> 
  </LI>
  <LI class=next><A title="WebPages WebGrid" 
  href="webpages_webgrid.asp">WebPages WebGrid</A> </LI></UL></DIV></DIV><!-- maincontent end -->
<DIV id=sidebar>
<DIV id=searchui>
