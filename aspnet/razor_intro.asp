...
<HTML lang=zh-cn><HEAD><TITLE>ASP.NET Razor - 标记</TITLE>
<META charset=gb2312>
...
<H2>ASP.NET Razor</H2>
<UL>
  <LI class=currentLink><A title="Razor 简介" href="razor_intro.asp">Razor 简介</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="WebPages 助手" href="webpages_ref_helpers.asp">WebPages 
  助手</A> </LI>
  <LI class=next><A title="Razor 语法" href="razor_syntax.asp">Razor 语法</A> 
</LI></UL></DIV>
<DIV id=intro>
<P>Razor 不是编程语言。它是服务器端标记语言。</P></DIV>
<DIV>
<H2>什么是 Razor ？</H2>
...
<P>Razor 基于 ASP.NET，它为 web 应用程序的创建而设计。它拥有传统 ASP.NET 标记的能力，但更易使用，也更易学习。</P></DIV>
<DIV>
<H2>Razor 语法</H2>
...
<H3>Web Forms（以及 Classic ASP）：</H3><PRE>&lt;ul&gt;
&lt;% for (int i = 0; i &lt; 10; i++) { %&gt;
&lt;li&gt;&lt;% =i %&gt;&lt;/li&gt;
&lt;% } %&gt;
&lt;/ul&gt;
...
<UL>
  ...
  <LI>Sending Email 
  <LI>Validation </LI></UL></DIV>
<DIV>
<H2>Razor 编程语言</H2>
<P>Razor 同时支持 C# (C sharp) 和 VB (Visual Basic)。</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="WebPages 助手" href="webpages_ref_helpers.asp">WebPages 
  助手</A> </LI>
