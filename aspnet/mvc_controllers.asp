...
<li class="currentLink"><a href="mvc_controllers.asp" title="MVC 控制器">MVC 控制器</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="mvc_layout.asp" title="MVC 布局">MVC 布局</a></li>
<li class="next"><a href="mvc_views.asp" title="MVC 视图">MVC 视图</a></li>
</ul>
</div>
