...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP.NET Button 控件</TITLE>
...
<P><A title="Web 服务器控件" href="aspnet_refwebcontrols.asp">Web 
服务器控件参考手册</A></P></DIV>
<DIV>
<H2>定义和用法</H2>
<P>Button 控件用于显示按钮。按钮可以是提交按钮或命令按钮。默认地，该控件是提交按钮。</P>
<P>提交按钮没有命令名称，在它被点击时它会把网页传回服务器。可以编写事件句柄来控制提交按钮被点击时执行的动作。</P>
<P>命令按钮拥有命令名称，且允许您在页面上创建多个按钮控件。可以编写事件句柄来控制命令按钮被点击时执行的动作。</P></DIV>
<DIV>
<H2>属性</H2>
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TH>.NET</TH></TR>
  <TR>
    <TD><A title="ASP.NET CausesValidation 属性" 
      href="prop_webcontrol_button_causesvalidation.asp">CausesValidation</A></TD>
  ...
  <TR>
    ...
    <TD>1.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET OnClientClick 属性" 
      href="prop_webcontrol_button_onclientclick.asp">OnClientClick</A></TD>
    <TD>当按钮被点击时被执行的函数的名称。</TD>
    <TD>2.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET PostBackUrl 属性" 
      href="prop_webcontrol_button_postbackurl.asp">PostBackUrl</A></TD>
  ...
  <TR>
    ...
    <TD>1.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET Text 属性" 
      href="prop_webcontrol_button_text.asp">Text</A></TD>
    <TD>按钮上的文本。</TD>
    <TD>1.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET UseSubmitBehavior 属性" 
      href="prop_webcontrol_button_usesubmitbehavior.asp">UseSubmitBehavior</A></TD>
    <TD>一个值 ，该值指示 Button 控件使用浏览器的提交机制，还是使用 ASP.NET 的 postback 机制。</TD>
    <TD>2.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET ValidationGroup 属性" 
      href="prop_webcontrol_button_validationgroup.asp">ValidationGroup</A></TD>
    <TD>当 Button 控件回传服务器时，该 Button 所属的哪个控件组引发了验证。</TD>
    <TD>2.0</TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>Web 控件标准属性</H2><PRE>AccessKey, Attributes, BackColor, BorderColor, BorderStyle, BorderWidth, 
CssClass, Enabled, Font, EnableTheming, ForeColor, Height, IsEnabled, 
SkinID, Style, TabIndex, ToolTip, Width</PRE>
<P>如需完整描述，请访问 <A title="ASP.NET Web 控件标准属性" 
href="prop_webcontrol_standard.asp">Web 控件标准属性</A>。</P></DIV>
<DIV>
<H2>控件标准属性</H2><PRE>AppRelativeTemplateSourceDirectory, BindingContainer, ClientID, Controls, 
EnableTheming, EnableViewState, ID, NamingContainer, Page, Parent, Site, 
TemplateControl, TemplateSourceDirectory, UniqueID, Visible</PRE>
<P>如需完整描述，请访问<A title="ASP.NET 控件标准属性" 
href="prop_control_standard.asp">控件标准属性</A>。</P></DIV>
<DIV class=example>
<H2>实例</H2>
<DL>
  <DT><A href="../tiy/s.asp@f=demo_aspnet_button">Button</A> 
  <DD>在本例中，我们在 .aspx 文件中声明了一个提交 Button 控件。然后我们创建了一个事件句柄，在 Click 事件发生时可更改按钮上的文本。 
  <DT><A href="../tiy/s.asp@f=demo_aspnet_button_2">Button 2</A> 
  <DD>在本例中，我们在 .aspx 文件中声明了一个提交 Button 控件。然后我们创建了一个事件句柄，在 Click 
  事件发生时可更改按钮的文本和样式。 </DD></DL></DIV>
<DIV class=backtoreference>
<P><A title="Web 服务器控件" href="aspnet_refwebcontrols.asp">Web 
服务器控件参考手册</A></P></DIV></DIV>
<DIV id=sidebar>
<DIV id=searchui>
