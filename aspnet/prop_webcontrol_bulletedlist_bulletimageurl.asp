...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP.NET BulletImageUrl 属性</TITLE>
...
<H3>语法</H3><PRE>&lt;asp:BulletedList <CODE>BulletImageUrl="url"</CODE> runat="server"&gt;
...
<TABLE class=dataintable>
  ...
  <TR>
    <TD>url</TD>
    <TD>字符串值，规定要作为项目符号来使用的图像的 URL。</TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>实例</H2>
<P>下面的例子设置了 BulletedList 控件的 BulletImageUrl：</P><PRE>&lt;form runat="server"&gt;
...
<H2>实例</H2>
<DL>
  <DT>设置 RadioButtonList 控件的 BulletImageUrl </DT></DL></DIV>
<DIV class=backtoreference>
<P><A title="ASP.NET BulletedList 控件" href="control_bulletedlist.asp">返回 ASP.NET 
