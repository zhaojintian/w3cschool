...
<HTML lang=zh-cn><HEAD><TITLE>ASP.NET Web Pages - 页面布局</TITLE>
<META charset=gb2312>
...
<UL>
  ...
  <LI class=currentLink><A title="WebPages 布局" 
  href="webpages_layout.asp">WebPages 布局</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="WebPages Razor" href="webpages_razor.asp">WebPages 
  Razor</A> </LI>
  <LI class=next><A title="WebPages 文件夹" href="webpages_folders.asp">WebPages 
  文件夹</A> </LI></UL></DIV>
<DIV id=intro>
<P>通过 Web Pages，很容易创建布局一致的网站。</P></DIV>
<DIV>
<H2>一致的外观</H2>
...
<H3>任意网页：</H3><PRE>@{Layout="Layout.cshtml";}
...
<P>这些工具会为您省去大量的工作，因为您不必在所有页面上重复相同的信息。将标记、样式和代码集中起来，使得 web 
应用程序更便于管理和维护。</P></DIV>
<DIV>
<H2>防止代码泄露</H2>
...
<UL class=prenext>
  ...
  Razor</A> </LI>
  <LI class=next><A title="WebPages 文件夹" href="webpages_folders.asp">WebPages 
  文件夹</A> </LI></UL></DIV></DIV><!-- maincontent end -->
<DIV id=sidebar>
<DIV id=searchui>
