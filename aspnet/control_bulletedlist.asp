...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP.NET BulletedList 控件</TITLE>
...
<P class=note><SPAN>注释：</SPAN>它是 ASP.NET 2.0 中的新类。</P></DIV>
<DIV>
<H2>属性</H2>
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TH>.NET</TH></TR>
  <TR>
    <TD><A title="ASP.NET BulletImageUrl 属性" 
      href="prop_webcontrol_bulletedlist_bulletimageurl.asp">BulletImageUrl</A></TD>
    <TD>
      <P>规定定制的列表项目图形符号的 URL。</P>
      <P>在 "BulletStyle" 为 "CustomImage" 时使用。</P></TD>
    <TD>2.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET BulletStyle 属性" 
      href="prop_webcontrol_bulletedlist_bulletstyle.asp">BulletStyle</A></TD>
    <TD>规定项目符号列表的样式。</TD>
    <TD>2.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET DisplayMode 属性" 
      href="prop_webcontrol_bulletedlist_displaymode.asp">DisplayMode</A></TD>
    <TD>规定被显示的列表的类型。</TD>
    <TD>2.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET FirstBulletNumber 属性" 
      href="prop_webcontrol_bulletedlist_firstbulletnumber.asp">FirstBulletNumber</A></TD>
  ...
  <TR>
    ...
    <TD>1.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET Target 属性" 
      href="prop_webcontrol_bulletedlist_target.asp">Target</A></TD>
    <TD>规定在何处打开目标 URL。</TD>
    <TD>2.0</TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>ListControl 标准属性</H2><PRE>AppendDataBoundItems, AutoPostBack, CausesValidation, DataTextField,
...
<P>ListControl 控件包括列表控件的所有基本功能。继承自此控件的控件包括：CheckBoxList, DropDownList, ListBox 
以及 RadioButtonList 控件。</P>
<P>如需完整描述，请访问 <A title="ASP.NET ListControl 控件" 
href="control_listcontrol.asp">ListControl 标准属性</A>。</P></DIV>
<DIV>
