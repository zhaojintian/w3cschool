...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP.NET Target 属性</TITLE>
...
<H3>语法</H3><PRE>&lt;asp:AdRotator Target="target" runat="server" /&gt;</PRE>
<TABLE class=dataintable>
  ...
  <TR>
    <TD>path</TD>
    <TD>
      <P>字符串值，规定在何处打开目标 URL。</P></TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>实例</H2>
<P>下面的例子为 AdRotator 设置了目标窗口（在 TIY 中查看此 XML 文件）：</P><PRE>&lt;form runat="server"&gt;
...
<H2>实例</H2>
<DL>
  <DT>为 AdRotator 控件设置新的目标窗口 </DT></DL></DIV>
<DIV class=backtoreference>
<P><A title="ASP.NET AdRotator 控件" href="control_adrotator.asp">ASP.NET 
