...
<li class="currentLink"><a href="mvc_reference.asp" title="MVC 参考手册">MVC 参考手册</a></li>
</ul>
<h2>WF 教程</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="mvc_publish.asp" title="MVC 发布">MVC 发布</a></li>
<li class="next"><a href="aspnet_intro.asp" title="WebForms 简介">WebForms 简介</a></li>
</ul>
</div>
