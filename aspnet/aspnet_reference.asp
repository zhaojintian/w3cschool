...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP.NET 参考手册</TITLE>
...
<H1>ASP.NET 参考手册</H1>
<DIV id=intro>
<P><STRONG>W3School 提供完整的 ASP.NET 服务器控件参考手册。</STRONG></P></DIV>
<DIV>
<H2>HTML 服务器控件</H2>
...
<P><A title="HTML 服务器控件" href="aspnet_refhtmlcontrols.asp">HTML 
服务器控件参考手册</A></P></DIV>
<DIV>
<H2>Web 服务器控件</H2>
<P>类似 HTML 服务器控件，Web 服务器控件同样在服务器创建，且需要 runat="server" 属性才能工作。不过，Web 
服务器控件不必映射任何已有的 HTML 元素，它们可代表更复杂的元素。</P>
<H3>创建一个 Web 服务器控件的语法是：</H3><PRE>&lt;asp:control_name id="some_id" runat="server" /&gt;</PRE>
...
<P><A title="Validation 服务器控件" 
href="aspnet_refvalidationcontrols.asp">Validation 服务器控件参考手册</A></P></DIV></DIV>
<DIV id=sidebar>
<DIV id=searchui>
