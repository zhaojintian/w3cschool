...
<HTML lang=zh-cn><HEAD><TITLE>ASP.NET Razor - VB 变量</TITLE>
<META charset=gb2312>
...
<UL>
  ...
  <LI class=currentLink><A title="Razor VB 变量" 
  href="razor_vb_variables.asp">Razor VB 变量</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="Razor 外边距合并" href="razor_cs_logic.asp">Razor C# 逻辑</A> 
  </LI>
  <LI class=next><A title="Razor VB 循环" href="razor_vb_loops.asp">Razor VB 
  循环</A> </LI></UL></DIV>
<DIV id=intro>
<P>变量时用于存储数据的命名实体。</P></DIV>
<DIV>
<H2>变量</H2>
<P>变量用于存储数据。</P>
...
<H3>实例</H3><PRE><SPAN class=code_comment>// 使用 Dim 关键词：</SPAN>
...
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TD>
      <UL>
        <LI>if ready And clear 
        <LI>if ready Or clear </LI></UL></TD></TR>
  <TR>
    <TD>
      <UL>
        <LI>AndAlso 
    ...
    <TD>
      <UL>
        <LI>if ready AndAlso clear 
        <LI>if ready OrElse clear </LI></UL></TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>转换数据类型</H2>
  ...
  <TR>
    <TD>
      <UL>
        ...
        <LI>IsInt() </LI></UL></TD>
    <TD>把字符串转换为整数。</TD>
    <TD>if myString.IsInt() then<BR>myInt=myString.AsInt()<BR>end if </TD></TR>
  <TR>
    <TD>
      <UL>
        <LI>AsFloat() 
        <LI>IsFloat() </LI></UL></TD>
    <TD>把字符串转换为浮点数。</TD>
    <TD>if myString.IsFloat() then<BR>myFloat=myString.AsFloat()<BR>end if 
  </TD></TR>
  <TR>
    <TD>
      <UL>
    ...
    <TD>把字符串转换为十进制数。</TD>
    <TD>if myString.IsDecimal() then<BR>myDec=myString.AsDecimal()<BR>end if 
    </TD></TR>
  <TR>
    <TD>
      <UL>
    ...
    <TD>myString="10/10/2012"<BR>myDate=myString.AsDateTime()<BR></TD></TR>
  <TR>
    <TD>
      <UL>
        <LI>AsBool() 
        <LI>IsBool() </LI></UL></TD>
    <TD>把字符串转换为逻辑值。</TD>
    <TD>myString="True"<BR>myBool=myString.AsBool()<BR></TD></TR>
  <TR>
    <TD>ToString()</TD>
    <TD>把任意数据类型转换为字符串。</TD>
    <TD>myInt=1234<BR>myString=myInt.ToString()<BR></TD></TR></TBODY></TABLE></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="Razor 外边距合并" href="razor_cs_logic.asp">Razor C# 逻辑</A> 
  </LI>
