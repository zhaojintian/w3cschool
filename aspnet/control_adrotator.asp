...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP.NET AdRotator 控件</TITLE>
...
<P>该控件使用 XML 文件来存储 ad 信息。XML 文件使用 &lt;Advertisements&gt; 开始和结束。在 
&lt;Advertisements&gt; 标签内部，应该有若干个定义每条 ad 的 &lt;Ad&gt; 标签。</P>
...
<TABLE class=dataintable>
  ...
  <TR>
    <TD>&lt;NavigateUrl&gt;</TD>
    <TD>可选。用户点击该 ad 时所链接的 URL。</TD></TR>
  <TR>
    <TD>&lt;AlternateText&gt;</TD>
    <TD>可选。图像的可选文本。</TD></TR>
  <TR>
  ...
  <TR>
    <TD>&lt;Impressions&gt;</TD>
    <TD>可选。显示概率。</TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>属性</H2>
<TABLE class=dataintable>
  <TBODY>
  <TR>
    ...
    <TH>.NET</TH></TR>
  <TR>
    <TD><A title="ASP.NET AdvertisementFile 属性" 
      href="prop_webcontrol_adrotator_advertisementfile.asp">AdvertisementFile</A></TD>
  ...
  <TR>
    <TD><A title="ASP.NET Target 属性" 
      href="prop_webcontrol_adrotator_target.asp">Target</A></TD>
    <TD>在何处打开 URL。</TD>
...
<H2>实例</H2>
<DL>
  <DT><A href="../tiy/s.asp@f=demo_aspnet_adrotator">AdRotator</A> 
  <DD>在本例中，我们在 .aspx 文件中声明了一个 AdRotator 控件。然后我们再 .aspx 文件中为 AdCreated 
  事件创建了一个事件句柄，来覆盖 XML 文件中 NavigateUrl 元素的值。 </DD></DL></DIV>
<DIV class=backtoreference>
<P><A title="Web 服务器控件" href="aspnet_refwebcontrols.asp">Web 
