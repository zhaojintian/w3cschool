...
<HTML lang=zh-cn><HEAD><TITLE>ASP.NET Razor - VB 循环和数组</TITLE>
<META charset=gb2312>
...
<UL>
  ...
  <LI class=currentLink><A title="Razor VB 循环" href="razor_vb_loops.asp">Razor 
  VB 循环</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="Razor VB 变量" href="razor_vb_variables.asp">Razor VB 
  变量</A> </LI>
  <LI class=next><A title="Razor VB 逻辑" href="razor_vb_logic.asp">Razor VB 
  逻辑</A> </LI></UL></DIV>
<DIV id=intro>
<P>语句可以在循环中重复执行。</P></DIV>
<DIV>
<H2>For 循环</H2>
...
<UL class=prenext>
  ...
  变量</A> </LI>
  <LI class=next><A title="Razor VB 逻辑" href="razor_vb_logic.asp">Razor VB 
  逻辑</A> </LI></UL></DIV></DIV><!-- maincontent end -->
<DIV id=sidebar>
<DIV id=searchui>
