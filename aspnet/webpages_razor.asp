...
<HTML lang=zh-cn><HEAD><TITLE>ASP.NET Web Pages - 添加 Razor 代码</TITLE>
<META charset=gb2312>
...
<UL>
  ...
  <LI class=currentLink><A title="WebPages Razor" 
  href="webpages_razor.asp">WebPages Razor</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="WebPages 简介" href="webpages_intro.asp">WebPages 简介</A> 
  </LI>
  <LI class=next><A title="WebPages 布局" href="webpages_layout.asp">WebPages 
  布局</A> </LI></UL></DIV>
<DIV id=intro>
<P>在本教程中，我们将通过 C# 和 Visual Basic 代码来使用 Razor 标记。</P></DIV>
<DIV>
<H2>什么是 Razor？</H2>
<UL>
  <LI>Razor 是一种向网页添加基于服务器的代码的标记语法 
  <LI>Razor 拥有传统 ASP.NET 标记的能力，但是更易学习，更易使用 
  <LI>Razor 是一种类似 ASP 和 PHP 的服务器端标记语法 
  <LI>Razor 支持 C# 和 Visual Basic 编程语言 </LI></UL></DIV>
<DIV>
<H2>添加 Razor 代码</H2>
<P>记得上一章中的网页吗：</P><PRE>&lt;!DOCTYPE html&gt;
...
<P>Razor 代码的全部工作是检测服务器上的当前时间，然后显示出来。（您可以指定格式选项，或者仅仅以默认格式显示）</P></DIV>
<DIV>
...
<UL>
  ...
  <LI>字符串用引用来包围 
  <LI>C# 代码对大小写敏感 
  <LI>C# 文件的扩展名是 .cshtml </LI></UL>
<H3>C# 实例</H3><PRE><SPAN class=code_comment>&lt;!-- 单行代码块 --&gt;</SPAN>
...
<UL>
  <LI>Razor 代码块由 @Code ... End 包围 
  <LI>行内表达式（变量和函数）以 @ 开始 
  <LI>变量通过 Dim 关键词进行声明 
  <LI>字符串用引用来包围 
  <LI>C# 代码对大小写不敏感 
  <LI>C# 文件的扩展名是 .vbhtml </LI></UL>
<H3>实例</H3><PRE><SPAN class=code_comment>&lt;!-- 单行代码块 --&gt;</SPAN>
...
<P>如果希望学习更多有关 Razor 以及 C# 和 Visual Basic 编程语言的更多知识，请访问本教程的 <A 
title="ASP.NET Razor - 标记" href="razor_intro.asp">Razor 部分</A>。</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="WebPages 简介" href="webpages_intro.asp">WebPages 简介</A> 
  </LI>
  <LI class=next><A title="WebPages 布局" href="webpages_layout.asp">WebPages 
  布局</A> </LI></UL></DIV></DIV><!-- maincontent end -->
<DIV id=sidebar>
<DIV id=searchui>
