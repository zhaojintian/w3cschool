...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP.NET AdvertisementFile 属性</TITLE>
...
<P><A title="ASP.NET AdRotator 控件" href="control_adrotator.asp">ASP.NET 
AdRotator 控件参考手册</A></P></DIV>
<DIV>
<H2>定义和用法</H2>
<P>AdvertisementFile 属性用于设置或返回包含广告信息的 XML 文件的路径。</P>
<H3>语法</H3><PRE>&lt;asp:AdRotator AdvertisementFile="path" runat="server" /&gt;</PRE>
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TD>
      ...
      <P>可能的值：</P>
      <UL>
        <LI>绝对路径： (比如 http://www.w3school.com.cn/ads/bigad.xml) 
        <LI>虚拟根路径： (比如 ~/ads/bigad.xml) 
        <LI>相对路径：(比如 ../ads/bigad.xml). </LI></UL></TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>实例</H2>
<P>下面的例子声明了一个 AdRotator（在 TIY 中查看此 XML 文件）：</P><PRE>&lt;form runat="server"&gt;
&lt;asp:AdRotator id="ad1" runat="server" AdvertisementFile="Ad1.xml" /&gt;
&lt;/form&gt;</PRE></DIV>
<DIV class=example>
<H2>实例</H2>
<DL>
  <DT>设置 AdRotator 控件中的 AdvertismentFile 属性 </DT></DL></DIV>
<DIV class=backtoreference>
<P><A title="ASP.NET AdRotator 控件" href="control_adrotator.asp">ASP.NET 
AdRotator 控件参考手册</A></P></DIV></DIV>
<DIV id=sidebar>
<DIV id=searchui>
