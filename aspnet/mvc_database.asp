...
<li class="currentLink"><a href="mvc_database.asp" title="MVC 数据库">MVC 数据库</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="mvc_views.asp" title="MVC 视图">MVC 视图</a></li>
<li class="next"><a href="mvc_models.asp" title="MVC 模型">MVC 模型</a></li>
</ul>
</div>
...
<p>* 如果选项中没有 SQL Server Compact Local Database，则表示您尚未在计算机上安装 SQL Server Compact。请通过以下链接安装：<a href="../../www.microsoft.com/web/gallery/install.aspx@appid=SQLCE;SQLCEVSTools_4_0">SQL Server Compact</a></p>
