...
<li class="currentLink"><a href="mvc_layout.asp" title="MVC 布局">MVC 布局</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="mvc_folders.asp" title="MVC 文件夹">MVC 文件夹</a></li>
<li class="next"><a href="mvc_controllers.asp" title="MVC 控制器">MVC 控制器</a></li>
</ul>
</div>
...
<p>您可以在我们的 <a href="razor_intro.asp" title="ASP.NET Razor - 标记">Razor 教程</a>中学习 C# 和 VB (Visual Basic) 编写的 Razor 标记。</p>
</div>
