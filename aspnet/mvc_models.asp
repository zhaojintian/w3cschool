...
<li class="currentLink"><a href="mvc_models.asp" title="MVC 模型">MVC 模型</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="mvc_database.asp" title="MVC 数据库">MVC 数据库</a></li>
<li class="next"><a href="mvc_security.asp" title="MVC 安全">MVC 安全</a></li>
</ul>
</div>
