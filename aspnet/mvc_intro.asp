...
<h2>ASP.NET MVC</h2>
<ul>
<li class="currentLink"><a href="mvc_intro.asp" title="MVC 简介">MVC 简介</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="razor_vb_logic.asp" title="Razor VB 逻辑">Razor VB 逻辑</a></li>
<li class="next"><a href="mvc_app.asp" title="MVC 应用程序">MVC 应用程序</a></li>
</ul>
</div>
...
<p><a href="../../www.microsoft.com/web/handlers/webpi.ashx@command=getinstallerredirect&appid=VWDOrVs11AzurePack">Visual Web Developer 2012</a>（Windows 7 或 Windows 8）</p>

<p><a href="../../www.microsoft.com/web/gallery/install.aspx@appid=VWDorVS2010SP1Pack">Visual Web Developer 2010</a>（Windows Vista 或 XP）</p>
...
<p>在本教程的结尾，我们提供完整的 <a href="mvc_reference.asp" title="ASP.NET MVC - 参考手册">ASP.NET MVC 参考手册</a>。</p>
</div>
