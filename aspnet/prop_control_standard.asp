...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP.NET 控件标准属性</TITLE>
...
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TD>1.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET BindingContainer 属性" 
      href="prop_control_standard_bindingcontainer.asp">BindingContainer</A></TD>
    <TD>获取包含该控件的数据绑定的控件。</TD>
    <TD>1.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET ClientID 属性" 
      href="prop_control_standard_clientid.asp">ClientID</A></TD>
  ...
  <TR>
    ...
    <TD>1.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET ID 属性" href="prop_control_standard_id.asp">ID</A></TD>
    <TD>分配给该控件的 id。</TD>
    <TD>2.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET NamingContainer 属性" 
      href="prop_control_standard_namingcontainer.asp">NamingContainer</A></TD>
    <TD>获取对服务器控件的命名容器的引用，此引用创建唯一的命名空间，以区分具有相同 id 属性值的服务器控件。</TD>
    <TD>1.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET Page 属性" 
      href="prop_control_standard_page.asp">Page</A></TD>
    <TD>对包含该控件的页面的引用。</TD>
    <TD>1.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET Parent 属性" 
      href="prop_control_standard_parent.asp">Parent</A></TD>
    <TD>对该控件的父控件的引用。</TD>
    <TD>2.0</TD></TR>
  <TR>
    <TD>Site</TD>
    <TD>有关当前控件的容器的信息。 (Get value only)</TD>
    <TD>2.0</TD></TR>
  <TR>
  ...
  <TR>
    ...
    <TD>1.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET UniqueID 属性" 
      href="prop_control_standard_uniqueid.asp">UniqueID</A></TD>
    <TD>获取服务器控件的唯一的、以分层形式限定的标识符。</TD>
    <TD>1.0</TD></TR>
  <TR>
    <TD><A title="ASP.NET Visible 属性" 
      href="prop_control_standard_visible.asp">Visible</A></TD>
