...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>Validation 服务器控件</TITLE>
...
<UL>
  ...
  Controls</A> 
  <LI class=currentLink><A title="WebForms Validation" 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="WebForms Controls" 
  href="aspnet_refwebcontrols.asp">WebForms Controls</A> </LI>
  <LI class=next><A title="ASP.NET 教程" href="index.asp">ASP.NET 教程</A> 
</LI></UL></DIV>
<DIV id=intro>
<P><STRONG>Validation 服务器控件用于用于验证用户输入。</STRONG></P></DIV>
<DIV>
<H2>Validation 服务器控件</H2>
<P>Validation 服务器控件用于验证输入控件的数据。如果数据未通过验证，则向用户显示错误消息。</P>
<H3>创建 Validation 服务器控件的语法是：</H3><PRE>&lt;asp:control_name id="some_id" runat="server" /&gt;</PRE>
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TH>描述</TH></TR>
  <TR>
    <TD><A title="ASP.NET CompareValidator 控件" 
      href="control_comparevalidator.asp">CompareValidator</A></TD>
    <TD>把一个输入控件的值与另一个输入控件或一个固定的值进行对比。</TD></TR>
  <TR>
    <TD><A title="ASP.NET CustomValidator 控件" 
      href="control_customvalidator.asp">CustomValidator</A></TD>
    <TD>允许您编写一个方法，来处理输入值的验证。</TD></TR>
  <TR>
    <TD><A title="ASP.NET RangeValidator 控件" 
      href="control_rangevalidator.asp">RangeValidator</A></TD>
    <TD>在两个值的范围内检查输入的值。</TD></TR>
  <TR>
    <TD><A title="ASP.NET RegularExpressionValidator 控件" 
      href="control_regularexpvalidator.asp">RegularExpressionValidator</A></TD>
    <TD>确保输入控件的值匹配指定的模式。</TD></TR>
  <TR>
    <TD><A title="ASP.NET RequiredFieldValidator 控件" 
      href="control_reqfieldvalidator.asp">RequiredFieldValidator</A></TD>
    <TD>是输入控件成为必需（必填）的字段。</TD></TR>
  <TR>
    <TD><A title="ASP.NET ValidationSummary 控件" 
      href="control_validationsummary.asp">ValidationSummary</A></TD>
    <TD>显示网页中所有验证错误的报告。</TD></TR></TBODY></TABLE></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="WebForms Controls" 
  href="aspnet_refwebcontrols.asp">WebForms Controls</A> </LI>
