...
<li class="currentLink"><a href="aspnet_examples.asp" title="WebForms 实例">WebForms 实例</a></li>
</ul>
<h2>WF 参考手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="aspnet_navigation.asp" title="WebForms 导航">WebForms 导航</a></li>
<li class="next"><a href="aspnet_refhtmlcontrols.asp" title="WebForms HTML">WebForms HTML</a></li>
</ul>
</div>
