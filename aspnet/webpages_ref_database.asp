...
<HTML lang=zh-cn><HEAD><TITLE>ASP.NET Web Pages - Database 对象</TITLE>
<META charset=gb2312>
...
<UL>
  ...
  <LI class=currentLink><A title="WebPages 数据库" 
  href="webpages_ref_database.asp">WebPages 数据库</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="WebPages 安全" 
  href="webpages_ref_websecurity.asp">WebPages 安全</A> </LI>
  <LI class=next><A title="WebPages WebMail" 
  href="webpages_ref_webmail.asp">WebPages WebMail</A> </LI></UL></DIV>
<DIV>
...
<DL class=define>
  ...
  <DD>关闭打开的数据库。 
  <DT>Dispose() 
  <DD>释放由 Database 实例使用的所有资源。 
  <DT>Database.Execute(SQLstatement [, parameters] 
  <DD>执行 SQL 语句并返回受影响的记录。 
  <DT>Database.GetLastInsertId() 
  <DD>返回最近一次插入的行的标识列。 
  <DT>Database.Open(filename)<BR>Database.Open(connectionStringName) 
  <DD>使用指定的文件名或指定的连接字符串打开到数据库的连接。 
  <DT>Database.OpenConnectionString(connectionString) 
  <DD>使用指定的连接字符串打开到数据库的连接。 
  <DT>Database.Query(SQLstatement[, parameters]) 
  <DD>执行 SQL 查询，该查询将返回行的列表作为结果。 
  <DT>Database.QuerySingle(SQLstatement [, parameters]) 
  <DD>执行 SQL 查询，该查询将返回一行作为结果。 
  <DT>Database.QueryValue(SQLstatement [, parameters]) 
  <DD>执行 SQL 查询，该查询将返回一个标量值作为结果。 </DD></DL></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="WebPages 安全" 
  href="webpages_ref_websecurity.asp">WebPages 安全</A> </LI>
  <LI class=next><A title="WebPages WebMail" 
  href="webpages_ref_webmail.asp">WebPages WebMail</A> </LI></UL></DIV></DIV><!-- maincontent end -->
<DIV id=sidebar>
<DIV id=searchui>
