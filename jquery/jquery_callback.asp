...
<li class="currentLink"><a href="jquery_callback.asp" title="jQuery 回调函数">jQuery Callback</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="jquery_stop.asp" title="jQuery 停止动画">jQuery stop()</a></li>
<li class="next"><a href="jquery_chaining.asp" title="jQuery - Chaining">jQuery Chaining</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_hide_slow_wrong">亲自试一试</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_hide_slow_right">亲自试一试</a></p>
