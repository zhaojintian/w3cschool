...
<li class="currentLink"><a href="jquery_css_classes.asp" title="jQuery - 获取和设置 CSS 类">jQuery CSS 类</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="jquery_dom_remove.asp" title="jQuery - 删除元素">jQuery 删除</a></li>
<li class="next"><a href="jquery_css.asp" title="jQuery - css() 方法">jQuery css()</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_dom_addclass">亲自试一试</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_dom_addclass2">亲自试一试</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_dom_removeclass">亲自试一试</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_dom_toggleclass">亲自试一试</a></p>
</div>
...
<p>如需有关 jQuery CSS 方法的完整内容，请访问我们的 <a href="jquery_ref_css.asp" title="jQuery 参考手册 - CSS 操作">jQuery CSS 操作参考手册</a></p>
</div>
