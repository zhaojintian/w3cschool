...
<li class="currentLink"><a href="jquery_ref_prop.asp" title="jQuery 属性">jQuery 属性</a></li>
</ul>
</div><div id="selected">
<h2>建站手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="jquery_ref_core.asp" title="jQuery 参考手册 - 核心">jQuery 核心</a></li>
<li class="next"><a href="index.asp" title="jQuery 教程">jQuery 教程</a></li>
</ul>
</div>
...
<tr>
<td><a href="prop_context.asp" title="jQuery CSS 操作 - css() 方法">context</a></td>
<td>在版本 1.10 中被弃用。包含传递给 jQuery() 的原始上下文。</td>
</tr>

<tr>
<td><a href="prop_jquery.asp" title="jQuery CSS 操作 - height() 方法">jquery</a></td>
<td>包含 jQuery 版本号。</td>
</tr>

<tr>
<td><a href="prop_jquery_fx_interval.asp" title="jQuery CSS 操作 - offset() 方法">jQuery.fx.interval</a></td>
<td>改变以毫秒计的动画速率。</td>
</tr>

<tr>
<td><a href="prop_jquery_fx_off.asp" title="jQuery CSS 操作 - offsetParent() 方法">jQuery.fx.off</a></td>
<td>全局禁用/启用所有动画。</td>
</tr>

<tr>
<td><a href="prop_jquery_support.asp" title="jQuery CSS 操作 - position() 方法">jQuery.support</a></td>
<td>表示不同浏览器特性或漏洞的属性集合（用于 jQuery 内部使用）。</td>
</tr>

<tr>
<td><a href="prop_length.asp" title="jQuery CSS 操作 - scrollLeft() 方法">length</a></td>
