...
<li class="currentLink"><a href="jquery_slide.asp" title="jQuery 效果 - 滑动">jQuery 滑动</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="jquery_fade.asp" title="jQuery jQuery 效果 - 淡入淡出">jQuery 淡入淡出</a></li>
<li class="next"><a href="jquery_animate.asp" title="jQuery 效果 - 动画">jQuery 动画</a></li>
</ul>
</div>
