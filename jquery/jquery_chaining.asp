...
<li class="currentLink"><a href="jquery_chaining.asp" title="jQuery - Chaining">jQuery Chaining</a></li>
</ul>
<h2>jQuery HTML</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="jquery_callback.asp" title="jQuery 回调函数">jQuery Callback</a></li>
<li class="next"><a href="jquery_dom_get.asp" title="jQuery - 获取内容和属性">jQuery 获取</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_chaining">亲自试一试</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_chaining2">亲自试一试</a></p>
