...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_ajax_serializearray">亲自试一试</a></p>
</div>
...
<p>.serializeArray() 方法使用了 W3C 关于 <a href="../../www.w3.org/TR/html401/interact/forms.html#h-17.13.2">successful controls</a>（有效控件） 的标准来检测哪些元素应当包括在内。特别说明，元素不能被禁用（禁用的元素不会被包括在内），并且元素应当有含有 name 属性。提交按钮的值也不会被序列化。文件选择元素的数据也不会被序列化。
