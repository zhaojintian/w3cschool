...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_ajax_getscript">亲自试一试</a></p>
</div>
...
<p>载入 <a title="http://jquery.com/plugins/project/color" class="external text" href="../../jquery.com/plugins/project/color">jQuery 官方颜色动画插件</a> 成功后绑定颜色变化动画：</p>
