...
<h2>jQuery 效果</h2>
<ul>
<li class="currentLink"><a href="jquery_hide_show.asp" title="jQuery jQuery 效果 - 隐藏和显示">jQuery 隐藏/显示</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="jquery_events.asp" title="jQuery 事件">jQuery 事件</a></li>
<li class="next"><a href="jquery_fade.asp" title="jQuery jQuery 效果 - 淡入淡出">jQuery 淡入淡出</a></li>
</ul>
</div>
