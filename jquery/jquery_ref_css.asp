...
<li class="currentLink"><a href="jquery_ref_css.asp" title="jQuery 参考手册 - CSS 操作">jQuery CSS 操作</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="jquery_ref_attributes.asp" title="jQuery 参考手册 - 属性操作">jQuery 属性操作</a></li>
<li class="next"><a href="jquery_ref_ajax.asp" title="jQuery 参考手册 - Ajax">jQuery Ajax</a></li>
</ul>
</div>
...
<p>参考手册：<a href="default.htm">CSS 参考手册</a></p>
</div>
