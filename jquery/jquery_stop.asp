...
<li class="currentLink"><a href="jquery_stop.asp" title="jQuery 停止动画">jQuery stop()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="jquery_animate.asp" title="jQuery 效果 - 动画">jQuery 动画</a></li>
<li class="next"><a href="jquery_callback.asp" title="jQuery 回调函数">jQuery Callback</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_stop_slide">亲自试一试</a></p>
</div>
