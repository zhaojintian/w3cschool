...
<li class="currentLink"><a href="jquery_events.asp" title="jQuery 事件">jQuery 事件</a></li>
</ul>
<h2>jQuery 效果</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="jquery_selectors.asp" title="jQuery 选择器">jQuery 选择器</a></li>
<li class="next"><a href="jquery_hide_show.asp" title="jQuery jQuery 效果 - 隐藏和显示">jQuery 隐藏/显示</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_hide_p">亲自试一试</a></p>
