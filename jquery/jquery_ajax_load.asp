...
<li class="currentLink"><a href="jquery_ajax_load.asp" title="jQuery - AJAX load() 方法">jQuery 加载</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="jquery_ajax_intro.asp" title="jQuery - AJAX 简介">jQuery AJAX 简介</a></li>
<li class="next"><a href="jquery_ajax_get_post.asp" title="jQuery - AJAX get() 和 post() 方法">jQuery Get/Post</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_ajax_load2">亲自试一试</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_ajax_load_callback">亲自试一试</a></p>
</div>
...
<p>如需完整的 AJAX 方法参考，请访问我们的 <a href="jquery_ref_ajax.asp" title="jQuery 参考手册 - Ajax">jQuery AJAX 参考手册</a>。</p>
</div>
