...
<h2>jQuery 参考手册</h2>
<ul>
<li class="currentLink"><a href="jquery_reference.asp" title="jQuery 参考手册">jQuery 参考手册</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="jquery_quiz.asp" title="jQuery 测验">jQuery 测验</a></li>
<li class="next"><a href="jquery_ref_selectors.asp" title="jQuery 参考手册 - 选择器">jQuery 选择器</a></li>
</ul>
</div>
