...
<li class="currentLink"><a href="jquery_ajax_get_post.asp" title="jQuery - AJAX get() 和 post() 方法">jQuery Get/Post</a></li>
</ul>
<h2>jQuery 杂项</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="jquery_ajax_load.asp" title="jQuery - AJAX load() 方法">jQuery 加载</a></li>
<li class="next"><a href="jquery_noconflict.asp" title="jQuery - noConflict() 方法">jQuery noConflict()</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_ajax_get">亲自试一试</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_ajax_post">亲自试一试</a></p>
