...
<h2>jQuery 实例</h2>
<ul>
<li class="currentLink"><a href="jquery_examples.asp" title="jQuery 实例">jQuery 实例</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="jquery_noconflict.asp" title="jQuery - noConflict() 方法">jQuery noConflict()</a></li>
<li class="next"><a href="jquery_quiz.asp" title="jQuery 测验">jQuery 测验</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_html_change_p">改变 HTML 元素的内容</a>。</p>

<p class="tiy"><a  href="../tiy/t.asp@f=jquery_html_append">向 HTML 元素追加内容</a>。</p>

<p class="tiy"><a  href="../tiy/t.asp@f=jquery_html_after">在 HTML 元素之后追加内容</a>。</p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_css_change_p">改变 HTML 元素的 CSS 属性</a>。</p>

<p class="tiy"><a  href="../tiy/t.asp@f=jquery_css_change_p_and_font">改变多个 CSS 属性</a>。</p>

<p class="tiy"><a  href="../tiy/t.asp@f=jquery_css_getcolor">获得元素的 CSS 属性</a>。</p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jquery_ajax1">使用 $(selector).load(url) 来改变 HTML 内容</a>。</p>

<p class="tiy"><a  href="../tiy/t.asp@f=jquery_ajax2">使用 $.ajax(options) 来改变 HTML 内容</a>。</p>
