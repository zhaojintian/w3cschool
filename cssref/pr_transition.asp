...
<p class="tiy"><a  href="../tiy/t.asp@f=css3_transition">亲自试一试</a></p>
</div>
...
<p class="note"><span>注释：</span>请始终设置 <a href="pr_transition-duration.asp" title="CSS3 transition-duration 属性">transition-duration</a> 属性，否则时长为 0，就不会产生过渡效果。</p>
