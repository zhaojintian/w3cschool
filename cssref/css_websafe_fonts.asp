...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="css_ref_aural.asp" title="CSS 听觉参考手册">CSS 听觉参考手册</a></li>
<li class="next"><a href="css_units.asp" title="CSS 单位">CSS 单位</a></li>
</ul>
</div>
...
<p><a  href="../tiy/t.asp@f=csse_font-family">亲自试一试</a></p>
