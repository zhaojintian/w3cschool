...
<p class="tiy"><a  href="../tiy/t.asp@f=css_sel_hover">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span><a href="selector_link.asp" title="CSS :link 选择器">:link</a> 选择器设置指向未被访问页面的链接的样式，<a href="selector_visited.asp" title="CSS :visited 选择器">:visited</a> 选择器用于设置指向已被访问的页面的链接，<a href="selector_active.asp" title="CSS :active 选择器">:active</a> 选择器用于活动链接。</p>
