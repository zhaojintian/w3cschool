...
<p>Opera 不支持 border-image-source 属性。</p>

<p>Internet Explorer 10 以及更早的版本不支持 border-image-source 属性。</p>

<p>Safari 5 以及更早的版本不支持 border-image-source 属性。</p>

<p>请参阅 <a href="pr_border-image.asp" title="CSS3 border-image 属性">border-image</a> 属性。</p>
</div>
