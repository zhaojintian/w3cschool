...
<p class="tiy"><a  href="../tiy/t.asp@f=css3_transform-origin">亲自试一试</a></p>
...
<p>为了更好地理解 transform-origin 属性，请查看这个<a  href="../example/css3/demo_css3_transform-origin.html">演示</a>。</p>

<p>Safari/Chrome 用户：为了更好地理解 transform-origin 属性用于 3D 转换的情况，请查看这个<a  href="../example/css3/demo_css3_transform-origin_3D.html">演示</a>。</p>

<p class="note"><span>注释：</span>该属性必须与 <a href="pr_transform.asp" title="CSS3 transform 属性">transform</a> 属性一同使用。</p>
