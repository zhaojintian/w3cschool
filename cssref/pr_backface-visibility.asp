...
<p class="tiy"><a  href="../tiy/t.asp@f=css3_backface-visibility">亲自试一试</a></p>
</div>
...
<p>只有 Internet Explorer 10+ 和 Firefox 支持 backface-visibility 属性。</p>

<p>Opera 15+、Safari 和 Chrome 支持替代的 -webkit-backface-visibility 属性。</p>
</div>
