...
<p class="tiy"><a  href="../tiy/t.asp@f=css_sel_active">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>请使用 <a href="selector_link.asp" title="CSS :link 选择器">:link</a> 选择器对指向未被访问页面的链接设置样式，<a href="selector_visited.asp" title="CSS :visited 选择器">:visited</a> 用于设置指向已访问页面的链接的样式，<a href="selector_hover.asp" title="CSS :hover 选择器">:hover</a> 选择器用于设置鼠标指针浮动到链接上时的样式。</p>
</div>
