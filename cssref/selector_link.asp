...
<p class="tiy"><a  href="../tiy/t.asp@f=css_sel_link">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>请使用 <a href="selector_visited.asp" title="CSS :visited 选择器">:visited</a> 选择器对指向已访问页面的链接设置样式，<a href="selector_hover.asp" title="CSS :hover 选择器">:hover</a> 选择器用于设置鼠标指针浮动到链接上时的样式，<a href="selector_active.asp" title="CSS :active 选择器">:active</a> 选择器用于设置点击链接时的样式。</p>
</div>
...
<p><a  href="../tiy/t.asp@f=css_sel_link_more1">亲自试一试</a></p>
...
<p><a  href="../tiy/t.asp@f=css_sel_link_more2">亲自试一试</a></p>
</div>
