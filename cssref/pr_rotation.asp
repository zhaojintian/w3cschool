...
<p class="tiy"><a  href="../tiy/t.asp@f=css3_rotation">亲自试一试</a></p>
</div>
...
<p>rotation 属性围绕由 <a href="pr_rotation-point.asp" title="CSS3 rotation-point 属性">rotation-point</a> 属性定义的指定点，对块级元素进行逆时针旋转。</p>
