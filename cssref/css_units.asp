...
<li class="currentLink"><a href="css_units.asp" title="CSS 单位">CSS 单位</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="css_websafe_fonts.asp" title="CSS 网络安全字体组合">CSS 网络安全字体</a></li>
<li class="next"><a href="css_colors.asp" title="CSS 颜色">CSS 颜色</a></li>
</ul>
</div>
