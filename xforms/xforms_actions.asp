...
<li class="currentLink"><a href="xforms_actions.asp" title="XForms 行为（Actions）">XForms 行为</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xforms_properties.asp" title="XForms 属性">XForms 属性</a></li>
<li class="next"><a href="xforms_functions.asp" title="XForms 函数">XForms 函数</a></li>
</ul>
</div>
