...
<li class="currentLink"><a href="xforms_properties.asp" title="XForms 属性">XForms 属性</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xforms_datatypes.asp" title="XForms 数据类型">XForms 数据类型</a></li>
<li class="next"><a href="xforms_actions.asp" title="XForms 行为（Actions）">XForms 行为</a></li>
</ul>
</div>
