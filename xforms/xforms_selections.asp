...
<li class="currentLink"><a href="xforms_selections.asp" title="XForms 选择控件">XForms 选择</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xforms_input.asp" title="XForms 输入控件">XForms 输入</a></li>
<li class="next"><a href="xforms_datatypes.asp" title="XForms 数据类型">XForms 数据类型</a></li>
</ul>
</div>
