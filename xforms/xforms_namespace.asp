...
<li class="currentLink"><a href="xforms_namespace.asp" title="XForms 命名空间">XForms 命名空间</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xforms_model.asp" title="XForms 模型">XForms 模型</a></li>
<li class="next"><a href="xforms_example.asp" title="XForms 实例">XForms 实例</a></li>
</ul>
</div>
