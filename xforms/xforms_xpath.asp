...
<li class="currentLink"><a href="xforms_xpath.asp" title="XForms 和 XPath">XForms XPath</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xforms_example.asp" title="XForms 实例">XForms 实例</a></li>
<li class="next"><a href="xforms_input.asp" title="XForms 输入控件">XForms 输入</a></li>
</ul>
</div>
