...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="html_5_app_cache.asp" title="HTML 5 应用程序缓存">HTML5 应用缓存</a></li>
<li class="next"><a href="html_5_serversentevents.asp" title="HTML5 服务器发送事件">HTML5 服务器发送事件</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=html5_webworker">亲自试一试</a></p>
</div>
