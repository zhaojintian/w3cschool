...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO 查询</TITLE>
...
<UL>
  ...
  <LI class=currentLink><A title="ADO 查询" href="ado_query.asp">ADO 查询</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="ADO 显示" href="ado_display.asp">ADO 显示</A> </LI>
  <LI class=next><A title="ADO 排序" href="ado_sort.asp">ADO 排序</A> </LI></UL></DIV>
<DIV>
<P><STRONG>我们可以使用 SQL 来创建查询，这样就可以指定仅查看选定的记录和字段。</STRONG></P></DIV>
<DIV id=example>
<H2>实例</H2>
<DL>
  <DT><A href="../tiy/s.asp@f=demo_adoe_query_1">显示 "Companyname" 以 A 开头的记录</A> 
  <DD>如何仅仅显示 "Customers" 表的 "Companyname" 字段中以 A 开头的记录。 
  <DT><A href="../tiy/s.asp@f=demo_adoe_query_2">显示 "Companyname" 大于 E 的记录</A> 
  <DD>如何仅仅显示 "Customers" 表的 "Companyname" 字段中大于 E 的记录。 
  <DT><A href="../tiy/s.asp@f=demo_adoe_query_3">仅显示西班牙的客户</A> 
  <DD>如何仅仅显示 "Customers" 表中的西班牙客户。 
  <DT><A href="../tiy/s.asp@f=demo_adoe_query_4">让用户来选择筛选标准</A> 
  <DD>让用户根据国别来选择客户 </DD></DL></DIV>
<DIV>
<H2>显示选定的数据</H2>
<P>我们希望仅仅显示 "Customers" 表的 "Companyname" 字段中以 A 开头的记录：</P><PRE>&lt;html&gt;
&lt;body&gt;
...
<UL class=prenext>
  <LI class=pre><A title="ADO 显示" href="ado_display.asp">ADO 显示</A> </LI>
  <LI class=next><A title="ADO 排序" href="ado_sort.asp">ADO 排序</A> 
</LI></UL></DIV></DIV>
<DIV id=sidebar>
<DIV id=searchui>
