...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO Cancel 方法</TITLE>
...
<TABLE class=dataintable>
  ...
  <TR>
    <TD>Command </TD>
    <TD>Execute。 
      <P>注释：在 Cancel 方法被调用之前，Execute 方法的 Options 参数必须被设置为 adAsyncExecute 或者 
      adAsyncFetch，否则会发生 run-time 错误。</P></TD></TR>
  <TR>
    <TD>Connection</TD>
    <TD>Execute 或 Open。 
      <P>注释：在 Cancel 方法被调用之前，Open 方法的 Options 参数必须被设置为 adSyncConnect，Execute 方法的 
      Options 参数必须被设置为 adAsyncExecute 或者 adAsyncFetch，否则会发生 run-time 
  错误。</P></TD></TR>
  <TR>
    <TD>Record</TD>
    <TD>CopyRecord, DeleteRecord, MoveRecord, 或者 Open。</TD></TR>
  <TR>
    <TD>Recordset</TD>
    <TD>Open</TD></TR>
  <TR>
...
<H3>语法</H3><PRE>object.Cancel</PRE></DIV>
<DIV class=backtoreference>
<P><A title="ADO Command 对象" href="ado_ref_command.asp">返回 ADO Command 
对象参考手册</A></P></DIV></DIV>
<DIV id=sidebar>
