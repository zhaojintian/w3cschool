...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO Value 属性</TITLE>
...
<TABLE class=dataintable>
  ...
  <TR>
    <TH>对象</TH>
    <TH>Value 属性的描述</TH></TR>
  <TR>
    <TD>Parameter</TD>
    <TD>
      <P>Value 值可设置或返回一个 variant 值，该值指示 Parameter 对象的值。</P>
      <P>注释：在读取 Value 属性之前，应当关闭 Recordset 对象。对于 Parameter 对象，ADO 只从提供者读取 Value 
      属性一次。</P></TD></TR>
  <TR>
    <TD>Field</TD>
    <TD>
      <P>Value 属性可设置或返回一个 variant 值，该值指示 Field 对象的当前值。</P>
      <P>注释：对于被添加到 Record 的 Fields 集合的新的 Field 对象，在设置任何其他属性之前，您必须首先设置 Value 
      属性，并且调用 Fields 集合的 Update。</P></TD></TR>
  <TR>
    <TD>Property</TD>
    <TD>
      <P>Value 属性可设置或返回一个 variant 值，该值指示 Property 对象的当前值。</P>
      <P>注释：您无法为只读属性设置 Value。</P></TD></TR></TBODY></TABLE>
<H3>语法</H3><PRE>objectname.Value</PRE></DIV>
<DIV>
<H2>实例</H2>
<P>针对 Field 对象：</P><PRE>&lt;%
