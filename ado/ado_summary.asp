...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>您已经学习了 ADO，下一步呢？</TITLE>
...
<UL>
  ...
  <LI class=currentLink><A title="您已经学习了 ADO，下一步呢？" href="ado_summary.asp">ADO 
  总结</A> </LI></UL>
<H2>ADO 实例</H2>
<UL>
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="ADO 数据类型" href="ado_datatypes.asp">ADO 数据类型</A> </LI>
  <LI class=next><A title="ADO 实例" href="../example/adoe_examples.asp">ADO 
  实例</A> </LI></UL></DIV>
<DIV>
<H2>ADO 概述</H2>
<P>本教程已经向您讲解了如何从网站访问数据库中的数据。</P>
<P>您已经学习了如何在网站上显示来自数据库的数据，以及如何通过 ADO 来编辑、添加及删除这些数据。</P>
<P>如需更多有关 ADO 的信息，请参阅我们的 <A href="../example/adoe_examples.asp">ADO 
实例</A>。</P></DIV>
<DIV>
<H2>您已经学习了 ADO，下一步呢？</H2>
<P>下一步应该学习 SQL。</P>
<P>SQL 是一门用于访问和操作数据库系统的标准计算机语言。</P>
<P>SQL 语句用于检索和更新数据库中的数据。SQL 可以和这些数据库系统配合工作：MS Access, DB2, Informix, MS SQL 
Server, Oracle, Sybase, 以及其他的数据库系统。</P>
<P>如果您需要学习更多有关 SQL 的知识，请访问我们的 <A href="../sql/index.asp">SQL 教程</A>。</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="ADO 数据类型" href="ado_datatypes.asp">ADO 数据类型</A> </LI>
  <LI class=next><A title="ADO 实例" href="../example/adoe_examples.asp">ADO 
