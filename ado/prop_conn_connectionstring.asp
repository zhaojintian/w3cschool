...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO ConnectionString 属性</TITLE>
...
<H3>语法</H3><PRE>objconn.ConnectionString="para1=value;para2=value;etc;"</PRE>
...
<TABLE class=dataintable>
  ...
  <TR>
    <TD>Provider</TD>
    <TD>用于连接的提供者的名称。</TD></TR>
  <TR>
    <TD>File Name</TD>
    <TD>提供者特有的文件（例如，持久保留的数据源对象）的名称，这些文件中包含预置的连接信息。</TD></TR>
  <TR>
    <TD>Remote Provider</TD>
    <TD>当打开客户端连接时使用的提供者的名称。（仅限于远程数据服务。）</TD></TR>
  <TR>
    <TD>Remote Server</TD>
    <TD>当打开客户端连接时使用的服务器的路径名称。（仅限于远程数据服务。）</TD></TR>
  <TR>
    <TD>url</TD>
    <TD>标识资源（比如文件或目录）的绝对 URL。</TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>实例</H2><PRE>&lt;%
