...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO Mode 属性</TITLE>
...
<DIV>
<H2>定义和用法</H2>
<P>Mode 属性可设置或返回一个 <A href="#connectmodeenum">ConnectModeEnum</A> 值，该值指示在 
Connection, Record 或 Stream 对象中修改数据的权限。在对象关闭时，此属性为读写，在对象打开时为只读。</P>
<UL>
  <LI>Connection 对象 - 默认是 adModeUnknown 
  <LI>Record 对象 - 默认是 adModeRead 
  <LI>Stream 对象 - 默认是 adModeRead 或 adModeUnknown </LI></UL>
<P class=note><SPAN>注释：</SPAN>该属性只能在 Connection 对象关闭时设置。</P>
<H3>语法</H3><PRE>object.Mode</PRE></DIV>
<DIV>
<H2>实例</H2><PRE>&lt;%
...
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TD>4</TD>
    <TD>禁止其他人以读权限打开连接。</TD></TR>
  <TR>
    <TD>adModeShareDenyWrite</TD>
    <TD>8</TD>
    <TD>禁止其他人以写权限打开连接。</TD></TR>
  <TR>
  ...
  <TR>
    ...
    <TD>16</TD>
    <TD>允许其他人以任何权限打开连接。不拒绝其他人的读或写访问。</TD></TR>
  <TR>
    <TD>adModeRecursive</TD>
    <TD>0x400000</TD>
    <TD>与 adModeShareDenyNone, adModeShareDenyWrite 或 adModeShareDenyRead 
      一起使用，对当前 Record 的所有子记录设置权限。</TD></TR></TBODY></TABLE></DIV>
<DIV class=backtoreference>
<P><A title="ADO Connection 对象" href="ado_ref_connection.asp">返回 ADO Connection 
对象参考手册</A></P></DIV></DIV>
<DIV id=sidebar>
