...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO Provider 属性</TITLE>
...
<DIV>
<H2>定义和用法</H2>
<P>Provider 属性可设置或返回包含特定 Connection 对象的提供者名称的字符串值。默认是 MSDASQL (Microsoft OLE DB 
provider for ODBC)。请参阅 <A href="#providercodes">Provider 代码</A>。</P>
<P>在连接关闭时，此属性是可读写的。</P>
<P>提供者名称也可通过 Connection 对象的 ConnectionString 属性或者 Open 方法的 ConnectionString 
参数来设置。</P>
<P class=note><SPAN>注释：</SPAN>请不要在多个地方为特定的 Connection 设置 provider。</P>
<H3>语法</H3><PRE>connobj.Provider</PRE></DIV>
<DIV>
<H2>实例</H2><PRE>&lt;%
...
<TABLE class=dataintable>
  ...
  <TR>
    <TD>ADSDSOObject</TD>
    <TD>Active Directory Services</TD></TR>
  <TR>
    <TD>Microsoft.Jet.OLEDB.4.0</TD>
    <TD>Microsoft Jet databases</TD></TR>
  <TR>
    <TD>MSDAIPP.DSO.1</TD>
    <TD>Microsoft Internet Publishing</TD></TR>
  <TR>
    <TD>MSDAORA</TD>
    <TD>Oracle databases</TD></TR>
  <TR>
    <TD>MSDAOSP</TD>
    <TD>Simple text files</TD></TR>
  <TR>
    <TD>MSDASQL</TD>
    <TD>Microsoft OLE DB provider for ODBC</TD></TR>
  <TR>
    <TD>MSDataShape</TD>
    <TD>Microsoft Data Shape</TD></TR>
  <TR>
    <TD>MSPersist</TD>
    <TD>Locally saved files</TD></TR>
  <TR>
    <TD>SQLOLEDB</TD>
    <TD>Microsoft SQL Server</TD></TR></TBODY></TABLE></DIV>
<DIV class=backtoreference>
<P><A title="ADO Connection 对象" href="ado_ref_connection.asp">返回 ADO Connection 
对象参考手册</A></P></DIV></DIV>
<DIV id=sidebar>
