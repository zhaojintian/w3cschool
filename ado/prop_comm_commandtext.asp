...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO CommandText 属性</TITLE>
...
<DIV>
<H2>定义和用法</H2>
<P>CommandText 属性可设置或返回一个字符串，该字符串包含一个 provider 命令，比如一条 SQL 语句、一个表名称、一个相对 
URL、或者一个存储过程调用。默认值为零 ""（零长度字符串）。</P>
<H3>语法</H3><PRE>objcommand.CommandText</PRE></DIV>
<DIV>
<H2>实例</H2><PRE>&lt;%
