...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO Name 属性</TITLE>
...
<TABLE class=dataintable>
  ...
  <TR>
    <TD>Command</TD>
    <TD>Name 属性拥有对 Command 对象的读写权限。</TD></TR>
  <TR>
    <TD>Property</TD>
    <TD>Name 属性拥有对 Property 属性的只读权限。</TD></TR>
  <TR>
    <TD>Field</TD>
    <TD>在被用于创建 Recordset 时 Name 属性拥有读写权限，但是当您打开一个已有的 Recordset 时是只读的。</TD></TR>
  <TR>
    <TD>Parameter</TD>
    <TD>对于尚未追加到 Parameters 集合的 Parameter 对象，Name 属性为读/写。对于已追加的 Parameter 
      对象和所有其他对象，Name 属性为只读。名称在集合中不必是唯一的。</TD></TR></TBODY></TABLE>
<H3>语法</H3><PRE>object.Name</PRE></DIV>
<DIV>
<H2>实例</H2>
<P>针对 Command 对象：</P><PRE>&lt;%
