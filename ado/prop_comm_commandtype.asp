...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO CommandType 属性</TITLE>
...
<DIV>
<H2>定义和用法</H2>
<P>CommandType 属性可设置或返回一个 <A href="app_commandtypeenum.asp">CommandTypeEnum</A> 
值，该值可定义 Command 对象的类型。默认是 adCmdUnknown。</P>
<P>如果您没有规定此类型，ADO 将需要联系 provider 以确定命令的类型。如果您定义了该类型，则 ADO 将有能力更快地处理此命令。</P>
<H3>语法</H3><PRE>objcommand.CommandType</PRE></DIV>
<DIV>
<H2>实例</H2><PRE>&lt;%
