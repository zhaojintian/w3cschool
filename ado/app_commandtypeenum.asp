...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>CommandTypeEnum</TITLE>
...
<TABLE class=dataintable>
  ...
  <TR>
    <TD>adCmdText</TD>
    <TD>1</TD>
    <TD>按命令或存储过程调用的文本定义计算 CommandText。</TD></TR>
  <TR>
    <TD>adCmdTable</TD>
    <TD>2</TD>
    <TD>按表名计算 CommandText，该表的列全部是由内部生成的 SQL 查询返回的。</TD></TR>
  <TR>
    <TD>adCmdStoredProc</TD>
    <TD>4</TD>
    <TD>按存储过程名计算 CommandText。</TD></TR>
  <TR>
    <TD>adCmdUnknown</TD>
    <TD>8</TD>
    <TD>默认值。指示 CommandText 属性中命令的类型未知。</TD></TR>
  <TR>
    <TD>adCmdFile</TD>
    <TD>256</TD>
    <TD>按持久存储的 Recordset 的文件名计算 CommandText。仅与 Recordset.Open 或 Requery 
  使用。</TD></TR>
  <TR>
    <TD>adCmdTableDirect</TD>
    <TD>512</TD>
    <TD>按表名计算 CommandText，该表的列被全部返回。仅与 Recordset.Open 或 Requery 使用。如需使用 Seek 
      方法，Recordset 必须通过 adCmdTableDirect 打开。该值不能与 ExecuteOptionEnum 值 
      adAsyncExecute 结合。</TD></TR></TBODY></TABLE></DIV>
<DIV class=backtoreference>
