...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO IsolationLevel 属性</TITLE>
...
<DIV>
<H2>定义和用法</H2>
<P>IsolationLevel 属性可设置或返回 Connection 对象的隔离级别。该值是一个 <A 
href="#isolationlevelenum">IsolationLevelEnum</A> 值。默认是 adXactChaos。</P>
<P class=note><SPAN>注释：</SPAN>IsolationLevel 设置直到下次调用 BeginTrans 方法时才生效。</P>
<H3>语法</H3><PRE>objconn.IsolationLevel</PRE></DIV>
<DIV>
<H2>实例</H2><PRE>&lt;%
...
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TD>-1</TD>
    <TD>无法使用指定的隔离级别，因为提供者正在使用不同的隔离级别，而且该级别无法被确定。</TD></TR>
  <TR>
    <TD>adXactChaos</TD>
    <TD>16</TD>
    <TD>无法覆盖更高级别的事务。</TD></TR>
  <TR>
    <TD>adXactBrowse</TD>
    <TD>256</TD>
    <TD>可以从一个事务中查看其他事务中未提交的更改。</TD></TR>
  <TR>
    <TD>adXactReadUncommitted</TD>
    <TD>256</TD>
    <TD>与 adXactBrowse 相同。</TD></TR>
  <TR>
    <TD>adXactCursorStability</TD>
    <TD>4096</TD>
    <TD>只能从一个事务中查看其他事务中提交的更改。</TD></TR>
  <TR>
    <TD>adXactReadCommitted</TD>
    <TD>4096</TD>
    <TD>与 adXactCursorStability 相同。</TD></TR>
  <TR>
    <TD>adXactRepeatableRead</TD>
    <TD>65536</TD>
    <TD>不能从一个事务中查看其他事务中所作的修改，但是重新查询可以检索新的 Recordset 对象。</TD></TR>
  <TR>
    <TD>adXactIsolated</TD>
    <TD>1048576</TD>
    <TD>该事务与其他事务隔离执行。</TD></TR>
  <TR>
    <TD>adXactSerializable</TD>
    <TD>1048576</TD>
    <TD>与 adXactIsolated 相同。</TD></TR></TBODY></TABLE></DIV>
<DIV class=backtoreference>
<P><A title="ADO Connection 对象" href="ado_ref_connection.asp">返回 ADO Connection 
对象参考手册</A></P></DIV></DIV>
<DIV id=sidebar>
