...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO Direction 属性</TITLE>
...
<DIV>
<H2>定义和用法</H2>
<P>Direction 属性可设置或返回一个 ParameterDirectionEnum 值，指示 Parameter 
所表示的是输入参数、输出参数还是两者都表示，或者指示参数是否是存储过程的返回值。默认值是 adParamInput。</P>
...
<H3>语法</H3><PRE>objparameter.Direction</PRE></DIV>
<DIV>
<H2>实例</H2><PRE>&lt;%
...
<TABLE class=dataintable>
  ...
  <TR>
    <TD>adParamInput</TD>
    <TD>1</TD>
    <TD>默认值。指示该参数是输入参数。</TD></TR>
  <TR>
    <TD>adParamInputOutput</TD>
    <TD>3</TD>
    <TD>指示该参数既是输入参数，又是输出参数。</TD></TR>
  <TR>
    <TD>adParamOutput</TD>
    <TD>2</TD>
    <TD>指示该参数是输出参数。</TD></TR>
  <TR>
    ...
    <TD>4</TD>
    <TD>指示该参数是返回值。</TD></TR></TBODY></TABLE></DIV>
<DIV class=backtoreference>
<P><A title="ADO Parameter 对象" href="ado_ref_parameter.asp">返回 ADO Parameter 
对象参考手册</A></P></DIV></DIV>
<DIV id=sidebar>
