...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO InfoMessage 事件</TITLE>
...
<H3>语法</H3><PRE>InfoMessage objerror,status,objconn</PRE>
<TABLE class=dataintable>
  ...
  <TR>
    <TD>objerror</TD>
    <TD>Error 对象。此参数包含返回的任何错误。</TD></TR>
  <TR>
    <TD>status</TD>
    <TD>一个 <A href="#eventstatusenum">EventStatusEnum</A> 值。如果出现警告，status 
      将被设置为 adStatusOK，并且 objerror 中包含该警告。</TD></TR>
  <TR>
    <TD>objconn</TD>
    <TD>Connection 对象。引发警告的连接。</TD></TR></TBODY></TABLE></DIV>
<DIV>
