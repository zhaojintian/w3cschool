...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO 教程</TITLE>
...
<H2>ADO 教程</H2>
<UL>
  <LI class=currentLink><A title="ADO 教程" href="index.asp">ADO 教程</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="ADO 教程" href="index.asp">ADO 教程</A> </LI>
  <LI class=next><A title="ADO 简介" href="ado_intro.asp">ADO 简介</A> 
</LI></UL></DIV>
<DIV>
<P><STRONG>在我们的 ADO 教程中，您将学到有关 ADO 的知识，以及如何使用 ADO 从您的网站访问数据库。</STRONG></P>
<P><A title="ADO 简介" href="ado_intro.asp">开始学习 ADO</A> ！</P></DIV>
<DIV>
<H2>ADO 参考手册</H2>
<P>在 W3School，我们为您提供完整的 ADO 参考手册，其中包括内建对象，以及它们的属性和方法。</P>
<P><A href="ado_reference.asp">ADO 参考手册</A></P></DIV>
<DIV>
<H2>ADO 实例</H2>
<P>通过实例来学习！因为 ASP 脚本只能在服务器端执行，所以你无法在浏览器中查看 ASP 代码，你能看到的仅仅是由 ASP 输出的纯粹的 HTML 
代码。</P>
<P>在 W3School，每个实例均可显示出以往被隐藏的 ASP 代码。这样，您就可以更容易理解它们的工作原理。</P>
<P><A href="../example/adoe_examples.asp">ADO 实例</A></P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="ADO 教程" href="index.asp">ADO 教程</A> </LI>
  <LI class=next><A title="ADO 简介" href="ado_intro.asp">ADO 简介</A> 
