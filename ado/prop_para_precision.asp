...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO Precision 属性</TITLE>
...
<H3>语法</H3><PRE>objectname.Precision</PRE>
<TABLE class=dataintable>
  <TBODY>
  <TR>
    <TH>对象</TH>
    <TH>Precision 属性的描述</TH></TR>
  <TR>
    <TD>Field</TD>
    <TD>
      <P>对于 Field 对象，Precision 通常为只读。但是，对于已追加到 Record 的 Fields 集合的新 Field 
      对象，只有当已指定 Field 的 Value 属性并且数据提供者通过调用 Fields 集合的 Update 方法成功添加了新 Field 
      时，Precision 才为读/写。</P></TD></TR>
  <TR>
    <TD>Parameter</TD>
    <TD>对于 Parameter 对象，Precision属性拥有读/写权限。</TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>实例</H2><PRE>&lt;%
