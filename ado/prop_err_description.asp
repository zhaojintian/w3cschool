...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO Description 属性</TITLE>
...
<P>提供者负责向 ADO 传递特定的错误文本。对于接收到的每一个提供者错误或警告，ADO 都会向 Errors 集合中添加一个 Error 对象。枚举 
Errors 集合以跟踪提供者传递的错误。</P>
<H3>语法</H3><PRE>strErrorText=objErr.Description</PRE></DIV>
<DIV>
<H2>实例</H2><PRE>&lt;%
