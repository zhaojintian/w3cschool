...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO State 属性</TITLE>
...
<DIV>
<H2>定义和用法</H2>
<P>State 属性可返回一个值，该值描述对象的当前状态是打开、关闭、正在连接、正在执行还是正在检索数据。该值返回 <A 
href="objectstateenum.asp">ObjectStateEnum</A> 值。默认值为 adStateClosed。</P>
<P>此属性可用于 Command, Connection, Record, Recordset 以及 Stream 对象。</P>
<P>State 属性可以是值的组合。例如，如果正在执行某个语句，此属性将有一个 adStateOpen 和 adStateExecuting 
的组合值。</P>
<P>State 属性为只读。</P>
<H3>语法</H3><PRE>object.State</PRE></DIV>
<DIV>
<H2>实例</H2>
