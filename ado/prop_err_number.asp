...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO Number 属性</TITLE>
...
<P>Errors 集合以十六进制格式（例如 0x80004005）或以 Long 值（例如 2147467259）返回 HRESULT。这些 HRESULT 
由基本组件生成，如 OLE DB，甚至是 OLE 本身。</P>
<H3>语法</H3><PRE>lngErrorNumber=objErr.Number</PRE></DIV>
<DIV>
<H2>实例</H2><PRE>&lt;%
