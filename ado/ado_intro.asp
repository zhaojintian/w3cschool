...
<UL>
  ...
  <LI class=currentLink><A title="ADO 简介" href="ado_intro.asp">ADO 简介</A> 
...
<UL class=prenext>
  ...
  <LI class=next><A title="ADO 数据库连接" href="ado_connect.asp">ADO 连接</A> 
</LI></UL></DIV>
<DIV>
<P><STRONG>ADO 被用于从网页访问数据库。</STRONG></P></DIV>
<DIV>
<H2>您应当具备的基础知识</H2>
<P>在继续学习之前，您需要对下面的知识有基本的了解：</P>
<UL>
  <LI>WWW、HTML 以及对网站构建的基本了解 
  <LI>ASP（动态服务器页面） 
  <LI>SQL（结构化查询语言） </LI></UL>
<P>如果您希望首先学习这些项目，请在我们的 <A title="W3School 在线教程" href="../default.htm">首页</A> 
访问这些教程。</P></DIV>
<DIV>
<H2>什么是 ADO？</H2>
<UL>
  <LI>ADO 是一项微软的技术 
  <LI>ADO 指 ActiveX 数据对象（<EM>A</EM>ctiveX <EM>D</EM>ata <EM>O</EM>bjects） 
  <LI>ADO 是一个微软的 Active-X 组件 
  <LI>ADO 会随微软的 IIS 被自动安装 
  <LI>ADO 是一个访问数据库中数据的编程接口 </LI></UL></DIV>
<DIV>
<H2>从 ASP 页面访问数据库</H2>
