...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO 数据类型</TITLE>
...
<H2>ADO 总结</H2>
<UL>
  <LI class=currentLink><A title="ADO 数据类型" href="ado_datatypes.asp">ADO 
  数据类型</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="ADO Stream 对象" href="ado_ref_stream.asp">ADO 
  Stream</A> </LI>
  <LI class=next><A title="您已经学习了 ADO，下一步呢？" href="ado_summary.asp">ADO 总结</A> 
  </LI></UL></DIV>
<DIV>
...
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TD>DateTime<BR>SmallDateTime</TD>
    <TD>Date</TD></TR>
  <TR>
    <TD>adDecimal</TD>
    <TD>14</TD>
  ...
  <TR>
    <TD>adInteger</TD>
    <TD>3</TD>
    <TD>AutoNumber<BR>Integer<BR>Long</TD>
    <TD>Identity (SQL Server 6.5)<BR>Int<BR>&nbsp;</TD>
    <TD>Int *</TD></TR>
  <TR>
    ...
    <TD>OLEObject</TD>
    <TD>Image</TD>
    <TD>Long Raw *<BR>Blob (Oracle 8.1.x)</TD></TR>
  <TR>
    <TD>adLongVarChar</TD>
    <TD>201</TD>
    <TD>Memo (Access 97)<BR>Hyperlink (Access 97)</TD>
    <TD>Text</TD>
    <TD>Long *<BR>Clob (Oracle 8.1.x)</TD></TR>
  <TR>
    <TD>adLongVarWChar</TD>
    <TD>203</TD>
    <TD>Memo (Access 2000 (OLEDB))<BR>Hyperlink (Access 2000 (OLEDB))</TD>
    <TD>NText (SQL Server 7.0 +)</TD>
    <TD>NClob (Oracle 8.1.x)</TD></TR>
  <TR>
    <TD>adNumeric</TD>
    <TD>131</TD>
    <TD>Decimal (Access 2000 (OLEDB))</TD>
    <TD>Decimal<BR>Numeric</TD>
    <TD>Decimal<BR>Integer<BR>Number<BR>SmallInt</TD></TR>
  <TR>
    <TD>adSingle</TD>
    <TD>4</TD>
    <TD>Single</TD>
...
<P>* 在 Oracle 8.0.x 中 - decimal 和 int 等于 number 和 number(10)。</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="ADO Stream 对象" href="ado_ref_stream.asp">ADO 
  Stream</A> </LI>
