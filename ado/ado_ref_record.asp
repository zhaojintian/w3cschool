...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO Record 对象</TITLE>
...
<UL>
  ...
  <LI class=currentLink><A title="ADO Record 对象" href="ado_ref_record.asp">ADO 
  Record</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="ADO Property 对象" href="ado_ref_property.asp">ADO 
  Property</A> </LI>
  <LI class=next><A title="ADO Recordset 对象" href="ado_ref_recordset.asp">ADO 
  Recordset</A> </LI></UL></DIV>
<DIV>
...
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TD>设置或返回 Record 对象当前所属的 Connection 对象。</TD></TR>
  <TR>
    <TD>Mode</TD>
    <TD>设置或返回在Record 对象中修改数据的有效权限。</TD></TR>
  <TR>
    <TD>ParentURL</TD>
    <TD>返回父 Record 的绝对URL。</TD></TR>
  <TR>
    <TD>RecordType</TD>
    <TD>返回 Record 对象的类型。</TD></TR>
  <TR>
    <TD>Source</TD>
    <TD>设置或返回 Record 对象的 Open 方法的 src 参数。</TD></TR>
  <TR>
    <TD>State</TD>
    <TD>返回 Record 对象的状态。</TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>方法</H2>
<TABLE class=dataintable>
  <TBODY>
  ...
  <TR>
    <TD>Cancel</TD>
    <TD>取消一次 CopyRecord、DeleteRecord、MoveRecord 或 Open 调用的执行。</TD></TR>
  <TR>
    <TD>Close</TD>
    <TD>关闭一个 Record 对象。</TD></TR>
  <TR>
    <TD>CopyRecord</TD>
    <TD>把文件或目录拷贝到另外一个位置。</TD></TR>
  <TR>
    <TD>DeleteRecord</TD>
    <TD>删除一个文件或目录。</TD></TR>
  <TR>
    <TD>GetChildren</TD>
    <TD>返回一个 Recordset 对象，其中的每一行表示目录中的文件或子目录。</TD></TR>
  <TR>
    <TD>MoveRecord</TD>
    <TD>把文件或目录移动到另外一个位置。</TD></TR>
  <TR>
    <TD>Open</TD>
    <TD>打开一个已有的 Record 对象或创建一个新的文件或目录。</TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>集合</H2>
<TABLE class=dataintable>
  <TBODY>
  ...
  <TR>
    <TD>Properties</TD>
    <TD>特定提供者属性的一个集合。</TD></TR>
  <TR>
    <TD>Fields</TD>
    <TD>包含 Record 对象中的所有 Field 对象。</TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>Fields 集合的属性</H2>
<TABLE class=dataintable>
  <TBODY>
  ...
  <TR>
    ...
    <TD>
      ...
      <P>例子：</P><PRE>countfields = rec.Fields.Count</PRE></TD></TR>
  <TR>
    <TD>Item(named_item/number)</TD>
    <TD>
      <P>返回 fields 集合中的某个指定的项目。</P>
      <P>例子：</P><PRE>itemfields = rec.Fields.Item(1)
或者
