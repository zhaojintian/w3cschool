...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO Field 对象</TITLE>
...
<UL>
  ...
  <LI class=currentLink><A title="ADO Field 对象" href="ado_ref_field.asp">ADO 
  Field</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="ADO Error 对象" href="ado_ref_error.asp">ADO Error</A> 
  </LI>
  <LI class=next><A title="ADO Parameter 对象" href="ado_ref_parameter.asp">ADO 
  Parameter</A> </LI></UL></DIV>
<DIV>
<H2>Field 对象</H2>
<P>ADO Field 对象包含有关 Recordset 对象中某一列的信息。Recordset 中的每一列对应一个 Field 对象。</P>
<H3>ProgID</H3><PRE>set objField=Server.CreateObject("ADODB.field")</PRE></DIV>
<DIV>
<H2>属性</H2>
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TD>返回一个字段值的实际长度。</TD></TR>
  <TR>
    <TD><A href="prop_field_attributes.asp">Attributes</A></TD>
    <TD>设置或返回 Field 对象的属性。</TD></TR>
  <TR>
    <TD><A href="prop_field_size.asp">DefinedSize</A></TD>
    <TD>返回Field 对象被定义的大小</TD></TR>
  <TR>
    <TD><A href="prop_field_name.asp">Name</A></TD>
    <TD>设置或返回 Field 对象的名称。</TD></TR>
  <TR>
    <TD><A href="prop_field_numericscale.asp">NumericScale</A></TD>
    <TD>设置或返回 Field 对象中的值所允许的小数位数。</TD></TR>
  <TR>
    <TD><A 
      href="prop_field_originalvalue_underlyingvalue.asp">OriginalValue</A></TD>
    <TD>返回某个字段的原始值。</TD></TR>
  <TR>
    <TD><A href="prop_field_precision.asp">Precision</A></TD>
    <TD>设置或返回当表示 Field 对象中的数值时所允许的数字的最大数。</TD></TR>
  <TR>
    <TD><A href="prop_field_status.asp">Status</A></TD>
    <TD>返回 Field 对象的状态。</TD></TR>
  <TR>
    <TD><A href="prop_field_type.asp">Type</A></TD>
    <TD>设置或返回 Field 对象的类型。</TD></TR>
  <TR>
    <TD><A 
      href="prop_field_originalvalue_underlyingvalue.asp">UnderlyingValue</A></TD>
    <TD>返回一个字段的当前值。</TD></TR>
  <TR>
    <TD><A href="prop_field_value.asp">Value</A></TD>
    <TD>设置或返回 Field 对象的值。</TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>方法</H2>
<TABLE class=dataintable>
  <TBODY>
  ...
  <TR>
    ...
    <TD>把大型的二进制或文本数据追加到 Field 对象</TD></TR>
  <TR>
    <TD><A href="met_field_getchunk.asp">GetChunk</A></TD>
    <TD>返回大型二进制或文本 Field 对象的全部或部分内容。</TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>集合</H2>
<TABLE class=dataintable>
  <TBODY>
  ...
  <TR>
    <TD>Properties</TD>
    <TD>包含一个 Field 对象的所有 Property 对象。</TD></TR></TBODY></TABLE></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="ADO Error 对象" href="ado_ref_error.asp">ADO Error</A> 
  </LI>
  <LI class=next><A title="ADO Parameter 对象" href="ado_ref_parameter.asp">ADO 
  Parameter</A> </LI></UL></DIV></DIV>
<DIV id=sidebar>
<DIV id=searchui>
