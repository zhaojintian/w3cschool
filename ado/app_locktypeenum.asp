...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>LockTypeEnum</TITLE>
...
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TD>未指定锁定类型。创建副本时，副本与源对象使用相同的锁定类型。</TD></TR>
  <TR>
    <TD>adLockReadOnly</TD>
    <TD>1</TD>
    <TD>指示只读记录。无法改变数据。</TD></TR>
  <TR>
    <TD>adLockPessimistic</TD>
    <TD>2</TD>
    <TD>指示逐个记录的保守式锁定。提供者要确保记录编辑成功，通常在编辑之后立即在数据源锁定记录。</TD></TR>
  <TR>
    <TD>adLockOptimistic</TD>
    <TD>3</TD>
    <TD>指示逐个记录的开放式锁定。提供者使用开放式锁定，仅在调用 Update 方法时锁定记录。</TD></TR>
  <TR>
    <TD>adLockBatchOptimistic</TD>
    <TD>4</TD>
    <TD>指示开放式批更新。需要批更新模式。</TD></TR></TBODY></TABLE></DIV>
<DIV class=backtoreference>
