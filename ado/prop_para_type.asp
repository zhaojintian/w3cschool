...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO Type 属性</TITLE>
...
<P><A title="ADO Parameter 对象" href="ado_ref_parameter.asp">返回 ADO Parameter 
对象参考手册</A></P></DIV>
<DIV>
<H2>定义和用法</H2>
<P>Type 属性可设置或返回一个 <A href="app_datatypeenum.asp">DataTypeEnum</A> 值，该值可指示 
Parameter, Field 或 Property 对象的类型。</P>
<TABLE class=dataintable>
  ...
  <TR>
    <TD>Parameter</TD>
    <TD>对于 Parameter 对象，Type 属性拥有读/写权限。</TD></TR>
  <TR>
    <TD>Field</TD>
    <TD>对于已追加到 Record 的 Fields 集合中的新 Field 对象，只有当 Field 的 Value 
      属性已被指定并且数据提供者通过调用 Fields 集合的 Update 方法成功添加了新的 Field 时，Type 才为读/写。</TD></TR>
  <TR>
    <TD>Property</TD>
    <TD>对于 Property 对象，Type 属性是只读的。</TD></TR></TBODY></TABLE>
<H3>语法</H3><PRE>objectname.Type</PRE></DIV>
<DIV>
<H2>实例</H2>
<P>针对 Field 对象：</P><PRE>&lt;%
...
<P>针对 Property 对象：</P><PRE><SPAN class=CODE>&lt;%
