...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO NumericScale 属性</TITLE>
...
<TABLE class=dataintable>
  ...
  <TR>
    <TH>对象</TH>
    <TH>NumericScale 属性的描述</TH></TR>
  <TR>
    <TD>Field</TD>
    <TD>
      <P>对于 Field 对象，NumericScale 通常为只读。但是，对于已追加到 Record 的 Fields 集合中的新 Field 
      对象，只有当 Field 的 Value 属性已被指定并且数据提供者通过调用 Fields 集合的 Update 方法成功添加了新的 Field 
      时，NumericScale 才为读/写。</P></TD></TR>
  <TR>
    <TD>Parameter</TD>
    <TD>对于 Parameter 对象，NumericScale 属性拥有读/写权限。</TD></TR></TBODY></TABLE>
<H3>语法</H3><PRE>object.NumericScale</PRE></DIV>
<DIV>
<H2>实例</H2><PRE>&lt;%
