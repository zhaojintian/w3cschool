...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ADO Close 方法</TITLE>
...
<P 
class=note><SPAN>注释：</SPAN>关闭对象不会将其从内存中删除；随后可以更改其属性设置并再次将其打开。要从内存中彻底清除对象，请在关闭对象后将对象变量设置为 
Nothing（在 Visual Basic 中）。</P>
<H3>语法</H3><PRE>object.Close</PRE></DIV>
<DIV>
<H2>实例</H2><PRE>&lt;%
