...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP Server 对象</TITLE>
...
<UL>
  ...
  <LI class=currentLink><A title="ASP Server 对象" href="asp_ref_server.asp">ASP 
  Server</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="ASP Session 对象" href="asp_ref_session.asp">ASP 
  Session</A> </LI>
  <LI class=next><A title="ASP ASPError 对象" href="asp_ref_error.asp">ASP 
  Error</A> </LI></UL></DIV>
<DIV id=intro>
<P><STRONG>ASP Server 对象的作用是访问有关服务器的属性和方法。</STRONG></P></DIV>
<DIV class=example>
<H2>实例</H2>
<DL>
  <DT><A href="../tiy/s.asp@f=demo_aspe_lastmodified">此文件最后被修改的时间是？</A> 
  <DD>探测文件的最后更新时间。 
  <DT><A href="../tiy/s.asp@f=demo_aspe_textstream">打开并读取某个文本文件</A> 
  <DD>本例会打开文件 "Textfile.txt" 以供读取。 
  <DT><A href="../tiy/s.asp@f=demo_aspe_hitcounter">自制的点击计数器</A> 
  <DD>本例可从一个文件中读取一个数字，并在此数字上累加 1，然后将此数写回这个文件。 </DD></DL></DIV>
<DIV>
<H2>Server 对象</H2>
...
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TD>设置或返回在一段脚本终止前它所能运行时间（秒）的最大值。</TD></TR></TBODY></TABLE>
<H3>方法</H3>
<TABLE class=dataintable>
  <TBODY>
  <TR>
