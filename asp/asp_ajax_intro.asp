...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>AJAX 简介</TITLE>
...
<H2>AJAX 与 ASP</H2>
<UL>
  <LI class=currentLink><A title="AJAX 简介" href="asp_ajax_intro.asp">AJAX 简介</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="ASP Content Rotator (ASP 3.0)" 
  href="asp_contentrotator.asp">ASP ContentRotator</A> </LI>
  <LI class=next><A title="ASP - AJAX 与 ASP" href="asp_ajax_asp.asp">AJAX 
  ASP</A> </LI></UL></DIV>
<DIV id=intro>
<P><STRONG>AJAX 旨在不重载整个页面的情况下对网页的某些部分进行更新。</STRONG></P></DIV>
<DIV>
<H2>AJAX 是什么？</H2>
...
<P>使用 AJAX 的典型案例包括：谷歌地图、腾讯微博、优酷视频等等。</P></DIV>
<DIV>
<H2>AJAX 如何工作</H2><IMG src="../i/ajax.gif"> </DIV>
<DIV>
<H2>AJAX 基于因特网标准</H2>
<P>AJAX 基于因特网标准，并使用以下技术组合：</P>
<UL>
  <LI>XMLHttpRequest 对象（与服务器异步交互数据） 
  <LI>JavaScript/DOM （显示/取回信息） 
  <LI>CSS （设置数据的样式） 
  <LI>XML （常用作数据传输的格式） </LI></UL>
<P class=tip><SPAN>提示：</SPAN>AJAX 应用程序是独立于浏览器和平台的！</P></DIV>
<DIV>
<H2>谷歌搜索建议（Google Suggest）</H2>
<P>随着谷歌搜索建议功能在 2005 的发布，AJAX 开始流行起来。</P>
<P>谷歌搜索建议使用 AJAX 创造出动态性极强的 web 界面：当您在谷歌的搜索框中键入内容时，JavaScript 
会把字符发送到服务器，服务器则会返回建议列表。</P></DIV>
<DIV>
<H2>今天就开始使用 AJAX</H2>
<P>在我们的 ASP 教程中，我们将演示 AJAX 如何更新网页的某个部分，在不重载整个页面的情况下。我们将使用 ASP 来编写服务器端的脚步。</P>
<P>如果您希望学习更多有关 AJAX 的知识，请访问我们的 <A title="AJAX 教程" href="../ajax/index.asp">AJAX 
教程</A>。</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="ASP Content Rotator (ASP 3.0)" 
