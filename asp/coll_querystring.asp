...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP QueryString 集合</TITLE>
...
<DIV>
<P><A title="ASP Request 对象" href="asp_ref_request.asp">Request 
对象参考手册</A></P></DIV>
<DIV>
<H2>定义和用法</H2>
<P>QueryString 集合用于取回 HTTP 查询字符串中的变量值。</P>
<P>HTTP 查询字符串 (HTTP query string) 是由问号 (?) 之后的值规定的，比如：</P><PRE>&lt;a href="test.asp<CODE>?txt=this is a query string test</CODE>"&gt;带有查询字符串的链接&lt;/a&gt;</PRE>
<P>上面的代码可生成一个名为 txt 且值为 "this is a query string test"的变量。</P>
<P>查询字符串同样可以通过表单提交来生成，或者通过用户在浏览器的地址栏中输入查询。</P></DIV>
<DIV>
<H2>语法</H2><PRE>Request.QueryString(variable)[(index)|.Count]</PRE>
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TD vAlign=top>必需。在 HTTP 查询字符串中要取回的变量名称。</TD></TR>
  <TR>
    <TD vAlign=top>index </TD>
    <TD vAlign=top>可选。为一个变量规定多个值之一。从 1 到 
  Request.QueryString(variable).Count</TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>实例</H2>
<H3>例子 1</H3>
<P>遍历查询字符串中所有变量 n 的值：</P>
<P>假设，这是被送出的请求：</P><PRE>http://www.w3school.com.cn/test/names.asp?n=John&amp;n=Susan</PRE>
<P>而 names.asp 包含以下代码：</P><PRE>&lt;%
for i=1 to Request.QueryString("n").Count 
  Response.Write(Request.QueryString("n")(i) &amp; "&lt;br /&gt;")
next
%&gt;
</PRE>
<P>文件 names.asp 会显示出：</P><PRE>John
Susan
</PRE>
<H3>例子 2</H3>
<P>假设，这是被送出的字符串：</P><PRE>http://www.w3school.com.cn/test/names.asp?name=John&amp;age=30</PRE>
<P>上面的代码产生了以下 QUERY_STRING 值：</P><PRE>name=John&amp;age=30</PRE>
<P>现在，我们可以通过脚本使用这些信息：</P><PRE>Hi, &lt;%=Request.QueryString("name")%&gt;.&nbsp;
Your age is &lt;%= Request.QueryString("age")%&gt;.
</PRE>
<P>输出：</P><PRE>Hi, John. Your age is 30.</PRE>
<P>假如您没有规定任何要显示的变量值，比如这样：</P><PRE>Query string is: &lt;%=Request.QueryString%&gt;&nbsp;</PRE>
<P>输出将成为这样：</P><PRE>Query string is: name=John&amp;age=30</PRE></DIV>
<DIV>
<P><A title="ASP Request 对象" href="asp_ref_request.asp">Request 
对象参考手册</A></P></DIV></DIV>
<DIV id=sidebar>
