...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP 测验</TITLE>
...
<UL>
  ...
  <LI class=currentLink><A title="ASP 测验" href="asp_quiz.asp">ASP 测验</A> 
</LI></UL></DIV>
<DIV id=selected>
<H2>建站手册</H2>
<UL>
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="ASP 实例" href="../example/aspe_examples.asp">ASP 实例</A> 
  </LI>
  <LI class=next><A title="ASP 教程" href="index.asp">ASP 教程</A> </LI></UL></DIV>
<DIV id=intro>
<P><STRONG>您可以通过W3SCHOOL的测验程序来测试您的ASP技能。</STRONG></P></DIV>
<DIV>
<H2>关于本测验</H2>
<P>本测验包含20道题，每道题的最长答题时间是20分钟（这是由于每个session的默认有效时间是20钟）。</P>
<P>本测验是非官方的测试，它仅仅提供了一个了解您对ASP的掌握程度的工具。</P></DIV>
<DIV>
<H2>测验会被记分</H2>
<P>每道题的分值是1分。在您完成全部的20道题之后，系统会为您的测验打分，并提供您做错的题目的正确答案。其中，绿色为正确答案，而红色为错误答案。</P>
<P><A href="../quiz/quiz.asp@quiz=asp">现在就开始测验</A>！祝您好运。</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="ASP 实例" href="../example/aspe_examples.asp">ASP 实例</A> 
  </LI>
  <LI class=next><A title="ASP 教程" href="index.asp">ASP 教程</A> 
</LI></UL></DIV></DIV>
<DIV id=sidebar>
<DIV id=searchui>
