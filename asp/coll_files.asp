...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP Files 集合</TITLE>
...
<P><A title="ASP Folder 对象" href="asp_ref_folder.asp">Folder 
对象参考手册</A></P></DIV>
<DIV>
<H2>定义和用法</H2>
<P>Files 集合返回指定的文件夹中所有文件的一个集合。</P>
<H3>语法：</H3><PRE>FolderObject.Files</PRE></DIV>
<DIV>
<H2>实例</H2><PRE>&lt;%
dim fs,fo,x
