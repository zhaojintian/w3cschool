...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP 变量</TITLE>
<META content="text/html; charset=gb2312" http-equiv=Content-Type>
<META content=zh-cn http-equiv=Content-Language>
<META name=robots content=all>
<META name=keywords 
content="ASP变量,ASP Variables,Session变量,Application变量、变量的声明、数组">
...
<UL>
  ...
  <LI class=currentLink><A title="ASP 变量" href="asp_variables.asp">ASP 变量</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="ASP 语法" href="asp_syntax.asp">ASP 语法</A> </LI>
  <LI class=next><A title="ASP 子程序" href="asp_procedures.asp">ASP 程序</A> 
</LI></UL></DIV>
<DIV id=intro>
<P><STRONG>变量用于存储信息。</STRONG></P>
<P><STRONG>假如在子程序之外声明变量，那么这个变量可被 ASP 
文件中的任何脚本改变。假如在子程序中声明变量，那么当子程序每次执行时，它才会被创建和撤销。</STRONG></P></DIV>
<DIV class=example>
<H2>实例：</H2>
<DL>
  <DT><A href="../tiy/s.asp@f=demo_aspe_variable">声明变量</A> 
  <DD>变量用于存储信息。本例演示如何声明变量，为变量赋值，并在程序中使用这个变量 
  <DT><A href="../tiy/s.asp@f=demo_aspe_array">声明数组</A> 
  <DD>数组用于存储一系列相关的数据项目。本例演示如何声明一个存储名字的数组。 
  <DT><A href="../tiy/s.asp@f=demo_aspe_fornext2">循环生成 HTML 标题</A> 
  <DD>如何循环生成 6 个不同的 HTML 标题。 
  <DT><A href="../tiy/s.asp@f=demo_aspe_vbtime">使用 Vbscript 制作基于时间的问候语</A> 
  <DD>本例将根据服务器时间向用户显示不同的消息。 
  <DT><A href="../tiy/s.asp@f=demo_aspe_jstime">使用 JavaScript 制作基于时间的问候语</A> 
  <DD>本例同上，只是语法不同而已。 </DD></DL></DIV>
<DIV>
<H2>变量的生存期</H2>
...
<P>Application 变量同样对一个应用程序中的所有页面均有效。Application 
变量用于存储一个特定的应用程序中所有用户的信息。</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="ASP 语法" href="asp_syntax.asp">ASP 语法</A> </LI>
  <LI class=next><A title="ASP 子程序" href="asp_procedures.asp">ASP 程序</A> 
