...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP 使用 CDOSYS 发送电子邮件</TITLE>
...
<UL>
  ...
  <LI class=currentLink><A title="ASP 使用 CDOSYS 发送电子邮件" 
  href="asp_send_email.asp">ASP 邮件</A> </LI></UL>
<H2>ASP 高级</H2>
<UL>
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="ASP Global.asa 文件" href="asp_globalasa.asp">ASP 
  Global.asa</A> </LI>
  <LI class=next><A title="ASP Response 对象" href="asp_ref_response.asp">ASP 
  Response</A> </LI></UL></DIV>
<DIV id=intro>
<P><STRONG>CDOSYS 是 ASP 中的内置组件。此组建用于通过 ASP 来发送电子邮件。</STRONG></P></DIV>
<DIV>
...
<H3>CDONTs 怎么样？</H3>
<P>微软已经在 Windows 2000、Windows XP 以及 Windows 2003 中淘汰了 CDONTs。如果您还在应用程序中使用 
CDONTs，就需要更新代码，并使用新的 CDO 技术。</P>
<H3>使用 CDOSYS 的实例</H3>
<P>发送电子邮件：</P><PRE>&lt;%
...
<P>发送一封发送来自网站的网页的 HTML 邮件：</P><PRE>&lt;%
Set myMail=CreateObject("CDO.Message")
myMail.Subject="Sending email with CDO"
myMail.From="mymail@mydomain.com"
myMail.To="someone@somedomain.com"
...
<P>发送一封发送来自电脑中文件的网页的 HTML 邮件：</P><PRE>&lt;%
Set myMail=CreateObject("CDO.Message")
myMail.Subject="Sending email with CDO"
myMail.From="mymail@mydomain.com"
myMail.To="someone@somedomain.com"
