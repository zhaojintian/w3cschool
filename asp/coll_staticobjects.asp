...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP StaticObjects 集合</TITLE>
...
<DIV>
<P><A title="ASP Application 对象" href="asp_ref_application.asp">Application 
对象参考手册</A></P></DIV>
<DIV>
<H2>定义和用法</H2>
<P>StaticObjects 集合包含所有使用 HTML 的 &lt;object&gt; 标签追加到 application/session 
的对象。</P></DIV>
<DIV>
<H2>语法</H2><PRE>Application.StaticObjects(Key)
...
<TABLE class=dataintable>
  ...
  <TR>
    <TD>key </TD>
    <TD>必需。要取回的项目的名称。</TD></TR></TBODY></TABLE></DIV>
<DIV>
<H2>针对 Application 对象的实例</H2>
<H3>例子 1</H3>
<P>循环遍历 StaticObjects 集合：</P><PRE>&lt;%
...
<H3>例子 2</H3>
<P>在 Global.asa 中：</P><PRE>&lt;object runat="server" scope="application"
...
<H3>例子 2</H3>
<P>在 Global.asa 中：</P><PRE>&lt;object runat="server" scope="session"
id="MsgBoard" progid="msgboard.MsgBoard"&gt; 
&lt;/object&gt;
