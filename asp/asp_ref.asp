...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP 参考手册</TITLE>
...
<H2>ASP 对象</H2>
<UL>
  <LI><A title="ASP Response" href="asp_ref_response.asp">Response</A> 
  <LI><A title="ASP Request" href="asp_ref_request.asp">Request</A> 
  <LI><A title="ASP Application" href="asp_ref_application.asp">Application</A> 
  <LI><A title="ASP Session" href="asp_ref_session.asp">Session</A> 
  <LI><A title="ASP Server" href="asp_ref_server.asp">Server</A> 
  <LI><A title="ASP Error" href="asp_ref_error.asp">Error</A> 
  <LI><A title="ASP FileSystem" href="asp_ref_filesystem.asp">FileSystem</A> 
  <LI><A title="ASP TextStream" href="asp_ref_textstream.asp">TextStream</A> 
  <LI><A title="ASP Drive" href="asp_ref_drive.asp">Drive</A> 
  <LI><A title="ASP File" href="asp_ref_file.asp">File</A> 
  <LI><A title="ASP Folder" href="asp_ref_folder.asp">Folder</A> 
  <LI><A title="ASP Dictionary" href="asp_ref_dictionary.asp">Dictionary</A> 
  <LI><A title="ASP ADO" href="asp_ado.asp">ADO</A> </LI></UL></DIV>
<DIV>
<H2>ASP 组件</H2>
<UL>
  <LI><A title="ASP AdRotator" href="asp_adrotator.asp">AdRotator</A> 
  <LI><A title="ASP BrowserCap" href="asp_browser.asp">BrowserCap</A> 
  <LI><A title="ASP Content Linking" href="asp_contentlinking.asp">Content 
  Linking</A> 
  <LI><A title="ASP Content Rotator" href="asp_contentrotator.asp">Content 
  Rotator</A> </LI></UL></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="" href="default.htm"></A></LI>
