...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP 课程总结</TITLE>
...
<UL>
  ...
  <LI class=currentLink><A title="ASP 课程总结" href="asp_summary.asp">ASP 课程总结</A> 
  </LI></UL>
<H2>ASP 实例/测验</H2>
<UL>
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="ASP 快速参考" href="asp_quickref.asp">ASP 快速参考</A> </LI>
  <LI class=next><A title="ASP 实例" href="../example/aspe_examples.asp">ASP 
  实例</A> </LI></UL></DIV>
<DIV>
<H2>ASP 概要</H2>
<P>本教程已经为您讲解了如何为您的网站添加服务器端脚本，使得您网站的动态性和交互性更强。</P>
<P>我们已经学习了如何动态地编辑、改变或者添加网页内容，对来自 HTML 
表单的数据提交进行响应，访问数据或数据库并向浏览器返回结果，为不同的用户定制页面，从而使这些页面的可用性更强。</P>
<P>如需更多关于 ASP 的信息，请阅读我们的 <A href="../example/aspe_examples.asp">ASP 
实例</A>。</P></DIV>
<DIV>
...
<P>SQL 语句用于取回和更新数据库中的数据。SQL 与数据库程序协同工作，比如 MS Access、DB2、Informix、MS SQL 
Server、Oracle、Sybase 以及其他数据库系统。</P>
<P>假如您希望学习更多关于 SQL 的知识，请访问我们的 <A href="../sql/index.asp">SQL 教程</A>。</P>
<H3>ADO</H3>
<P>ADO 是从网站访问数据库中数据的编程接口。</P>
<P>ADO 使用 SQL 来查询数据库中的数据。</P>
<P>如果您希望学习更多关于 ADO 的知识，请访问我们的 <A href="../ado/index.asp">ADO 教程</A>。 </P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="ASP 快速参考" href="asp_quickref.asp">ASP 快速参考</A> </LI>
  <LI class=next><A title="ASP 实例" href="../example/aspe_examples.asp">ASP 
