...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>ASP Dictionary 对象</TITLE>
...
<UL>
  ...
  <LI class=currentLink><A title="ASP Dictionary 对象" 
  href="asp_ref_dictionary.asp">ASP Dictionary</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="ASP Folder 对象" href="asp_ref_folder.asp">ASP 
  Folder</A> </LI>
  <LI class=next><A title="ADO 简介" href="asp_ado.asp">ASP ADO</A> </LI></UL></DIV>
<DIV id=intro>
<P><STRONG>Dictionary 对象用于在结对的名称/值中存储信息（等同于键和项目）。</STRONG></P></DIV>
<DIV class=example>
<H2>实例</H2>
<DL>
  <DT><A href="../tiy/s.asp@f=demo_aspe_exists">指定的键存在吗？</A> 
  <DD>本例演示如何受首先创建一个 Dictionary 对象，然后使用 Exists 方法来检查指定的键是否存在。 
  <DT><A href="../tiy/s.asp@f=demo_aspe_items">返回一个所有项目的数组</A> 
  <DD>本例演示如何使用 Items 方法来返回所有项目的一个数组。 
  <DT><A href="../tiy/s.asp@f=demo_aspe_keys">返回一个所有键的数组</A> 
  <DD>本例演示如何使用 Keys 方法来返回所有键的一个数组。 
  <DT><A href="../tiy/s.asp@f=demo_aspe_item">返回某个项目的值</A> 
  <DD>本例演示如何使用 Item 属性来返回一个项目的值。 
  <DT><A href="../tiy/s.asp@f=demo_aspe_key">设置一个键</A> 
  <DD>本例演示如何使用 Key 属性来在 Dictionary 对象中设置一个键。 
  <DT><A href="../tiy/s.asp@f=demo_aspe_count">返回键/项目对的数目</A> 
  <DD>本例演示如何使用 Count 属性来返回键/项目对的数目。 </DD></DL></DIV>
<DIV>
<H2>Dictionary 对象</H2>
<P>Dictionary 对象用于在结对的名称/值中存储信息（(等同于键和项目）。Dictionary 对象看似比数组更为简单，然而，Dictionary 
对象却是更令人满意的处理关联数据的解决方案。</P>
<H3>比较 Dictionary 和数组：</H3>
<UL>
  <LI>键用于识别 Dictionary 对象中的项目 
  <LI>无需调用 ReDim 来改变 Dictionary 对象的尺寸 
  <LI>当从 Dictionary 删除一个项目时，其余的项目会自动上移 
  <LI>Dictionary 不是多维，而数组是 
  <LI>Dictionary 与数组相比，有更多的内建对象 
  <LI>Dictionary 在频繁地访问随机元素时，比数组工作得更好 
  <LI>Dictionary 在根据它们的内容定位项目时，比数组工作得更好 </LI></UL>
<P>下面的例子创建了一个 Dictionary 对象，并向对象添加了一些键/项目对，然后取回了键 bl 的值：</P><PRE>&lt;%
Dim d
...
<P>输出：</P><PRE>The value of key bl is: Blue</PRE></DIV>
<DIV>
...
<TABLE class=dataintable>
  ...
  <TR>
    ...
    <TD>设置或返回用于在 Dictionary 对象中比较键的比较模式。</TD></TR>
  <TR>
    <TD><A href="prop_count.asp">Count</A></TD>
    <TD>返回 Dictionary 对象中键/项目对的数目。</TD></TR>
  <TR>
    <TD><A href="prop_item.asp">Item</A></TD>
    <TD>设置或返回 Dictionary 对象中一个项目的值。</TD></TR>
  <TR>
    <TD><A href="prop_key.asp">Key</A></TD>
    <TD>为 Dictionary 对象中已有的键值设置新的键值。</TD></TR></TBODY></TABLE>
<H3>方法</H3>
<TABLE class=dataintable>
  <TBODY>
  <TR>
  ...
  <TR>
    ...
    <TD>向 Dictionary 对象添加新的键/项目对。</TD></TR>
  <TR>
    <TD><A href="met_exists.asp">Exists</A></TD>
    <TD>返回一个逻辑值，这个值可指示指定的键是否存在于 Dictionary 对象中。</TD></TR>
  <TR>
    <TD><A href="met_items.asp">Items</A></TD>
    <TD>返回 Dictionary 对象中所有项目的一个数组。</TD></TR>
  <TR>
    <TD><A href="met_keys.asp">Keys</A></TD>
    <TD>返回 Dictionary 对象中所有键的一个数组。</TD></TR>
  <TR>
    <TD><A href="met_remove.asp">Remove</A></TD>
    <TD>从 Dictionary 对象中删除指定的键/项目对。</TD></TR>
  <TR>
    <TD><A href="met_removeall.asp">RemoveAll</A></TD>
    <TD>删除 Dictionary 对象中所有的键/项目对。</TD></TR></TBODY></TABLE></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="ASP Folder 对象" href="asp_ref_folder.asp">ASP 
  Folder</A> </LI>
  <LI class=next><A title="ADO 简介" href="asp_ado.asp">ASP ADO</A> 
</LI></UL></DIV></DIV>
<DIV id=sidebar>
<DIV id=searchui>
