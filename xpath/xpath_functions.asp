...
<h2>XPath 参考手册</h2>
<ul>
<li class="currentLink"><a href="xpath_functions.asp" title="XPath、XQuery 以及 XSLT 函数">XPath 函数</a></li>
</ul>
</div><div id="selected">
<h2>建站手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xpath_summary.asp" title="您已经学习了 XPath，下一步呢？">XPath 总结</a></li>
<li class="next"><a href="index.asp" title="XPath 教程">XPath 教程</a></li>
</ul>
</div>
