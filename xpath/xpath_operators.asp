...
<li class="currentLink"><a href="xpath_operators.asp" title="XPath 运算符">XPath 运算符</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xpath_axes.asp" title="XPath Axes（轴）">XPath 轴</a></li>
<li class="next"><a href="xpath_examples.asp" title="XPath 实例">XPath 实例</a></li>
</ul>
</div>
