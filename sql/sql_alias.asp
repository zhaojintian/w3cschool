...
<li class="currentLink"><a href="sql_alias.asp" title="SQL Alias（别名）">SQL Aliases</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_between.asp" title="SQL BETWEEN">SQL Between</a></li>
<li class="next"><a href="sql_join.asp" title="SQL JOIN">SQL Join</a></li>
</ul>
</div>
