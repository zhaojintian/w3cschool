...
<h2>SQL 总结</h2>
<ul>
<li class="currentLink"><a href="sql_quickref.asp" title="SQL 快速参考">SQL 快速参考</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_func_format.asp" title="SQL FORMAT() 函数">SQL format()</a></li>
<li class="next"><a href="sql_summary.asp" title="我们已经学习了 SQL，下一步学习什么呢？">SQL 教程总结</a></li>
</ul>
</div>
