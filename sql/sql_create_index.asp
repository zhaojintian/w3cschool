...
<li class="currentLink"><a href="sql_create_index.asp" title="SQL CREATE INDEX 语句">SQL Create Index</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_default.asp" title="SQL DEFAULT 约束">SQL Default</a></li>
<li class="next"><a href="sql_drop.asp" title="SQL 撤销索引、表以及数据库">SQL Drop</a></li>
</ul>
</div>
