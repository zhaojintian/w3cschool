...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_drop.asp" title="SQL 撤销索引、表以及数据库">SQL Drop</a></li>
<li class="next"><a href="sql_autoincrement.asp" title="SQL AUTO INCREMENT 字段">SQL Increment</a></li>
</ul>
</div>
