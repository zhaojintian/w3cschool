...
<li class="currentLink"><a href="sql_func_max.asp" title="SQL MAX() 函数">SQL max()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_func_last.asp" title="SQL LAST() 函数">SQL last()</a></li>
<li class="next"><a href="sql_func_min.asp" title="SQL MIN() 函数">SQL min()</a></li>
</ul>
</div>
