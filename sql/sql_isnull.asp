...
<li class="currentLink"><a href="sql_isnull.asp" title="SQL NULL 函数">SQL isnull()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_null_values.asp" title="SQL NULL 值">SQL Nulls</a></li>
<li class="next"><a href="sql_datatypes.asp" title="SQL 数据类型">SQL 数据类型</a></li>
</ul>
</div>
