...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_primarykey.asp" title="SQL PRIMARY KEY 约束">SQL Primary Key</a></li>
<li class="next"><a href="sql_check.asp" title="SQL CHECK 约束">SQL Check</a></li>
</ul>
</div>
