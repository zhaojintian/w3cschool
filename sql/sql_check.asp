...
<li class="currentLink"><a href="sql_check.asp" title="SQL CHECK 约束">SQL Check</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_foreignkey.asp" title="SQL FOREIGN KEY 约束">SQL Foreign Key</a></li>
<li class="next"><a href="sql_default.asp" title="SQL DEFAULT 约束">SQL Default</a></li>
</ul>
</div>
