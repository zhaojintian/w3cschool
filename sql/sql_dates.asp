...
<li class="currentLink"><a href="sql_dates.asp" title="SQL Date 函数">SQL Date</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_view.asp" title="SQL VIEW（视图）">SQL View</a></li>
<li class="next"><a href="sql_null_values.asp" title="SQL NULL 值">SQL Nulls</a></li>
</ul>
</div>
