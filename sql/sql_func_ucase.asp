...
<li class="currentLink"><a href="sql_func_ucase.asp" title="SQL UCASE() 函数">SQL ucase()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_having.asp" title="SQL HAVING 子句">SQL Having</a></li>
<li class="next"><a href="sql_func_lcase.asp" title="SQL LCASE() 函数">SQL lcase()</a></li>
</ul>
</div>
