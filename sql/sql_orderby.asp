...
<li class="currentLink"><a href="sql_orderby.asp" title="SQL ORDER BY 语句">SQL Order By</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_and_or.asp" title="SQL AND &amp; OR">SQL AND &amp; OR</a></li>
<li class="next"><a href="sql_insert.asp" title="SQL INSERT INTO 语句">SQL insert</a></li>
</ul>
</div>
