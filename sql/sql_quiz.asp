...
<h2>SQL 测验</h2>
<ul>
<li class="currentLink"><a href="sql_quiz.asp" title="SQL 测验">SQL 测验</a></li>
</ul>
</div><div id="selected">
<h2>建站手册</h2>
<ul>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_summary.asp" title="我们已经学习了 SQL，下一步学习什么呢？">SQL 教程总结</a></li>
<li class="next"><a href="index.asp" title="SQL 教程">SQL 教程</a></li>
</ul>
</div>
