...
<li class="currentLink"><a href="sql_join_right.asp" title="SQL RIGHT JOIN 关键字">SQL Right Join</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_join_left.asp" title="SQL LEFT JOIN 关键字">SQL Left Join</a></li>
<li class="next"><a href="sql_join_full.asp" title="SQL FULL JOIN 关键字">SQL Full Join</a></li>
</ul>
</div>
