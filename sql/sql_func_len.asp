...
<li class="currentLink"><a href="sql_func_len.asp" title="SQL LEN() 函数">SQL len()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_func_mid.asp" title="SQL MID() 函数">SQL mid()</a></li>
<li class="next"><a href="sql_func_round.asp" title="SQL ROUND() 函数">SQL round()</a></li>
</ul>
</div>
