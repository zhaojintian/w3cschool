...
<li class="currentLink"><a href="sql_wildcards.asp" title="SQL 通配符">SQL 通配符</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_like.asp" title="SQL LIKE 运算符">SQL Like</a></li>
<li class="next"><a href="sql_in.asp" title="SQL IN">SQL In</a></li>
</ul>
</div>
