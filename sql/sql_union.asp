...
<li class="currentLink"><a href="sql_union.asp" title="SQL UNION 和 UNION ALL">SQL Union</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_join_full.asp" title="SQL FULL JOIN 关键字">SQL Full Join</a></li>
<li class="next"><a href="sql_select_into.asp" title="SQL SELECT INTO 语句">SQL Select Into</a></li>
</ul>
</div>
