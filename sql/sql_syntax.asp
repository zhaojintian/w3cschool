...
<li class="currentLink"><a href="sql_syntax.asp" title="SQL 语法">SQL 语法</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_intro.asp" title="SQL 简介">SQL 简介</a></li>
<li class="next"><a href="sql_select.asp" title="SQL SELECT 语句">SQL select</a></li>
</ul>
</div>
