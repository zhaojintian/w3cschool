...
<li class="currentLink"><a href="sql_intro.asp" title="SQL 简介">SQL 简介</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="index.asp" title="SQL 教程">SQL 教程</a></li>
<li class="next"><a href="sql_syntax.asp" title="SQL 语法">SQL 语法</a></li>
</ul>
</div>
