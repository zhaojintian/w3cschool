...
<li class="currentLink"><a href="sql_join_inner.asp" title="SQL INNER JOIN 关键字">SQL Inner Join</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_join.asp" title="SQL JOIN">SQL Join</a></li>
<li class="next"><a href="sql_join_left.asp" title="SQL LEFT JOIN 关键字">SQL Left Join</a></li>
</ul>
</div>
