...
<li class="currentLink"><a href="sql_join.asp" title="SQL JOIN">SQL Join</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_alias.asp" title="SQL Alias（别名）">SQL Aliases</a></li>
<li class="next"><a href="sql_join_inner.asp" title="SQL INNER JOIN 关键字">SQL Inner Join</a></li>
</ul>
</div>
