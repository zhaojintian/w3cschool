...
<li class="currentLink"><a href="sql_between.asp" title="SQL BETWEEN">SQL Between</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_in.asp" title="SQL IN">SQL In</a></li>
<li class="next"><a href="sql_alias.asp" title="SQL Alias（别名）">SQL Aliases</a></li>
</ul>
</div>
