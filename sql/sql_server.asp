...
<li class="currentLink"><a href="sql_server.asp" title="SQL 服务器 - RDBMS">SQL 服务器</a></li>
</ul>
<h2>SQL 函数</h2>
<ul>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_datatypes.asp" title="SQL 数据类型">SQL 数据类型</a></li>
<li class="next"><a href="sql_functions.asp" title="SQL 函数">SQL functions</a></li>
</ul>
</div>
