...
<h2>SQL 函数</h2>
<ul>
<li class="currentLink"><a href="sql_functions.asp" title="SQL 函数">SQL functions</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_server.asp" title="SQL 服务器 - RDBMS">SQL 服务器</a></li>
<li class="next"><a href="sql_func_avg.asp" title="SQL AVG() 函数">SQL avg()</a></li>
</ul>
</div>
