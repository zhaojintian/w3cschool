...
<li class="currentLink"><a href="sql_unique.asp" title="SQL UNIQUE 约束">SQL Unique</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_notnull.asp" title="SQL NOT NULL 约束">SQL Not Null</a></li>
<li class="next"><a href="sql_primarykey.asp" title="SQL PRIMARY KEY 约束">SQL Primary Key</a></li>
</ul>
</div>
