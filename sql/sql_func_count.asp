...
<li class="currentLink"><a href="sql_func_count.asp" title="SQL COUNT() 函数">SQL count()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_func_avg.asp" title="SQL AVG() 函数">SQL avg()</a></li>
<li class="next"><a href="sql_func_first.asp" title="SQL FIRST() 函数">SQL first()</a></li>
</ul>
</div>
