...
<li class="currentLink"><a href="sql_func_avg.asp" title="SQL AVG() 函数">SQL avg()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_functions.asp" title="SQL 函数">SQL functions</a></li>
<li class="next"><a href="sql_func_count.asp" title="SQL COUNT() 函数">SQL count()</a></li>
</ul>
</div>
