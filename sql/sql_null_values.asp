...
<li class="currentLink"><a href="sql_null_values.asp" title="SQL NULL 值">SQL Nulls</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_dates.asp" title="SQL Date 函数">SQL Date</a></li>
<li class="next"><a href="sql_isnull.asp" title="SQL NULL 函数">SQL isnull()</a></li>
</ul>
</div>
