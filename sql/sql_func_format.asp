...
<li class="currentLink"><a href="sql_func_format.asp" title="SQL FORMAT() 函数">SQL format()</a></li>
</ul>
<h2>SQL 总结</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_func_now.asp" title="SQL NOW() 函数">SQL now()</a></li>
<li class="next"><a href="sql_quickref.asp" title="SQL 快速参考">SQL 快速参考</a></li>
</ul>
</div>
