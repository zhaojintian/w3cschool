...
<li class="currentLink"><a href="sql_create_db.asp" title="SQL CREATE DATABASE 语句">SQL Create DB</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_select_into.asp" title="SQL SELECT INTO 语句">SQL Select Into</a></li>
<li class="next"><a href="sql_create_table.asp" title="SQL CREATE TABLE 语句">SQL Create Table</a></li>
</ul>
</div>
