...
<li class="currentLink"><a href="sql_view.asp" title="SQL VIEW（视图）">SQL View</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_autoincrement.asp" title="SQL AUTO INCREMENT 字段">SQL Increment</a></li>
<li class="next"><a href="sql_dates.asp" title="SQL Date 函数">SQL Date</a></li>
</ul>
</div>
