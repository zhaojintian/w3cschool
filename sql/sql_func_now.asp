...
<li class="currentLink"><a href="sql_func_now.asp" title="SQL NOW() 函数">SQL now()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_func_round.asp" title="SQL ROUND() 函数">SQL round()</a></li>
<li class="next"><a href="sql_func_format.asp" title="SQL FORMAT() 函数">SQL format()</a></li>
</ul>
</div>
