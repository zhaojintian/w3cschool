...
<li class="currentLink"><a href="sql_update.asp" title="SQL UPDATE 语句">SQL update</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_insert.asp" title="SQL INSERT INTO 语句">SQL insert</a></li>
<li class="next"><a href="sql_delete.asp" title="SQL DELETE 语句">SQL delete</a></li>
</ul>
</div>
