...
<h2>SQL 高级教程</h2>
<ul>
<li class="currentLink"><a href="sql_top.asp" title="SQL TOP 子句">SQL Top</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_delete.asp" title="SQL DELETE 语句">SQL delete</a></li>
<li class="next"><a href="sql_like.asp" title="SQL LIKE 运算符">SQL Like</a></li>
</ul>
</div>
