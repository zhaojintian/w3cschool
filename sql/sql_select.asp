...
<li class="currentLink"><a href="sql_select.asp" title="SQL SELECT 语句">SQL select</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_syntax.asp" title="SQL 语法">SQL 语法</a></li>
<li class="next"><a href="sql_distinct.asp" title="SQL SELECT DISTINCT 语句">SQL distinct</a></li>
</ul>
</div>
