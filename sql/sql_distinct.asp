...
<li class="currentLink"><a href="sql_distinct.asp" title="SQL SELECT DISTINCT 语句">SQL distinct</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_select.asp" title="SQL SELECT 语句">SQL select</a></li>
<li class="next"><a href="sql_where.asp" title="SQL WHERE 子句">SQL where</a></li>
</ul>
</div>
