...
<li class="currentLink"><a href="sql_select_into.asp" title="SQL SELECT INTO 语句">SQL Select Into</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_union.asp" title="SQL UNION 和 UNION ALL">SQL Union</a></li>
<li class="next"><a href="sql_create_db.asp" title="SQL CREATE DATABASE 语句">SQL Create DB</a></li>
</ul>
</div>
