...
<li class="currentLink"><a href="sql_autoincrement.asp" title="SQL AUTO INCREMENT 字段">SQL Increment</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_alter.asp" title="SQL ALTER TABLE">SQL Alter</a></li>
<li class="next"><a href="sql_view.asp" title="SQL VIEW（视图）">SQL View</a></li>
</ul>
</div>
