...
<li class="currentLink"><a href="sql_func_lcase.asp" title="SQL LCASE() 函数">SQL lcase()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_func_ucase.asp" title="SQL UCASE() 函数">SQL ucase()</a></li>
<li class="next"><a href="sql_func_mid.asp" title="SQL MID() 函数">SQL mid()</a></li>
</ul>
</div>
