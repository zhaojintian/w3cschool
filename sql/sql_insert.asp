...
<li class="currentLink"><a href="sql_insert.asp" title="SQL INSERT INTO 语句">SQL insert</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_orderby.asp" title="SQL ORDER BY 语句">SQL Order By</a></li>
<li class="next"><a href="sql_update.asp" title="SQL UPDATE 语句">SQL update</a></li>
</ul>
</div>
