...
<li class="currentLink"><a href="sql_join_full.asp" title="SQL FULL JOIN 关键字">SQL Full Join</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_join_right.asp" title="SQL RIGHT JOIN 关键字">SQL Right Join</a></li>
<li class="next"><a href="sql_union.asp" title="SQL UNION 和 UNION ALL">SQL Union</a></li>
</ul>
</div>
