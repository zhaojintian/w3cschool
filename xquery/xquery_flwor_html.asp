...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>XQuery FLWOR + HTML</TITLE>
...
<UL>
  ...
  <LI class=currentLink><A title="XQuery FLWOR + HTML" 
  href="xquery_flwor_html.asp">XQuery HTML</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="XQuery FLWOR 表达式" href="xquery_flwor.asp">XQuery 
  FLWOR</A> </LI>
  <LI class=next><A title="XQuery 术语" href="xquery_terms.asp">XQuery 术语</A> 
</LI></UL></DIV>
<DIV>
<H2>XML 实例文档</H2>
...
<P>请看下面的 XQuery FLWOR 表达式：</P><PRE>for $x in doc("books.xml")/bookstore/book/title
order by $x
return $x
</PRE>
<P>上面的表达式会选取 bookstore 元素下的 book 元素下的所有 title 元素，并以字母顺序返回 title 元素。</P>
<P>现在，我们希望使用 HTML 列表列出我们的书店中所有的书目。我们向 FLWOR 表达式添加 &lt;ul&gt; 和 &lt;li&gt; 
标签：</P><PRE><CODE>&lt;ul&gt;
{</CODE>
...
&lt;/ul&gt;</PRE>
<P>现在我们希望去除 title 元素，而仅仅显示 title 元素内的数据。</P><PRE>&lt;ul&gt;
{
for $x in doc("books.xml")/bookstore/book/title
order by $x
