...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>XQuery 参考手册</TITLE>
...
<H2>XQuery 参考手册</H2>
<UL>
  <LI class=currentLink><A title="XQuery 参考手册" 
  href="xquery_reference.asp">XQuery 参考手册</A> </LI></UL></DIV>
<DIV id=selected>
<H2>建站手册</H2>
<UL>
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="XQuery 课程总结" href="xquery_summary.asp">XQuery 总结</A> 
  </LI>
  <LI class=next><A title="XQuery 教程" href="index.asp">XQuery 教程</A> 
</LI></UL></DIV>
<DIV>
<P><STRONG>XQuery 1.0 和 XPath 2.0 分享相同的数据模型，并支持相同的函数和运算符。</STRONG></P></DIV>
<DIV>
<H2>XQuery 函数</H2>
<P>XQuery 构建在 XPath 表达式之上。XQuery 1.0 和 XPath 2.0 分享相同的数据模型，并支持相同的函数和运算符。</P>
<P><A href="../xpath/xpath_operators.asp">XPath 运算符</A></P>
<P><A href="../xpath/xpath_functions.asp">XPath 函数</A></P></DIV>
<DIV>
<H2>XQuery 数据类型</H2>
...
<P><A href="../schema/schema_dtypes_misc.asp">XSD Misc</A></P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="XQuery 课程总结" href="xquery_summary.asp">XQuery 总结</A> 
  </LI>
