...
<ul>
<li><a href="index.asp" title="Web Services 教程">WS 教程</a></li>
...
<li class="currentLink"><a href="ws_use.asp" title="Web Services 使用">WS 使用</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="ws_example.asp" title="Web Services 实例">WS 实例</a></li>
<li class="next"><a href="ws_summary.asp" title="您已经学习了 Web Services,下一步学习什么内容呢？">WS 总结</a></li>
</ul>
</div>
...
<p>在上一节，我们创建了一个 <a href="../../www.w3schools.com/webservices/tempconvert.asmx" title="TempConvert Web Service">Web Service 的例子</a>。</p>
<p>请在此测试华氏度转换摄氏度函数：<a href="../../www.w3schools.com/webservices/tempconvert.asmx@op=FahrenheitToCelsius" title="TempConvert Web Service">华氏度转换为摄氏度</a></p>
<p>请在此测试摄氏度转换华氏度函数：<a href="../../www.w3schools.com/webservices/tempconvert.asmx@op=CelsiusToFahrenheit" title="TempConvert Web Service">摄氏度转换为华氏度</a></p>
</div>
...
<form  action='http://www.w3schools.com/webservices/tempconvert.asmx/FahrenheitToCelsius' method="POST">
...
<form  action='http://www.w3schools.com/webservices/tempconvert.asmx/CelsiusToFahrenheit' method="POST">
