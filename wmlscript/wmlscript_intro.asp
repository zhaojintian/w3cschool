...
<li class="currentLink"><a href="wmlscript_intro.asp" title="WMLScript 简介">WMLScript 简介</a></li>
...
<li class="next"><a href="wmlscript_howto.asp" title="WMLScript 调用">WMLScript 调用</a></li>
</ul>
</div>
