...
<title>HTML DOM Input Image 对象</title>
...
<li class="currentLink"><a href="dom_obj_input_image.asp" title="HTML DOM Input Image 对象">&lt;input&gt; image</a></li>
...
<h1>HTML DOM Input Image 对象</h1>


<div>
<h2>Input Image 对象</h2>

<p>Input Image 对象是 HTML5 中的新对象。</p>

<p>Input Image 对象表示 HTML &lt;image&gt; 元素。</p>

<h3>访问 Input Image 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;image&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myImage&quot;);</pre>

<p class="tip"><span>提示：</span>您也可以通过遍历表单的 <a href="coll_form_elements.asp" title="HTML DOM elements 集合">elements 集合</a>来访问 Input Image 对象。</p>

<h3>创建 Input Image 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;image&gt; 元素：</p>
...
<tr>
<td>autocomplete</td>
<td>设置或返回 email 字段的 autocomplete 属性值。</td>
</tr>

<tr>
<td>alt</td>
<td>设置或返回 input image 的 alt 属性值。</td>
</tr>

<tr>
<td>autofocus</td>
<td>设置或返回 input image 在页面加载后是否应自动获取焦点。</td>
</tr>

<tr>
<td>defaultValue</td>
<td>设置或返回 input image 的默认值。</td>
</tr>

<tr>
<td>disabled</td>
<td>设置或返回 input image 是否被禁用。</td>
</tr>

<tr>
<td>form</td>
<td>返回对包含 input image 的表单的引用。</td>
</tr>

<tr>
<td>formAction</td>
<td>设置或返回 input image 的 formaction 属性值。</td>
</tr>

<tr>
<td>formEnctype</td>
<td>设置或返回 input image 的 formenctype 属性值。</td>
</tr>

<tr>
<td>formMethod</td>
<td>设置或返回 input image 的 formmethod 属性值。</td>
</tr>

<tr>
<td>formNoValidate</td>
<td>设置或返回在提交表单时是否应该验证表单数据（form-data）。</td>
</tr>

<tr>
<td>formTarget</td>
<td>设置或返回 input image 的 formtarget 属性值。</td>
</tr>

<tr>
<td>height</td>
<td>设置或返回 input image 的 height 属性值。</td>
</tr>

<tr>
<td>name</td>
<td>设置或返回 input image 的 name 属性值。</td>
</tr>

<tr>
<td>src</td>
<td>设置或返回 input image 的 src 属性值。</td>
</tr>

<tr>
<td>type</td>
<td>返回 input image 字段的表单元素类型。</td>
</tr>

<tr>
<td>value</td>
<td>设置或返回 input image 的 value 属性值。</td>
</tr>

<tr>
<td>width</td>
<td>设置或返回 input image 的 width 属性值。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>Input Image 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
