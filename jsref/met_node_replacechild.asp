...
<title>HTML DOM replaceChild() 方法</title>
...
<h1>HTML DOM replaceChild() 方法</h1>
...
<p>用一个新项目替换列表中的某个项目：</p>

<pre>document.getElementById(&quot;myList&quot;).replaceChild(newnode,oldnode);</pre>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_replacechild">亲自试一试</a></p>
</div>
...
<p>replaceChild() 方法用新节点替换某个子节点。</p>

<p>这个新节点可以是文档中某个已存在的节点，或者您也可创建新的节点。</p>
</div>
...
<p>所有主流浏览器均支持 replaceChild() 方法。</p>
</div>
...
<pre>node.replaceChild(<i>newnode</i>,<i>oldnode</i>)</pre>
