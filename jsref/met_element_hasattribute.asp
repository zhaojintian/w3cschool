...
<title>HTML DOM hasAttribute() 方法</title>
...
<h1>HTML DOM hasAttribute() 方法</h1>
...
<p>检查 button 元素是否有 onclick 属性：</p>

<pre>document.getElementsByTagName(&quot;BUTTON&quot;)[0].hasAttribute(&quot;onclick&quot;);</pre>

<p>结果：</p>

<pre>true</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_element_hasattribute">亲自试一试</a></p>
</div>
...
<p>如果存在指定属性，则 hasAttribute() 方法返回 true，否则返回 false。</p>
</div>
...
<p>所有主流浏览器均支持 hasAttribute() 方法。</p>
...
<pre>element.hasAttribute(<i>attributename</i>)</pre>
...
<tr>
<td>Boolean</td>
<td>如果存在该属性，则返回 true，否则返回 false。</td>
</tr>
</table>
