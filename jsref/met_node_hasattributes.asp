...
<title>HTML DOM hasAttributes() 方法</title>
...
<h1>HTML DOM hasAttributes() 方法</h1>
...
<pre>document.body.hasAttributes()</pre>

<p>结果：</p>

<pre>false</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_hasattributes">亲自试一试</a></p>
</div>
...
<p>如果指定节点拥有属性，则 hasAttributes() 方法返回 true，否则返回 false。</p>

<p>如果指定节点不是元素节点，则返回值始终是 false。</p>
</div>
...
<p>所有主流浏览器均支持 hasAttributes() 方法。</p>
...
<tr>
<td>Boolean</td>
<td>如果节点有属性，则返回 true，否则返回 false。</td>
</tr>
</table>
