...
<title>HTML DOM nodeValue 属性</title>
...
<p>获得第一个 button 元素的节点值：</p>

<pre>document.getElementsByTagName(&quot;BUTTON&quot;)[0].childNodes[0].nodeValue;</pre>

<p>结果：</p>

<pre>Try it yourself</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_nodevalue">亲自试一试</a></p>
</div>
...
<p class="note"><span>注释：</span>如果您希望返回元素的文本，请记住文本始终位于文本节点中，并且您必须返回文本节点的值（element.childNodes[0].nodeValue）。</p>

<p class="tip"><span>提示：</span>nodeValue 属性的替代选择是 textContent 属性。</p>
</div>
...
<pre>node.nodeValue=<i>value</i></pre>
