...
<title>HTML DOM TableHeader 对象</title>
...
<li class="currentLink"><a href="dom_obj_tablehead.asp" title="HTML DOM TableHeader 对象">&lt;th&gt;</a></li>
...
<h1>HTML DOM TableHeader 对象</h1>


<div>
<h2>TableHeader 对象</h2>

<p>TableHeader 对象是 HTML5 中的新对象。</p>

<p>TableHeader 对象表示 HTML &lt;th&gt; 元素。</p>

<h3>访问 TableHeader 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;th&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myTh&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_th_get">亲自试一试</a></p>

<h3>创建 TableHeader 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;th&gt; 元素：</p>

<pre>var x = document.createElement(&quot;TH&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_th_create">亲自试一试</a></p>
</div>


<div>
<h2>TableHeader 对象属性</h2>
...
<tr>
<td>abbr</td>
<td>设置或返回 abbr 属性值。</td>
</tr>

<tr>
<td>align</td>
<td>
<p><span class="marked">HTML5 中不支持。</span>请使用 style.textAlign 代替。</p>
<p>设置或返回数据单元中内容的水平对齐方式。</p>
</td>
</tr>
...
<td>axis</td>
<td>
<p><span class="marked">HTML5 中不支持。</span></p>
<p>设置或返回相关联数据单元的以逗号分隔列表。</p>
</td>
</tr>
...
<td>background</td>
<td>
<p><span class="marked">HTML5 中不支持。</span>请使用 style.background 代替。</p>
<p>设置或返回数据单元的背景图像。</p>
</td>
</tr>
...
<td>bgColor</td>
<td>
<p><span class="marked">HTML5 中不支持。</span>请使用 style.backgroundColor 代替。</p>
<p>设置或返回表格的背景色。</p>
</td>
</tr>
...
<td>
<p><span class="marked">HTML5 中不支持。</span></p>
<p>设置或返回 ch 属性的水平偏移。</p>
</td>
</tr>

<tr>
<td>colSpan</td>
<td>设置或返回 colspan 属性值。</td>
</tr>

<tr>
<td>headers</td>
<td>设置或返回 headers 属性值。</td>
</tr>

<tr>
<td>height</td>
<td>
<p><span class="marked">HTML5 中不支持。</span>请使用 style.height 代替。</p>
<p>设置或返回数据单元的高度。</p>
</td>
</tr>
...
<td>noWrap</td>
<td>
<p><span class="marked">HTML5 中不支持。</span>请使用 style.whiteSpace 代替。</p>
<p>设置或返回单元内的内容是否能够折行。</p>
</td>
</tr>

<tr>
<td>rowSpan</td>
<td>设置或返回 rowspan 属性值。</td>
</tr>

<tr>
<td>vAlign</td>
<td>
<p><span class="marked">HTML5 中不支持。</span>请使用 style.verticalAlign 代替。</p>
<p>设置或返回单元内容的垂直对齐方式。</p>
</td>
</tr>
...
<td>width</td>
<td>
<p><span class="marked">HTML5 中不支持。</span>请使用 style.width 代替。</p>
<p>设置或返回数据单元的宽度。</p>
</td>
</tr>
</table>
...
<p>TableHeader 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 教程：<a href="../html/html_tables.asp">HTML 表格</a></p>

<p>HTML 参考手册：<a href="../tags/tag_th.asp">HTML &lt;th&gt; 标签</a></p>
</div>
