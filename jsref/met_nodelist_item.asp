...
<pre>document.body.childNodes.item(0);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_nodelist_item">亲自试一试</a></p>
</div>
...
<pre>nodelist.item(<i>index</i>)</pre>
