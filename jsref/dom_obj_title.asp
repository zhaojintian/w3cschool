...
<li class="currentLink"><a href="dom_obj_title.asp" title="HTML DOM Title 对象">&lt;title&gt;</a></li>
...
<h1>HTML DOM Title 对象</h1>


<div>
<h2>Title 对象</h2>

<p>Title 对象表示 HTML &lt;title&gt; 元素。</p>

<h3>访问 Title 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;title&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myTitle&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_title_get">亲自试一试</a></p>

<h3>创建 Title 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;title&gt; 元素：</p>

<pre>var x = document.createElement(&quot;TITLE&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_title_create">亲自试一试</a></p>
</div>
...
<p>Title 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 参考手册：<a href="../tags/tag_title.asp">HTML &lt;title&gt; 标签</a></p>
</div>
