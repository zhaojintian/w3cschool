...
<title>HTML DOM attributes 属性</title>
...
<pre>document.getElementsByTagName(&quot;BUTTON&quot;)[0].attributes;</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_attributes">亲自试一试</a></p>
</div>
...
<p>attributes 属性返回指定节点的属性集合，即 NamedNodeMap。</p>

<p class="tip"><span>提示：</span>您可以使用 length 属性来确定属性的数量，然后您就能够遍历所有的属性节点并提取您需要的信息。</p>
</div>
...
<p>所有主流浏览器都支持 attributes 属性。</p>

<p class="note"><span>注释：</span>在 Internet Explorer 8 以及更早的版本中，attributes 属性会返回元素所有可能属性的集合。</p>
</div>
