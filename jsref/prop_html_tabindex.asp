...
<p>tabIndex 属性设置或返回元素的 tab 键控制次序。</p>

<h3>语法</h3>

<pre>HTMLElementObject.tabIndex=tabIndex</pre>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_html_tabindex">亲自试一试</a></p>
</div>
