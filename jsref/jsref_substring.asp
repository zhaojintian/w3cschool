...
<div>
<h2>提示和注释</h2>
<p class="important"><span>重要事项：</span>与 <a href="jsref_slice_string.asp" title="JavaScript slice() 方法">slice()</a> 和 <a href="jsref_substr.asp" title="JavaScript substr() 方法">substr()</a> 方法不同的是，substring() 不接受负的参数。</p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jseg_substring2">亲自试一试</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jseg_substring">亲自试一试</a></p>
</div>
