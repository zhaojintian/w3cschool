...
<title>HTML DOM removeNamedItem() 方法</title>
...
<h1>HTML DOM removeNamedItem() 方法</h1>
...
<p>删除 input 按钮的 type 属性：</p>

<pre>
var btn=document.getElementsByTagName(&quot;INPUT&quot;)[0];
btn.attributes.<code>removeNamedItem(&quot;type&quot;)</code>;
</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_namednodemap_removenameditem">亲自试一试</a></p>
</div>
...
<p>removeNamedItem() 方法删除 namedNodeMap 中带有指定名称的节点。</p>
</div>
...
<p>所有主流浏览器都支持 removeNamedItem() 方法。</p>

<p class="note"><span>注释：</span>在 Internet Explorer 8 以及更早的版本中，当使用 removedNamedItem 方法来删除属性时，此方法会返回该属性，但不会删除该属性。</p>
</div>
...
<pre>namednodemap.removeNamedItem(<i>nodename</i>)</pre>
...
<td><i>nodename</i></td>
<td>String</td>
<td>必需。您希望删除的 namedNodeMap 中节点的名称。</td>
</tr>
</table>
