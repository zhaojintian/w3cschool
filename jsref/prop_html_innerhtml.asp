...
<p>innerHTML 属性设置或返回元素的 inner HTML。</p>

<h3>语法</h3>

<pre>HTMLElementObject.innerHTML=text</pre>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_html_innerhtml">亲自试一试</a></p>
</div>
