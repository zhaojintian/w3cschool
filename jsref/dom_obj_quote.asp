...
<li class="currentLink"><a href="dom_obj_quote.asp" title="HTML DOM Quote 对象">&lt;q&gt;</a></li>
...
<h1>HTML DOM Quote 对象</h1>


<div>
<h2>Quote 对象</h2>

<p>Quote 对象表示 HTML &lt;q&gt; 元素。</p>

<h3>访问 Quote 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;q&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myQuote&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_quote_get">亲自试一试</a></p>

<h3>创建 Quote 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;q&gt; 元素：</p>

<pre>var x = document.createElement(&quot;Q&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_quote_create">亲自试一试</a></p>
</div>
...
<tr>
<td>cite</td>
<td>设置或返回引用的 cite 属性值。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>Quote 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 参考手册：<a href="../tags/tag_q.asp">HTML &lt;q&gt; 标签</a></p>
</div>
