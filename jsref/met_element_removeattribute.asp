...
<title>HTML DOM removeAttribute() 方法</title>
...
<h1>HTML DOM removeAttribute() 方法</h1>
...
<p>删除 header 元素的 style 属性：</p>

<pre>document.getElementsByTagName(&quot;H1&quot;)[0].removeAttribute(&quot;style&quot;);</pre>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_element_removeattribute">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器均支持 removeAttribute() 方法。</p>
</div>
...
<pre>element.removeAttribute(<i>attributename</i>)</pre>
