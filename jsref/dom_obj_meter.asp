...
<li class="currentLink"><a href="dom_obj_meter.asp" title="HTML DOM Meter 对象">&lt;meter&gt;</a></li>
...
<h1>HTML DOM Meter 对象</h1>


<div>
<h2>Meter 对象</h2>

<p>Meter 对象是 HTML5 中的新对象。</p>

<p>Meter 对象表示 HTML &lt;meter&gt; 元素。</p>

<h3>访问 Meter 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;meter&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myMeter&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_meter_get">亲自试一试</a></p>

<h3>创建 Meter 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;meter&gt; 元素：</p>

<pre>var x = document.createElement(&quot;METER&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_meter_create">亲自试一试</a></p>
</div>
...
<tr>
<td>high</td>
<td>设置或返回 gauge 中 high 属性的值。</td>
</tr>

<tr>
<td>labels</td>
<td>返回属于 gauge 标记的 &lt;label&gt; 元素列表。</td>
</tr>

<tr>
<td>low</td>
<td>设置或返回 gauge 中 low 属性的值。</td>
</tr>

<tr>
<td>max</td>
<td>设置或返回 gauge 中 max 属性的值。</td>
</tr>

<tr>
<td>min</td>
<td>设置或返回 gauge 中 min 属性的值。</td>
</tr>

<tr>
<td>optimum</td>
<td>设置或返回 gauge 中 optimum 属性的值。</td>
</tr>

<tr>
<td>value</td>
<td>设置或返回 gauge 中 value 属性的值。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>Meter 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 参考手册：<a href="../tags/tag_meter.asp">HTML &lt;meter&gt; 标签</a></p>
</div>
