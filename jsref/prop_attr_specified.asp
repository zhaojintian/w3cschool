...
<title>HTML DOM specified 属性</title>
...
<pre>document.getElementById(&quot;demo&quot;).attributes[0].<code>specified</code>;</pre>

<p>结果：</p>

<pre>true</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_attr_specified">亲自试一试</a></p>
</div>
...
<p>specified 属性返回 true，如果已规定某个属性。</p>

<p>如果已创建该属性但尚未添加到元素中，也会返回 true。</p>
