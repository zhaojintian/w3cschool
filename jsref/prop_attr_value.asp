...
<pre>document.getElementsByTagName(&quot;button&quot;)[0].attributes[0].<code>value</code>;</pre>

<p>结果：</p>

<pre>myFunction()</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_attr_value">亲自试一试</a></p>

<h3>实例 2：设置属性的值</h3>

<p>设置标题元素的 style 属性：</p>

<pre>
var h=document.getElementsByTagName(&quot;H1&quot;)[0];
<code>h.getAttributeNode(&quot;style&quot;).value=&quot;color:green&quot;;</code>
</pre>

<p>改变样式之前：</p>

<pre><span style="font-size:14px; color:red;">Hello World</span></pre>

<p>改变样式之后：</p>

<pre><span style="font-size:14px; color:green;">Hello World</span></pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_attr_value2">亲自试一试</a></p>
</div>
...
<pre>attribute.value=<i>value</i></pre>
