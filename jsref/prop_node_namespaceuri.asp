...
<title>HTML DOM namespaceURI 属性</title>
...
<h1>HTML DOM namespaceURI 属性</h1>
...
<p>获得一个 XHTML 文档的命名空间的 URI：</p>

<pre>document.documentElement.namespaceURI;</pre>

<p>结果：</p>

<pre>http://www.w3.org/1999/xhtml</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_namespaceuri">亲自试一试</a></p>
</div>
...
<p>namespaceURI 属性返回指定节点的命名空间的 URI。</p>

<p class="note"><span>注释：</span>元素节点继承其父节点的命名空间，因此，XHTML 文档中的所有元素都拥有 namespaceURI &quot;http://www.w3.org/1999/xhtml&quot;。</p>
</div>
...
<p>所有主流浏览器均支持 namespaceURI 属性。</p>

<p class="note"><span>注释：</span>Internet Explorer 8 以及更早的版本不支持该属性。</p>
</div>
