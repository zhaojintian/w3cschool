...
<title>HTML DOM getNamedItem() 方法</title>
...
<h1>HTML DOM getNamedItem() 方法</h1>
...
<p>返回 button 元素的 onclick 属性值：</p>

<pre>
var btn=document.getElementsByTagName(&quot;BUTTON&quot;)[0];
btn.attributes.<code>getNamedItem(&quot;onclick&quot;)</code>.textContent;
</pre>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_namednodemap_getnameditem">亲自试一试</a></p>
</div>
...
<p>getNamedItem() 方法从 namedNodeMap 中返回具有指定名称的属性节点。</p>
</div>
...
<p>所有主流浏览器都支持 getNamedItem() 方法。</p>
...
<pre>namednodemap.getNamedItem(<i>name</i>)</pre>
...
<td><i>nodename</i></td>
<td>String</td>
<td>必需。您希望返回的 namedNodeMap 中节点的名称。</td>
</tr>
</table>
