...
<title>HTML DOM Datalist 对象</title>
...
<li class="currentLink"><a href="dom_obj_datalist.asp" title="HTML DOM Datalist 对象">&lt;datalist&gt;</a></li>
...
<h1>HTML DOM Datalist 对象</h1>


<div>
<h2>Datalist 对象</h2>

<p>Datalist 对象是 HTML5 中的新对象。</p>

<p>Datalist 对象表示 HTML &lt;datalist&gt; 元素。</p>

<h3>访问 Datalist 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;datalist&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myDatalist&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_datalist_get">亲自试一试</a></p>

<h3>创建 Datalist 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;datalist&gt; 元素：</p>

<pre>var x = document.createElement(&quot;DATALIST&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_datalist_create">亲自试一试</a></p>
</div>
...
<tr>
<td>options</td>
<td>返回 datalist 中所有选项的集合。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>Datalist 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 参考手册：<a href="../tags/tag_datalist.asp">HTML &lt;datalist&gt; 标签</a></p>
</div>
