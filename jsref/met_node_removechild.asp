...
<title>HTML DOM removeChild() 方法</title>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_removechild">亲自试一试</a></p>
</div>
...
<p>removeChild() 方法指定元素的某个指定的子节点。</p>

<p>以 Node 对象返回被删除的节点，如果节点不存在则返回 null。</p>
</div>
...
<pre>node.removeChild(<i>node</i>)</pre>
