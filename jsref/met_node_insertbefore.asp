...
<title>HTML DOM insertBefore() 方法</title>
...
<h1>HTML DOM insertBefore() 方法</h1>
...
<pre>document.getElementById(&quot;myList&quot;).insertBefore(newItem,existingItem);</pre>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_insertbefore">亲自试一试</a></p>
</div>
...
<p>insertBefore() 方法在您指定的已有子节点之前插入新的子节点。</p>

<p class="tip"><span>提示：</span>如果您希望创建包含文本的新列表项，请记得创建文本节点形式的文本，以便追加到 LI 元素中，然后向列表插入这个 LI。</p>

<p>您也可以使用 insertBefore 方法插入/移动已有元素。</p>
</div>
...
<p>所有主流浏览器均支持 insertBefore() 方法。</p>
</div>
...
<pre>node.insertBefore(<i>newnode</i>,<i>existingnode</i>)</pre>
...
<tr>
<td><i>existingnode</i></td>
<td>Node object</td>
<td>可选。在其之前插入新节点的子节点。如果未规定，则 insertBefore 方法会在结尾插入 newnode。</td>
</tr>
</table>
