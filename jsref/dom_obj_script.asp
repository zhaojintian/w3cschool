...
<title>HTML DOM Script 对象</title>
...
<li class="currentLink"><a href="dom_obj_script.asp" title="HTML DOM Script 对象">&lt;script&gt;</a></li>
...
<h1>HTML DOM Script 对象</h1>


<div>
<h2>Script 对象</h2>

<p>Script 对象表示 HTML &lt;script&gt; 元素。</p>

<h3>访问 Script 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;script&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myScript&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_script_get">亲自试一试</a></p>

<h3>创建 Script 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;script&gt; 元素：</p>

<pre>var x = document.createElement(&quot;SCRIPT&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_script_create">亲自试一试</a></p>
</div>
...
<tr>
<td>async</td>
<td>设置或返回是否脚本一旦可用，就应异步执行。</td>
</tr>

<tr>
<td>charset</td>
<td>设置或返回脚本的 charset 属性值。</td>
</tr>

<tr>
<td>cross Origin</td>
<td>设置或返回脚本的 CORS 设置。</td>
</tr>

<tr>
<td>defer</td>
<td>设置或返回当页面完成解析后是否执行脚本。</td>
</tr>

<tr>
<td>src</td>
<td>设置或返回脚本的 src 属性值。</td>
</tr>

<tr>
<td>text</td>
<td>设置或返回属于脚本子节点的所有文本节点的内容。</td>
</tr>

<tr>
<td>type</td>
<td>设置或返回脚本的 type 属性值。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>Script 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 参考手册：<a href="../tags/tag_script.asp">HTML &lt;script&gt; 标签</a></p>
</div>
