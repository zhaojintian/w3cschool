...
<li class="currentLink"><a href="dom_obj_attributes.asp" title="HTML DOM Attribute 对象">DOM Attribute</a></li>
...
<p>在 HTML DOM 中，<em>Attr</em> 对象表示 HTML 属性。</p>
...
<p>在 HTML DOM 中，<em>NamedNodeMap</em> 对象表示元素属性节点的无序集合。</p>

<p>NamedNodeMap 中的节点可通过名称或索引（数字）来访问。</p>
</div>
...
<tr>
<td><a href="prop_attr_isid.asp" title="HTML DOM isId 属性">attr.isId</a></td>
<td>如果属性是 id 类型，则返回 true，否则返回 false。</td>
</tr>

<tr>
<td><a href="prop_attr_name.asp" title="HTML DOM name 属性">attr.name</a></td>
<td>返回属性的名称。</td>
</tr>

<tr>
<td><a href="prop_attr_value.asp" title="HTML DOM value 属性">attr.value</a></td>
<td>设置或返回属性的值。</td>
</tr>

<tr>
<td><a href="prop_attr_specified.asp" title="HTML DOM specified 属性">attr.specified</a></td>
<td>如果已指定属性，则返回 true，否则返回 false。</td>
</tr>

<tr>
<td><a href="met_namednodemap_getnameditem.asp" title="HTML DOM getNamedItem() 方法">nodemap.getNamedItem()</a></td>
<td>从 NamedNodeMap 返回指定的属性节点。</td>
</tr>

<tr>
<td><a href="met_namednodemap_item.asp" title="HTML DOM item() 方法">nodemap.item()</a></td>
<td>返回 NamedNodeMap 中位于指定下标的节点。</td>
</tr>

<tr>
<td><a href="prop_namednodemap_length.asp" title="HTML DOM length 属性">nodemap.length</a></td>
<td>返回 NamedNodeMap 中的节点数。</td>
</tr>

<tr>
<td><a href="met_namednodemap_removenameditem.asp" title="HTML DOM removeNamedItem() 方法">nodemap.removeNamedItem()</a></td>
<td>移除指定的属性节点。</td>
</tr>

<tr>
<td><a href="met_namednodemap_setnameditem.asp" title="HTML DOM setNamedItem() 方法">nodemap.setNamedItem()</a></td>
