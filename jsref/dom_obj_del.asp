...
<li class="currentLink"><a href="dom_obj_del.asp" title="HTML DOM Del 对象">&lt;del&gt;</a></li>
...
<h1>HTML DOM Del 对象</h1>


<div>
<h2>Del 对象</h2>

<p>Del 对象表示 HTML &lt;del&gt; 元素。</p>

<h3>访问 Del 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;del&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myDel&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_del_get">亲自试一试</a></p>

<h3>创建 Del 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;del&gt; 元素：</p>

<pre>var x = document.createElement(&quot;DEL&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_del_create">亲自试一试</a></p>
</div>
...
<tr>
<td>cite</td>
<td>设置或者返回被删除文本的 cite 属性值。</td>
</tr>

<tr>
<td>dateTime</td>
<td>设置或者返回被删除文本的 datetime 属性值。</td>
</tr>
...
<p>Del 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 教程：<a href="../html/html_formatting.asp">HTML 文本格式化</a></p>

<p>HTML 参考手册：<a href="../tags/tag_del.asp">HTML &lt;del&gt; 标签</a></p>

<p>JavaScript 参考手册：<a href="dom_obj_ins.asp">HTML DOM ins 对象</a></p>
</div>
