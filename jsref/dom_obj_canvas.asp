...
<li class="currentLink"><a href="dom_obj_canvas.asp" title="HTML DOM Canvas 对象">&lt;canvas&gt;</a></li>
...
<p>Canvas 对象表示一个 HTML 画布元素 - <a href="../tags/tag_canvas.asp" title="HTML 5 &lt;canvas&gt; 标签">&lt;canvas&gt;</a>。它没有自己的行为，但是定义了一个 API 支持脚本化客户端绘图操作。</p>
...
<p>&lt;canvas&gt; 标记在 Safari 1.3 中引入，在制作此参考页时，它在 Firefox 1.5 和 Opera 9 中也得到了支持。在 IE 中，&lt;canvas&gt; 标记及其 API 可以使用位于 <a href="../../excanvas.sourceforge.net/default.htm" title="ExplorerCanvas">excanvas.sourceforge.net</a> 的 ExplorerCanvas 开源项目来模拟。</p>
