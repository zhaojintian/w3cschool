...
<li class="currentLink"><a href="dom_obj_track.asp" title="HTML DOM Track 对象">&lt;track&gt;</a></li>
...
<h1>HTML DOM Track 对象</h1>


<div>
<h2>Track 对象</h2>

<p>Track 对象是 HTML5 中的新对象。</p>

<p>Track 对象表示 HTML &lt;track&gt; 元素。</p>

<h3>访问 Track 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;track&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myTrack&quot;);</pre>

<h3>创建 Track 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;track&gt; 元素：</p>

<pre>var x = document.createElement(&quot;TRACK&quot;);</pre>
</div>
...
<tr>
<td>kind</td>
<td>设置或返回轨道的 kind 属性值。</td>
</tr>

<tr>
<td>label</td>
<td>设置或返回轨道的 label 属性值。</td>
</tr>
...
<tr>
<td>src</td>
<td>设置或返回轨道的 src 属性值。</td>
</tr>

<tr>
<td>srclang</td>
<td>设置或返回轨道的 srclang 属性值。</td>
</tr>

<tr>
<td>track</td>
<td>返回表示 track 元素文本轨道数据的 TextTrack 对象。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>Track 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 参考手册：<a href="../tags/tag_track.asp">HTML &lt;track&gt; 标签</a></p>
</div>
