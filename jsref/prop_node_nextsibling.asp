...
<title>HTML DOM nextSibling 属性</title>
...
<pre>document.getElementById(&quot;item1&quot;).nextSibling;</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_nextsibling">亲自试一试</a></p>
</div>
...
<p>nextSibling 属性返回指定节点之后紧跟的节点，在相同的树层级中。</p>

<p>被返回的节点以 Node 对象返回。</p>

<p class="note"><span>注释：</span>如果没有 nextSibling 节点，则返回值为 null。</p>
</div>
