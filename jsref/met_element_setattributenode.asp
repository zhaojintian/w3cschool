...
<title>HTML DOM setAttributeNode() 方法</title>
...
<h1>HTML DOM setAttributeNode() 方法</h1>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_element_setattributenode">亲自试一试</a></p>
</div>
...
<p>setAttributeNode() 方法向元素中添加指定的属性节点。</p>

<p>如果这个指定的属性已存在，则此方法会替换它。</p>
</div>
...
<p>所有主流浏览器均支持 setAttributeNode() 方法。</p>
</div>
...
<pre>element.setAttributeNode(<i>attributenode</i>)</pre>
