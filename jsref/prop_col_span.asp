...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_col_span2">亲自试一试</a></p>
</div>
...
<p>span 属性设置或返回列的 span 属性的值。</p>

<p>span 属性 &lt;col&gt; 元素应该横跨的列数。</p>
</div>
...
<pre>columnObject.span</pre>

<p>设置 formMethod 属性：</p>

<pre>columnObject.span=<i>number</i></pre>
...
<p>返回 &lt;col&gt; 元素应该横跨的列数：</p>

<pre>var x = document.getElementById(&quot;myCol&quot;).span;</pre>

<p>x 的结果：</p>

<p>2</p>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_col_span">亲自试一试</a></p>
</div>
