...
<title>HTML DOM getAttributeNode() 方法</title>
...
<h1>HTML DOM getAttributeNode() 方法</h1>
...
<pre>document.getElementsByTagName(&quot;a&quot;)[0].getAttributeNode(&quot;target&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_element_getattributenode">亲自试一试</a></p>
</div>
...
<p>getAttribute() 方法返回指定属性名的属性值，以 Attr 对象。</p>

<p class="tip"><span>提示：</span>如果您只需要返回属性值，请使用 getAttribute。</p>
</div>
...
<p>所有主流浏览器均支持 getAttributeNode() 方法。</p>
</div>
...
<pre>element.getAttributeNode(<i>attributename</i>)</pre>
