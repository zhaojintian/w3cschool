...
<title>HTML DOM Dialog 对象</title>
...
<li class="currentLink"><a href="dom_obj_dialog.asp" title="HTML DOM Dialog 对象">&lt;dialog&gt;</a></li>
...
<h1>HTML DOM Dialog 对象</h1>


<div>
<h2>Dialog 对象</h2>

<p>Dialog 对象是 HTML5 中的新对象。</p>

<p>Dialog 对象表示 HTML &lt;dialog&gt; 元素。</p>

<p class="note"><span>注释：</span>目前只有 Chrome Canary 和 Safari 6 支持 &lt;dialog&gt; 元素。</p>

<h3>访问 Dialog 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;dialog&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myDialog&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_dialog_get">亲自试一试</a></p>

<h3>创建 Dialog 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;dialog&gt; 元素：</p>

<pre>var x = document.createElement(&quot;DIALOG&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_dialog_create">亲自试一试</a></p>
</div>
...
<p>Dialog 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 参考手册：<a href="../tags/tag_dialog.asp">HTML &lt;dialog&gt; 标签</a></p>
</div>
