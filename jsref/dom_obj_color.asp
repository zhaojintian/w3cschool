...
<li class="currentLink"><a href="dom_obj_color.asp" title="HTML DOM Color 对象">&lt;input&gt; color</a></li>
...
<h1>HTML DOM Color 对象</h1>


<div>
<h2>Color 对象</h2>

<p>Color 对象是 HTML5 中的新对象。</p>

<p>Color 对象表示 HTML &lt;input type=&quot;color&quot;&gt; 元素。</p>

<p class="note"><span>注释：</span>Internet Explorer 和 Safari 不支持 &lt;input type=&quot;color&quot;&gt; 元素。</p>

<h3>访问 Color 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;color&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myColor&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_color_get">亲自试一试</a></p>

<p class="tip"><span>提示：</span>您也可以通过遍历表单的 <a href="coll_form_elements.asp" title="HTML DOM elements 集合">elements 集合</a>来访问 Color 对象。</p>

<h3>创建 Color 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;color&gt; 元素：</p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_color_create">亲自试一试</a></p>
</div>
...
<tr>
<td><a href="prop_colgroup_span.asp" title="Color span 属性">span</a></td>
<td>设置或返回列的 span 属性的值。</td>
</tr>

<tr>
<td>autocomplete</td>
<td>设置或返回色彩选择器的 autocomplete 属性值。</td>
</tr>

<tr>
<td>autofocus</td>
<td>设置或返回色彩选择器在页面加载后是否应自动获取焦点。</td>
</tr>

<tr>
<td>defaultValue</td>
<td>设置或返回色彩选择器的默认值。</td>
</tr>

<tr>
<td>disabled</td>
<td>设置或返回色彩选择器是否被禁用。</td>
</tr>

<tr>
<td>form</td>
<td>返回对包含色彩选择器的表单的引用。</td>
</tr>

<tr>
<td>list</td>
<td>返回对包含色彩选择器的 datalist 的引用。</td>
</tr>

<tr>
<td>name</td>
<td>设置或返回色彩选择器的 name 属性值。</td>
</tr>

<tr>
<td>type</td>
<td>返回色彩选择器的表单元素类型。</td>
</tr>

<tr>
<td>value</td>
<td>设置或返回色彩选择器的 value 属性值。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>Color 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
