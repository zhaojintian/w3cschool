...
<li class="currentLink"><a href="dom_obj_ol.asp" title="HTML DOM Ol 对象">&lt;ol&gt;</a></li>
...
<h1>HTML DOM Ol 对象</h1>


<div>
<h2>Ol 对象</h2>

<p>Ol 对象表示 HTML &lt;ol&gt; 元素。</p>

<h3>访问 Ol 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;ol&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myOl&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_ol_get">亲自试一试</a></p>

<h3>创建 Ol 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;ol&gt; 元素：</p>

<pre>var x = document.createElement(&quot;OL&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_ol_create">亲自试一试</a></p>
</div>
...
<td>compact</td>
<td>
    <p>HTML5 中不支持。请使用 <a href="prop_style_lineheight.asp" title="HTML DOM lineHeight 属性">style.lineHeight</a> 代替。</p>
    <p>设置或返回列表是否应该比正常值显示得略小。</p>
</td>
</tr>

<tr>
<td>reversed</td>
<td>设置或返回列表顺序是否为降序。</td>
</tr>

<tr>
<td>start</td>
<td>设置或返回有序列表的 start 属性值。</td>
</tr>

<tr>
<td>type</td>
<td>设置或返回有序列表的 type 属性值。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>Ol 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 参考手册：<a href="../tags/tag_ol.asp">HTML &lt;ol&gt; 标签</a></p>
</div>
