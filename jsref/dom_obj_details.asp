...
<title>HTML DOM Details 对象</title>
...
<li class="currentLink"><a href="dom_obj_details.asp" title="HTML DOM Details 对象">&lt;details&gt;</a></li>
...
<h1>HTML DOM Details 对象</h1>


<div>
<h2>Details 对象</h2>

<p>Details 对象表示 HTML &lt;details&gt; 元素。</p>

<h3>访问 Details 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;details&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myDetails&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_details_get">亲自试一试</a></p>

<h3>创建 Details 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;details&gt; 元素：</p>

<pre>var x = document.createElement(&quot;DETAILS&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_details_create">亲自试一试</a></p>
</div>
...
<tr>
<td>open</td>
<td>设置或者返回 details 对于用户是否是可见的。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>Details 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 参考手册：<a href="../tags/tag_details.asp">HTML &lt;details&gt; 标签</a></p>
</div>
