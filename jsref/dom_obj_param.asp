...
<title>HTML DOM Parameter 对象</title>
...
<li class="currentLink"><a href="dom_obj_param.asp" title="HTML DOM Parameter 对象">&lt;param&gt;</a></li>
...
<h1>HTML DOM Parameter 对象</h1>


<div>
<h2>Parameter 对象</h2>

<p>Parameter 对象表示 HTML &lt;param&gt; 元素。</p>

<h3>访问 Parameter 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;param&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myParam&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_param_get">亲自试一试</a></p>

<h3>创建 Parameter 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;param&gt; 元素：</p>

<pre>var x = document.createElement(&quot;PARAM&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_param_create">亲自试一试</a></p>
</div>


<div>
<h2>Parameter 对象属性</h2>
...
<tr>
<td>name</td>
<td>设置或返回参数的 name 属性值。</td>
</tr>

<tr>
<td>value</td>
<td>设置或返回参数的 value 属性值。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>Parameter 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 参考手册：<a href="../tags/tag_param.asp">HTML &lt;param&gt; 标签</a></p>
</div>
