...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_element_getelementsbytagname">亲自试一试</a></p>
</div>
...
<p>getElementsByTagName() 方法返回具有指定标签名的元素子元素集合，以 NodeList 对象。</p>

<p class="tip"><span>提示：</span>参数值 &quot;*&quot; 返回元素的所有子元素。</p>
</div>
...
<p>所有主流浏览器均支持 getElementsByTagName() 方法。</p>
</div>
...
<pre>element.getElementsByTagName(<i>tagname</i>)</pre>
