...
<title>HTML DOM isContentEditable 属性</title>
...
<h1>HTML DOM isContentEditable 属性</h1>
...
<pre>var x = document.getElementById(&quot;myP&quot;).isContentEditable;</pre>

<p>x 的结果是：</p>

<pre>true</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_html_iscontenteditable">亲自试一试</a></p>
</div>
...
<p>isContentEditable 属性返回元素的内容是否可编辑。</p>

<p>该属性为只读。</p>

<p class="tip"><span>提示：</span>请使用 contentEditable 属性来改变元素的可编辑状态。</p>
</div>
...
<pre>HTMLElementObject.isContentEditable</pre>
...
<td>逻辑值，如果元素内容可编辑，则返回 true，否则返回 false。</td>
</tr>
</table>
</div>
...
<p>HTML 参考手册：HTML contenteditable 属性</p>
</div>
