...
<li class="currentLink"><a href="dom_obj_label.asp" title="HTML DOM Label 对象">&lt;label&gt;</a></li>
...
<h1>HTML DOM Label 对象</h1>


<div>
<h2>Label 对象</h2>

<p>Label 对象表示 HTML &lt;label&gt; 元素。</p>

<h3>访问 Label 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;label&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myLabel&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_label_get">亲自试一试</a></p>

<h3>创建 Label 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;label&gt; 元素：</p>

<pre>var x = document.createElement(&quot;LABEL&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_label_create">亲自试一试</a></p>
</div>
...
<tr>
<td>form</td>
<td>返回对包含 label 的表单的引用。</td>
</tr>

<tr>
<td>htmlFor</td>
<td>设置或返回 label 的 for 属性值。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>Label 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 参考手册：<a href="../tags/tag_label.asp">HTML &lt;label&gt; 标签</a></p>
</div>
