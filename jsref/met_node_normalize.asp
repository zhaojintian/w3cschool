...
<title>HTML DOM normalize() 方法</title>
...
<pre>xmlDoc.getElementById(&quot;demo&quot;).normalize();</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_normalize">亲自试一试</a></p>
</div>
...
<p>normalize() 方法移除空的文本节点，并连接相邻的文本节点。</p>
</div>
