...
<title>HTML DOM Input Search 对象</title>
...
<li class="currentLink"><a href="dom_obj_search.asp" title="HTML DOM Input Search 对象">&lt;input&gt; search</a></li>
...
<h1>HTML DOM Input Search 对象</h1>


<div>
<h2>Input Search 对象</h2>

<p>Input Search 对象是 HTML5 中的新对象。</p>

<p>Input Search 对象表示 HTML &lt;input type=&quot;search&quot;&gt; 元素。</p>

<p class="note"><span>注释：</span>Internet Explorer 9（以及更早的版本）或 Safari 不支持 &lt;input type=&quot;search&quot;&gt; 元素。</p>

<h3>访问 Input Search 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;search&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;mySearch&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_search_get">亲自试一试</a></p>

<h3>创建 Input Search 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;search&gt; 元素：</p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_search_create">亲自试一试</a></p>
</div>


<div>
<h2>Input Search 对象属性</h2>
...
<tr>
<td>autocomplete</td>
<td>设置或返回 Search 字段的 autocomplete 属性值。</td>
</tr>

<tr>
<td>autofocus</td>
<td>设置或返回 Search 字段在页面加载后是否应自动获取焦点。</td>
</tr>

<tr>
<td>defaultValue</td>
<td>设置或返回 Search 字段的默认值。</td>
</tr>

<tr>
<td>disabled</td>
<td>设置或返回 Search 字段是否被禁用。</td>
</tr>

<tr>
<td>form</td>
<td>返回对包含 Search 字段的表单的引用。</td>
</tr>

<tr>
<td>list</td>
<td>返回对包含 Search 字段的 datalist 的引用。</td>
</tr>

<tr>
<td>maxLength</td>
<td>设置或返回 search 字段的 maxLength 属性值。</td>
</tr>

<tr>
<td>name</td>
<td>设置或返回 Search 字段的 name 属性值。</td>
</tr>

<tr>
<td>pattern</td>
<td>设置或返回 Search 字段的 pattern 属性值。</td>
</tr>

<tr>
<td>placeholder</td>
<td>设置或返回 Search 字段的 placeholder 属性值。</td>
</tr>

<tr>
<td>readOnly</td>
<td>设置或返回 Search 字段是否是只读的。</td>
</tr>

<tr>
<td>required</td>
<td>设置或返回在提交表单之前是否必须填写 Search 字段。</td>
</tr>

<tr>
<td>size</td>
<td>设置或返回 Search 字段的 size 属性值。</td>
</tr>

<tr>
<td>step</td>
<td>设置或返回 Search 字段的 step 属性值。</td>
</tr>

<tr>
<td>type</td>
<td>返回 Search 字段的表单元素类型。</td>
</tr>

<tr>
<td>value</td>
<td>设置或返回 Search 字段的 value 属性值。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>Input Search 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
