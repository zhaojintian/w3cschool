...
<title>HTML DOM nodeName 属性</title>
...
<pre>document.body.nodeName;</pre>

<p>结果：</p>

<pre>BODY</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_nodename">亲自试一试</a></p>
</div>
...
<p>入股节点是属性节点，则 nodeName 属性返回属性的名称。</p>
