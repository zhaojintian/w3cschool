...
<p>返回 body 元素的子节点数量：</p>

<pre>document.body.childNodes.length;</pre>

<p>结果：</p>

<pre>8</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_nodelist_length">亲自试一试</a></p>
</div>
...
<p>length 属性返回集合中的节点数量。</p>

<p>Node 对象的子节点集合是 NodeList 对象的实例。</p>
</div>
