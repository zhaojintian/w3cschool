...
<p>返回 button 元素的首个属性的名称：</p>

<pre>document.getElementsByTagName(&quot;BUTTON&quot;)[0].attributes.item(0).nodeName;</pre>

<p>结果：</p>

<pre>onclick</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_namednodemap_item">亲自试一试</a></p>
</div>
...
<p>item() 方法以 Node 对象返回 namedNodeMap 中位于指定索引的节点。</p>

<h3>语法：</h3>

<pre>document.getElementsByTagName(&quot;BUTTON&quot;)[0].attributes.item(0);</pre>

<p>下面这条语法产生相同的结果：</p>

<pre>document.getElementsByTagName(&quot;BUTTON&quot;)[0].attributes[0];</pre>
</div>
...
<pre>namednodemap.item(<i>index</i>)</pre>
...
<td><i>index</i></td>
<td>Number</td>
<td>必须。您希望返回的 namedNodeMap 中节点的索引。</td>
</tr>
</table>
