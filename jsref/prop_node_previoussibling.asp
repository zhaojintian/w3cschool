...
<title>HTML DOM previousSibling 属性</title>
...
<h1>HTML DOM previousSibling 属性</h1>
...
<p>返回列表项的 previousSibling（前一个同胞节点）：</p>

<pre>document.getElementById(&quot;item2&quot;).previousSibling;</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_previoussibling">亲自试一试</a></p>
</div>
...
<p>previousSibling 属性返回同一树层级中指定节点的前一个节点。</p>

<p>被返回的节点以 Node 对象的形式返回。</p>

<p class="note"><span>注释：</span>如果没有 previousSibling 节点，则返回值是 null。</p>
</div>
...
<p>所有主流浏览器均支持 previousSibling 属性。</p>
</div>
