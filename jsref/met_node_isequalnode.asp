...
<title>HTML DOM isEqualNode() 方法</title>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_isequalnode">亲自试一试</a></p>
</div>
...
<p>isEqualNode() 方法检查两个节点是否相等。</p>

<p>如果下例条件为 true，则两个节点相等：</p>

<ul>
<li>节点类型相同</li>
<li>拥有相同的 nodeName、NodeValue、localName、nameSpaceURI 以及前缀</li>
<li>所有后代均为相同的子节点</li>
<li>拥有相同的属性和属性值（属性次序不必一致）</li>
</ul>

<p class="tip"><span>提示：</span>请使用 isSameNode() 方法来检测两节点是否是相同节点。</p>
</div>
...
<pre>node.isEqualNode(<i>node</i>)</pre>
...
<tr>
<td>Boolean</td>
<td>如果两节点相等，则返回 true，否则返回 false。</td>
</tr>
</table>
