...
<p>title 属性设置或返回元素的咨询标题。</p>

<h3>语法</h3>

<pre>HTMLElementObject.title=title</pre>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_html_title">亲自试一试</a></p>

<h3>例子 2</h3>

<p>返回图像映射中某个区域的咨询标题：</p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_html_title2">亲自试一试</a></p>
</div>
