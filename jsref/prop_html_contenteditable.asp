...
<title>HTML DOM contentEditable 属性</title>
...
<h1>HTML DOM contentEditable 属性</h1>

<div class="backtoreference">
<p><a href="dom_obj_all.asp">HTML DOM Element 对象</a></p>
</div>
...
<pre>document.getElementById(&quot;myP&quot;).contentEditable = true;</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_html_contenteditable">亲自试一试</a></p>
</div>
...
<p>contentEditable 属性设置或返回元素内容是否可编辑。</p>

<p class="tip"><span>提示：</span>您也可以使用 isContentEditable 属性来查明元素内容是否可编辑。</p>
</div>
...
<p>返回 contentEditable 属性：</p>

<pre>HTMLElementObject.contentEditable</pre>

<p>设置 contentEditable 属性：</p>

<pre>HTMLElementObject.contentEditable=true|false</pre>
...
<td>
    ...
    <li>inherit - 默认。如果父元素可编辑，则元素内容可编辑。</li>
    <li>true - 内容可编辑。</li>
    <li>false - 内容不可编辑。</li>
    </ul>
</td>
...
<table class="dataintable">
<tr>
<td style="width:25%;">返回值：</td>
<td>逻辑值，如果元素可编辑则返回 true，否则返回 false。</td>
</tr>
</table>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_html_contenteditable2">亲自试一试</a></p>

<h3>例子 2</h3>

<p>对是否能够对 &lt;p&gt; 元素的内容进行编辑进行切换：</p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_html_contenteditable3">亲自试一试</a></p>
</div>
