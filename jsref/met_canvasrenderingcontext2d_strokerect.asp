...
<p><a href="dom_obj_canvasrenderingcontext2d.asp" title="HTML DOM CanvasRenderingContext2D 对象">HTML DOM CanvasRenderingContext2D 对象</a></p>
</div>
...
<p>strokeRect() 的当前实现会清晰化路径，就好像 <a href="default.htm" title="">beginPath()</a> 已经调用过了。这一令人吃惊的行为可能不会标准化，所以不能指望它。</p>
</div>
