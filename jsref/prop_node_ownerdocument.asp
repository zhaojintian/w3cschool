...
<title>HTML DOM ownerDocument 属性</title>
...
<h1>HTML DOM ownerDocument 属性</h1>
...
<p>返回元素的 ownerDocument：</p>

<pre>document.getElementById(&quot;demo&quot;).ownerDocument;</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_ownerdocument">亲自试一试</a></p>
</div>
...
<p>ownerDocument 属性以 Document 对象的形式返回节点的 owner document。</p>

<p>在 HTML 中，HTML 文档本身始终是元素的 ownerDocument。</p>

<p>请在我们的文档对象参考手册中浏览更多有关 Document 对象的内容。</p>
</div>
...
<p>所有主流浏览器均支持 ownerDocument 属性。</p>
</div>
...
<td>Document 对象，节点的 owner document。</td>
</tr>
