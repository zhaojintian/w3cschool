...
<title>HTML DOM tagName 属性</title>
...
<pre>document.getElementById(&quot;demo&quot;).tagName;</pre>

<p>结果：</p>

<pre>P</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_element_tagname">亲自试一试</a></p>
</div>
...
<p>tagName 属性返回元素的标签名。</p>

<p>在 HTML 中，tagName 属性的返回值始终是大写的。</p>
</div>
