...
<p>返回 button 元素的属性数：</p>

<pre>document.getElementsByTagName(&quot;BUTTON&quot;)[0].attributes.<code>length</code>;</pre>

<p>结果：</p>

<pre>1</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_namednodemap_length">亲自试一试</a></p>
</div>
...
<p>length 属性返回集合中节点的数量。</p>

<p>Node 对象的属性是 NamedNodeMap 对象的实例。</p>
</div>
...
<p>所有主流浏览器都支持 length 属性。</p>

<p class="note"><span>注释：</span>在 Internet Explorer 8 以及更早的版本中，属性的 length 属性将返回元素所有可能属性数量。</p>
</div>
