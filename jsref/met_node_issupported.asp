...
<title>HTML DOM Node isSupported() 方法</title>
...
<h1>HTML DOM Node isSupported() 方法</h1>
...
<p>检测 buttom 元素是否支持特性 Core，版本 2.0：</p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_issupported">亲自试一试</a></p>
</div>
...
<p>isSupported() 方法检测指定节点是否支持指定特性。</p>
</div>
...
<pre>node.isSupported(<i>feature</i>,<i>version</i>)</pre>
...
<td><i>feature</i></td>
<td>String</td>
<td>必需。定义需要检查是否得到支持的特性。</td>
</tr>

<tr>
<td><i>version</i></td>
<td>String</td>
<td>可选。定义需要检查是否得到支持的特性版本。</td>
</tr>
</table>
...
<tr>
<td>Boolean</td>
<td>如果特性得到支持则返回 true，否则返回 false。</td>
</tr>
</table>
