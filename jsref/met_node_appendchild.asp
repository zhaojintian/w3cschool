...
<title>HTML DOM appendChild() 方法</title>
...
<pre>document.getElementById(&quot;myList&quot;).appendChild(newListItem);</pre>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_appendchild">亲自试一试</a></p>
</div>
...
<p>appendChild() 方法向节点添加最后一个子节点。</p>

<p class="tip"><span>提示：</span>如果您需要创建包含文本的新段落，请记得添加到段落的文本的文本节点，然后向文档添加该段落。</p>

<p>您也可以使用 appendChild() 方法从一个元素向另一个元素中移动元素。</p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_appendchild2">亲自试一试</a></p>
</div>
...
<pre>node.appendChild(<i>node</i>)</pre>
