...
<title>HTML DOM hasChildNodes() 方法</title>
...
<h1>HTML DOM hasChildNodes() 方法</h1>
...
<pre>document.getElementById(&quot;myList&quot;).hasChildNodes()</pre>

<p>结果：</p>

<pre>true</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_haschildnodes">亲自试一试</a></p>
</div>
...
<p>hasChildNodes() 方法返回 true，如果指定节点拥有子节点，否则返回 false。</p>
</div>
...
<p>所有主流浏览器都支持 hasChildNodes() 方法。</p>
</div>
...
<tr>
<td>Boolean</td>
<td>如果节点拥有子节点，则返回布尔 true，否则返回 false。</td>
</tr>
</table>
...
<table class="dataintable">
<tr>
<td style="width:25%;">DOM Version</td>
