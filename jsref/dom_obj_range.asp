...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_range_get">亲自试一试</a></p>

<p class="tip"><span>提示：</span>您也可以通过遍历表单的 <a href="coll_form_elements.asp" title="HTML DOM elements 集合">elements 集合</a>来访问 Input Range 对象。</p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_range_create">亲自试一试</a></p>
</div>
...
<p>Input Range 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
