...
<title>HTML DOM isDefaultNamespace() 方法</title>
...
<h1>HTML DOM isDefaultNamespace() 方法</h1>
...
<p>检查被定义的命名空间是否是默认命名空间：</p>

<pre>document.documentElement.isDefaultNamespace('http://www.w3.org/1999/xhtml');</pre>

<p>结果：</p>

<pre>true</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_isdefaultnamespace">亲自试一试</a></p>
</div>
...
<p>isDefaultNamespace() 方法返回 true，如果指定的命名空间是默认的，否则返回 false。</p>
</div>
...
<p>所有主流浏览器均支持 isDefaultNamespace() 方法。</p>
...
<pre>node.isDefaultNamespace(<i>namespaceURI</i>)</pre>
...
<tr>
<td>Boolean</td>
<td>如果命名空间为默认，则返回 true，否则返回 false。</td>
</tr>
</table>
