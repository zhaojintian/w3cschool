...
<title>HTML DOM childNodes 属性</title>
...
<p>获得 body 元素的子节点集合：</p>

<pre>document.body.childNodes;</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_childnodes">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>您可以使用 length 属性来确定子节点的数量，然后您就能够遍历所有的子节点并提取您需要的信息。</p>
</div>
