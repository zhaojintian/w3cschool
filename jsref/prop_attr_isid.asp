...
<p>查明属性是否是元素的 ID 属性：</p>

<pre>document.getElementById(&quot;demo&quot;).attributes[0].<code>isId</code>;</pre>

<p>结果：</p>

<pre>true</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_attr_isid">亲自试一试</a></p>
</div>
...
<p>isId 属性返回 true，如果属性是 ID 类型，返回返回 false。</p>
</div>
...
<p>所有主流浏览器都支持 isId 属性，除了 Internet Explorer 和 Opera。</p>
</div>
