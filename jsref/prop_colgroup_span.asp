...
<title>ColumnGroup span 属性</title>
...
<h1>ColumnGroup span 属性</h1>

<div class="backtoreference">
<p><a href="dom_obj_col.asp">HTML DOM Column 对象</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_colgroup_span2">亲自试一试</a></p>
</div>
...
<p>span 属性设置或返回列组的 span 属性的值。</p>

<p>span 属性 &lt;colgroup&gt; 元素应该横跨的列数。</p>
</div>
...
<pre>columngroupObject.span</pre>

<p>设置 formMethod 属性：</p>

<pre>columngroupObject.span=<i>number</i></pre>
...
<tr>
<td><i>number</i></td>
<td>规定 &lt;colgroup&gt; 元素应该横跨的列数。不允许负值。</td>
</tr>
</table>
...
<p>返回 &lt;colgroup&gt; 元素应该横跨的列数：</p>

<pre>var x = document.getElementById(&quot;myColgroup&quot;).span;</pre>

<p>x 的结果：</p>

<p>2</p>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_colgroup_span">亲自试一试</a></p>
</div>
...
<p>HTML 参考手册：<a href="../tags/att_col_span.asp">HTML &lt;col&gt; span 属性</a></p>
</div>
