...
<p>accessKey 属性设置或返回元素的快捷键。</p>

<p>快捷键规定激活元素或使元素获得焦点的快捷键。</p>

<p class="note"><span>注释：</span>在不同的浏览器中访问快捷键的方式各有不同：</p>
...
<td>[Alt] + <i>accesskey</i></td>
<td>[Alt] + <i>accesskey</i></td>
<td>[Control] [Alt] + <i>accesskey</i></td>
</tr>

<tr>
<td>Firefox</td>
<td>[Alt] [Shift] + <i>accesskey</i></td>
<td>[Alt] [Shift] + <i>accesskey</i></td>
<td>[Control] [Alt] + <i>accesskey</i></td>
</tr>
...
<td>Opera</td>
<td colspan="3">
<p>Opera 15 或更新的版本：[Alt] + <i>accesskey</i></p>
<p>Opera 12.1 或更老的版本：[Shift] [Esc] + <i>accesskey</i></p>
</td>
</tr>
</table>

<p>不过在大多数浏览器中，可以将快捷键设置为其他组合。</p>

<p class="tip"><span>提示：</span>如果超过一个元素拥有相同的快捷键，那么：</p>

<ul>
<li>IE, Firefox: 激活下一个被按下快捷键的元素</li>
<li>Chrome, Safari: 激活最后一个被按下快捷键的元素</li>
<li>Opera: 激活第一个被按下快捷键的元素</li>
</ul>

<h3>语法</h3>

<pre>HTMLElementObject.accessKey=<i>accessKey</i></pre>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_anchor_accesskey">亲自试一试</a></p>
</div>
