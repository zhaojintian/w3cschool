...
<title>HTML DOM textContent 属性</title>
...
<p>获得第一个 button 元素的文本内容：</p>

<pre>document.getElementsByTagName(&quot;BUTTON&quot;)[0].textContent;</pre>

<p>结果：</p>

<pre>Try it yourself</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_textcontent">亲自试一试</a></p>
</div>
...
<p>textContent 属性设置或返回指定节点的文本内容，以及它的所有后代。</p>

<p>如果您设置了 textContent 属性，会删除所有子节点，并被替换为包含指定字符串的一个单独的文本节点。</p>

<p class="tip"><span>提示：</span>有时，此属性可用于取代 nodeValue 属性，但是请记住此属性同时会返回所有子节点的文本。</p>

<h3>实例</h3>

<p>获得列表的所有文本内容：</p>

<pre>document.getElementById(&quot;myList).textContent;</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_textcontent2">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器均支持 textContent 属性。</p>

<p class="note"><span>注释：</span>Internet Explorer 8 以及更早的版本不支持此属性。</p>
</div>
...
<pre>node.textContent=<i>text</i></pre>
