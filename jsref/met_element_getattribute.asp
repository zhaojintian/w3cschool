...
<title>HTML DOM getAttribute() 方法</title>
...
<h1>HTML DOM getAttribute() 方法</h1>
...
<pre>document.getElementsByTagName(&quot;a&quot;)[0].getAttribute(&quot;target&quot;);</pre>

<p>结果：</p>

<pre>_blank</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_element_getattribute">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>如果您希望以 Attr 对象返回属性，请使用 getAttributeNode。</p>
</div>
...
<p>所有主流浏览器均支持 getAttribute() 方法。</p>
</div>
...
<pre>element.getAttribute(<i>attributename</i>)</pre>
