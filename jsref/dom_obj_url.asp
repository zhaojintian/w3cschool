...
<title>HTML DOM Input URL 对象</title>
...
<li class="currentLink"><a href="dom_obj_url.asp" title="HTML DOM Input URL 对象">&lt;input&gt; url</a></li>
...
<h1>HTML DOM Input URL 对象</h1>


<div>
<h2>Input URL 对象</h2>

<p>Input URL 对象是 HTML5 中的新对象。</p>

<p>Input URL 对象表示 HTML &lt;input type=&quot;url&quot;&gt; 元素。</p>

<p class="note"><span>注释：</span>Internet Explorer 9（以及更早的版本）或 Safari 不支持 &lt;input type=&quot;search&quot;&gt; 元素。</p>

<h3>访问 Input URL 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;input type=&quot;url&quot;&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myUrl&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_url_get">亲自试一试</a></p>

<h3>创建 Input URL 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;input type=&quot;url&quot;&gt; 元素：</p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=jsref_url_create">亲自试一试</a></p>
</div>


<div>
<h2>Input URL 对象属性</h2>
...
<tr>
<td>multiple</td>
<td>设置或返回是否允许用户在 URL 字段中输入不止一条 url 地址。</td>
</tr>
...
<p>Input URL 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
