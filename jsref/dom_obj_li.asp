...
<li class="currentLink"><a href="dom_obj_li.asp" title="HTML DOM Li 对象">&lt;li&gt;</a></li>
...
<h1>HTML DOM Li 对象</h1>


<div>
<h2>Li 对象</h2>

<p>Li 对象表示 HTML &lt;li&gt; 元素。</p>

<h3>访问 Li 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;li&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myLi&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_li_get">亲自试一试</a></p>

<h3>创建 Li 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;li&gt; 元素：</p>

<pre>var x = document.createElement(&quot;LI&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_li_create">亲自试一试</a></p>
</div>
...
<tr>
<td>value</td>
<td>设置或返回列表项的 value 属性值。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>Li 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 参考手册：<a href="../tags/tag_li.asp">HTML &lt;li&gt; 标签</a></p>
</div>
