...
<title>HTML DOM MenuItem 对象</title>
...
<li class="currentLink"><a href="dom_obj_menuitem.asp" title="HTML DOM MenuItem 对象">&lt;menuitem&gt;</a></li>
...
<h1>HTML DOM MenuItem 对象</h1>


<div>
<h2>MenuItem 对象</h2>

<p>MenuItem 对象表示 HTML &lt;menuitem&gt; 元素。</p>

<p class="note"><span>注释：</span>只有 Firefox 支持 &lt;menuitem&gt; 元素。</p>

<h3>访问 MenuItem 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;menuitem&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myMenuItem&quot;);</pre>

<h3>创建 MenuItem 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;menuitem&gt; 元素：</p>

<pre>var x = document.createElement(&quot;MENUITEM&quot;);</pre>
</div>
...
<tr>
<td>command</td>
<td>设置或返回菜单项的 command 属性值。</td>
</tr>

<tr>
<td>default</td>
<td>设置或返回菜单项是否是默认命令。</td>
</tr>
...
<tr>
<td>label</td>
<td>设置或返回菜单项的 label 属性值。</td>
</tr>

<tr>
<td>radiogroup</td>
<td>设置或返回菜单项的 radiogroup 属性值。</td>
</tr>

<tr>
<td>type</td>
<td>设置或返回菜单项的 type 属性值。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>MenuItem 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 参考手册：<a href="../tags/tag_menuitem.asp">HTML &lt;menuitem&gt; 标签</a></p>
</div>
