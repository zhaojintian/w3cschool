...
<li class="currentLink"><a href="dom_obj_menu.asp" title="HTML DOM Menu 对象">&lt;menu&gt;</a></li>
...
<h1>HTML DOM Menu 对象</h1>


<div>
<h2>Menu 对象</h2>

<p>Menu 对象表示 HTML &lt;menu&gt; 元素。</p>

<p class="note"><span>注释：</span>任何主流浏览器都不支持 &lt;menu&gt; 元素。</p>

<h3>访问 Menu 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;menu&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myEmbed&quot;);</pre>

<h3>创建 Menu 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;menu&gt; 元素：</p>
...
<tr>
<td>label</td>
<td>设置或返回菜单的 label 属性的值。</td>
</tr>

<tr>
<td>type</td>
<td>设置或返回菜单的 type 属性的值。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>Menu 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 参考手册：<a href="../tags/tag_menu.asp">HTML &lt;menu&gt; 标签</a></p>
</div>
