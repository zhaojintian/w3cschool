...
<li class="currentLink"><a href="dom_obj_embed.asp" title="HTML DOM Embed 对象">&lt;embed&gt;</a></li>
...
<h1>HTML DOM Embed 对象</h1>


<div>
<h2>Embed 对象</h2>

<p>Embed 对象是 HTML5 中的新对象。</p>

<p>Embed 对象表示 HTML &lt;embed&gt; 元素。</p>

<h3>访问 Embed 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;embed&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myEmbed&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_embed_get">亲自试一试</a></p>

<h3>创建 Embed 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;embed&gt; 元素：</p>

<pre>var x = document.createElement(&quot;EMBED&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_embed_create">亲自试一试</a></p>
</div>
...
<tr>
<td>height</td>
<td>设置或返回 embed 元素中 height 属性的值。</td>
</tr>

<tr>
<td>src</td>
<td>设置或返回 embed 元素中 src 属性的值。</td>
</tr>

<tr>
<td>type</td>
<td>设置或返回 embed 元素中 type 属性的值。</td>
</tr>

<tr>
<td>width</td>
<td>设置或返回 embed 元素中 width 属性的值。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>Embed 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 教程：<a href="../html/html_object.asp">HTML 插件</a></p>

<p>HTML 参考手册：<a href="../tags/tag_embed.asp">HTML &lt;embed&gt; 标签</a></p>
</div>
