...
<li class="currentLink"><a href="dom_obj_map.asp" title="HTML DOM Map 对象">&lt;map&gt;</a></li>
...
<h1>HTML DOM Map 对象</h1>


<div>
<h2>Map 对象</h2>

<p>Map 对象表示 HTML &lt;map&gt; 元素。</p>

<h3>访问 Map 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;map&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myMap&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_map_get">亲自试一试</a></p>

<h3>创建 Map 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;map&gt; 元素：</p>

<pre>var x = document.createElement(&quot;MAP&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_map_create">亲自试一试</a></p>
</div>
...
<tr>
<td>areas</td>
<td>返回 image-map 中所有 &lt;area&gt; 元素的集合。</td>
</tr>

<tr>
<td>images</td>
<td>返回与 image-map 相关联的所有 &lt;img&gt; 和 &lt;object&gt; 元素的集合。</td>
</tr>
</table>
</div>
...
<tr>
<td>name</td>
<td>设置或返回 image-map 的 name 属性值。</td>
</tr>
</table>
</div>
...
<p>Map 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 参考手册：<a href="../tags/tag_map.asp">HTML &lt;map&gt; 标签</a></p>

<p>HTML 参考手册：<a href="../tags/tag_area.asp">HTML &lt;area&gt; 标签</a></p>
</div>
