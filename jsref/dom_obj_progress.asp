...
<li class="currentLink"><a href="dom_obj_progress.asp" title="HTML DOM Progress 对象">&lt;progress&gt;</a></li>
...
<h1>HTML DOM Progress 对象</h1>


<div>
<h2>Progress 对象</h2>

<p>Progress 对象是 HTML5 中的新对象。</p>

<p>Progress 对象表示 HTML &lt;progress&gt; 元素。</p>

<p>&lt;progress&gt; 元素表示任务的进度。</p>

<h3>访问 Progress 对象</h3>

<p>您可以通过使用 getElementById() 来访问 &lt;progress&gt; 元素：</p>

<pre>var x = document.getElementById(&quot;myProgress&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_progress_get">亲自试一试</a></p>

<h3>创建 Progress 对象</h3>

<p>您可以通过使用 document.createElement() 方法来创建 &lt;progress&gt; 元素：</p>

<pre>var x = document.createElement(&quot;PROGRESS&quot;);</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_progress_create">亲自试一试</a></p>
</div>
...
<tr>
<td>value</td>
<td>设置或返回进度条的 value 属性值。</td>
</tr>
</table>

<h3>标准属性和事件</h3>

<p>Progress 对象支持标准<a href="dom_obj_all.asp" title="HTML DOM Element 对象">属性</a>和<a href="dom_obj_event.asp" title="HTML DOM Event 对象">事件</a>。</p>
</div>
...
<p>HTML 参考手册：<a href="../tags/tag_progress.asp">HTML &lt;progress&gt; 标签</a></p>
</div>
