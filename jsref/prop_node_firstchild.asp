...
<title>HTML DOM firstChild 属性</title>
...
<pre>document.firstChild;</pre>

<p class="tiy"><a  href="../tiy/t.asp@f=jsref_node_firstchild">亲自试一试</a></p>
</div>
...
<p class="note"><span>注释：</span>在 HTML 中，文本本身是 HTML 元素的父节点，HEAD 和 BODY 是 HTML 元素的子节点。</p>
</div>
