...
<li class="currentLink"><a href="dom_event.asp" title="XML DOM Event 对象">DOM Event</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_element.asp" title="XML DOM Element 对象">DOM Element</a></li>
<li class="next"><a href="dom_htmlcollection.asp" title="XML DOM HTMLCollection 对象">DOM HTMLCollection</a></li>
</ul>
</div>
