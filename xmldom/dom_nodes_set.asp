...
<li class="currentLink"><a href="dom_nodes_set.asp" title="XML DOM 改变节点值">DOM 改变节点</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_nodes_get.asp" title="XML DOM 获取节点值">DOM 获取节点</a></li>
<li class="next"><a href="dom_nodes_remove.asp" title="XML DOM 删除节点">DOM 删除节点</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_nodevalue_change">TIY</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_setattribute_1">TIY</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_att_nodevalue">TIY</a></p>
</div>
