...
<h2>节点操作</h2>
<ul>
<li class="currentLink"><a href="dom_nodes_get.asp" title="XML DOM 获取节点值">DOM 获取节点</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_nodes_navigate.asp" title="XML DOM 定位节点">DOM 定位节点</a></li>
<li class="next"><a href="dom_nodes_set.asp" title="XML DOM 改变节点值">DOM 改变节点</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_getelementsbytagname">TIY</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_getattribute">TIY</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_getattributenode">TIY</a></p>
