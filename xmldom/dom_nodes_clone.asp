...
<li class="currentLink"><a href="dom_nodes_clone.asp" title="XML DOM 克隆节点">DOM 克隆节点</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_nodes_add.asp" title="XML DOM 添加节点">DOM 添加节点</a></li>
<li class="next"><a href="dom_httprequest.asp" title="XMLHttpRequest 对象">DOM HttpRequest</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_clonenode">TIY</a></p>
</div>
