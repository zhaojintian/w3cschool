...
<li class="currentLink"><a href="dom_cssstylesheet.asp" title="XML DOM CSSStyleSheet 对象">DOM CSSStyleSheet</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_cssstylerule.asp" title="XML DOM CSSStyleRule 对象">DOM CSSStyleRule</a></li>
<li class="next"><a href="dom_comment.asp" title="XML DOM Comment 对象">DOM Comment</a></li>
</ul>
</div>
