...
<li class="currentLink"><a href="dom_parser.asp" title="解析 XML DOM">DOM 解析</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_nodetree.asp" title="XML DOM 节点树">DOM 节点树</a></li>
<li class="next"><a href="dom_loadxmldoc.asp" title="XML DOM 加载函数">DOM 加载</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_parser">TIY</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_parser2">TIY</a></p>
