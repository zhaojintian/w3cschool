...
<li class="currentLink"><a href="dom_methods.asp" title="XML DOM - 属性和方法">DOM 属性和方法</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_loadxmldoc.asp" title="XML DOM 加载函数">DOM 加载</a></li>
<li class="next"><a href="dom_nodes_access.asp" title="XML DOM 访问节点">DOM 访问节点</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_parsertest">TIY</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_parsertest2">TIY</a></p>
</div>
