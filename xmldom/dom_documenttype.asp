...
<li class="currentLink"><a href="dom_documenttype.asp" title="XML DOM DocumentType 对象">DOM DocumentType</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_document.asp" title="XML DOM Document 对象">DOM Document</a></li>
<li class="next"><a href="dom_domexception.asp" title="XML DOM DOMException 对象">DOM DOMException</a></li>
</ul>
</div>
