...
<li class="currentLink"><a href="dom_htmlcollection.asp" title="XML DOM HTMLCollection 对象">DOM HTMLCollection</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_event.asp" title="XML DOM Event 对象">DOM Event</a></li>
<li class="next"><a href="dom_htmldocument.asp" title="XML DOM HTMLDocument 对象">DOM HTMLDocument</a></li>
</ul>
</div>
...
<p>参考手册：<a href="../jsref/index.asp" title="JavaScript 和 HTML DOM 参考手册">HTML DOM 参考手册</a></p>
</div>
