...
<h2>XML DOM 参考手册</h2>
<ul>
<li class="currentLink"><a href="xmldom_reference.asp" title="XML DOM 参考手册">DOM 手册目录</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_httprequest.asp" title="XMLHttpRequest 对象">DOM HttpRequest</a></li>
<li class="next"><a href="dom_nodetype.asp" title="XML DOM 节点类型（Node Types）">DOM 节点类型</a></li>
</ul>
</div>
