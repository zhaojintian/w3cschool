...
<li class="currentLink"><a href="dom_domparser.asp" title="XML DOM DOMParser 对象">DOM DOMParser</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_domimplementation.asp" title="XML DOM Implementation 对象">DOM Implementation</a></li>
<li class="next"><a href="dom_element.asp" title="XML DOM Element 对象">DOM Element</a></li>
</ul>
</div>
