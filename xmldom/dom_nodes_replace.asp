...
<li class="currentLink"><a href="dom_nodes_replace.asp" title="XML DOM 替换节点">DOM 替换节点</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_nodes_remove.asp" title="XML DOM 删除节点">DOM 删除节点</a></li>
<li class="next"><a href="dom_nodes_create.asp" title="XML DOM 创建节点">DOM 创建节点</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_replacechild">TIY</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_replacedata">TIY</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_replacedata_2">TIY</a></p>
