...
<li class="currentLink"><a href="dom_comment.asp" title="XML DOM Comment 对象">DOM Comment</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_cssstylesheet.asp" title="XML DOM CSSStyleSheet 对象">DOM CSSStyleSheet</a></li>
<li class="next"><a href="dom_document.asp" title="XML DOM Document 对象">DOM Document</a></li>
</ul>
</div>
