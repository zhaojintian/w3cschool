...
<li class="currentLink"><a href="dom_nodes_navigate.asp" title="XML DOM 定位节点">DOM 定位节点</a></li>
</ul>
<h2>节点操作</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_mozilla_vs_ie.asp" title="XML DOM 浏览器差异">DOM 浏览器</a></li>
<li class="next"><a href="dom_nodes_get.asp" title="XML DOM 获取节点值">DOM 获取节点</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_nav_parentnode">TIY</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_nav_firstchild">TIY</a></p>
</div>
