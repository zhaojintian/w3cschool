...
<li class="currentLink"><a href="dom_namednodemap.asp" title="XML DOM NamedNodeMap 对象">DOM NamedNodeMap</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_htmlelement.asp" title="XML DOM HTMLElement 对象">DOM HTMLElement</a></li>
<li class="next"><a href="dom_node.asp" title="XML DOM Node 对象">DOM Node</a></li>
</ul>
</div>
