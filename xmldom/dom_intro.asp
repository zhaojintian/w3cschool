...
<li class="currentLink"><a href="dom_intro.asp" title="XML DOM 简介">DOM 简介</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="index.asp" title="XML DOM 教程">DOM 首页</a></li>
<li class="next"><a href="dom_nodes.asp" title="XML DOM 节点">DOM 节点</a></li>
</ul>
</div>
