...
<li class="currentLink"><a href="dom_nodelist.asp" title="XML DOM NodeList 对象">DOM NodeList</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_node.asp" title="XML DOM Node 对象">DOM Node</a></li>
<li class="next"><a href="dom_errors.asp" title="XML DOM ParseError 对象">DOM ParseError</a></li>
</ul>
</div>
