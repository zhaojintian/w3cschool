...
<li class="currentLink"><a href="dom_nodes_traverse.asp" title="XML DOM 遍历节点">DOM 遍历节点</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_nodes_nodelist.asp" title="XML DOM 节点列表">DOM 节点列表</a></li>
<li class="next"><a href="dom_mozilla_vs_ie.asp" title="XML DOM 浏览器差异">DOM 浏览器</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_parsertest3">TIY</a></p>
</div>
