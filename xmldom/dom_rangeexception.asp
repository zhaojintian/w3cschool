...
<li class="currentLink"><a href="dom_rangeexception.asp" title="XML DOM RangeException 对象">DOM RangeException</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_range.asp" title="XML DOM Range 对象">DOM Range</a></li>
<li class="next"><a href="dom_text.asp" title="XML DOM Text 对象">DOM Text</a></li>
</ul>
</div>
