...
<li class="currentLink"><a href="dom_nodes_create.asp" title="XML DOM 创建节点">DOM 创建节点</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_nodes_replace.asp" title="XML DOM 替换节点">DOM 替换节点</a></li>
<li class="next"><a href="dom_nodes_add.asp" title="XML DOM 添加节点">DOM 添加节点</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_createattribute">TIY</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_createelement_1">TIY</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_createcdatasection_1">TIY</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_createcomment_1">TIY</a></p>
