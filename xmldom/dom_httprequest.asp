...
<li class="currentLink"><a href="dom_httprequest.asp" title="XMLHttpRequest 对象">DOM HttpRequest</a></li>
</ul>
<h2>XML DOM 参考手册</h2>
<ul>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_nodes_clone.asp" title="XML DOM 克隆节点">DOM 克隆节点</a></li>
<li class="next"><a href="xmldom_reference.asp" title="XML DOM 参考手册">DOM 手册目录</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_httprequest_js">TIY</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_httprequest_js_false">TIY</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_httpsend_2">TIY</a></p>
</div>
