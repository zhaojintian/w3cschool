...
<li class="currentLink"><a href="dom_cdatasection.asp" title="XML DOM CDATASection 对象">DOM CDATASection</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_attribute.asp" title="XML DOM Attr 对象">DOM Attr</a></li>
<li class="next"><a href="dom_characterdata.asp" title="XML DOM CharacterData 对象">DOM CharacterData</a></li>
</ul>
</div>
