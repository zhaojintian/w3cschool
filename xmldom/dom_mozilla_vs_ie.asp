...
<li class="currentLink"><a href="dom_mozilla_vs_ie.asp" title="XML DOM 浏览器差异">DOM 浏览器</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_nodes_traverse.asp" title="XML DOM 遍历节点">DOM 遍历节点</a></li>
<li class="next"><a href="dom_nodes_navigate.asp" title="XML DOM 定位节点">DOM 定位节点</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_nodetype_ievsmozilla">TIY</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_nodetype_ievsmozilla2">TIY（简单）</a> 或者 <a  href="../tiy/t.asp@f=xdom_nodetype_ievsmozilla3">TIY（完整）</a></p>
</div>
