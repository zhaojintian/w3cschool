...
<li class="currentLink"><a href="dom_range.asp" title="XML DOM Range 对象">DOM Range</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_processinginstruction.asp" title="XML DOM ProcessingInstr 对象">DOM ProcessingInstr</a></li>
<li class="next"><a href="dom_rangeexception.asp" title="XML DOM RangeException 对象">DOM RangeException</a></li>
</ul>
</div>
