...
<li class="currentLink"><a href="dom_htmlelement.asp" title="XML DOM HTMLElement 对象">DOM HTMLElement</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_htmldocument.asp" title="XML DOM HTMLDocument 对象">DOM HTMLDocument</a></li>
<li class="next"><a href="dom_namednodemap.asp" title="XML DOM NamedNodeMap 对象">DOM NamedNodeMap</a></li>
</ul>
</div>
...
<p>HTMLElement 对象继承了 <a href="dom_node.asp" title="XML DOM Node 对象">Node</a> 和 <a href="dom_element.asp" title="XML DOM Element 对象">Element</a> 对象的标准方法。某些类型的元素实现了特定于标记的方法，W3School 在 <a href="../jsref/index.asp" title="HTML DOM 参考手册">HTML DOM 参考手册</a>的各标记参考页中提供了这些方法的信息。</p>
