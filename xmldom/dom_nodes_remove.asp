...
<li class="currentLink"><a href="dom_nodes_remove.asp" title="XML DOM 删除节点">DOM 删除节点</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_nodes_set.asp" title="XML DOM 改变节点值">DOM 改变节点</a></li>
<li class="next"><a href="dom_nodes_replace.asp" title="XML DOM 替换节点">DOM 替换节点</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_removechild">TIY</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_removecurrent">TIY</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_removetextnode">TIY</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_remove_nodevalue">TIY</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_removeattribute">TIY</a></p>
...
<p class="tiy"><a  href="../tiy/t.asp@f=xdom_removeattributenode">TIY</a></p>
</div>
