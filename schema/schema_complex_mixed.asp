...
<li class="currentLink"><a href="schema_complex_mixed.asp" title="XSD 带有混合内容的复合类型">XSD 混合内容</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="schema_complex_text.asp" title="XSD 仅含文本复合元素">XSD 仅含文本</a></li>
<li class="next"><a href="schema_complex_indicators.asp" title="XSD 复合类型指示器">XSD 指示器</a></li>
</ul>
</div>
