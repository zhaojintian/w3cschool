...
<li class="currentLink"><a href="schema_complex_elements.asp" title="XSD 复合类型 - 仅含元素">XSD 仅含元素</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="schema_complex_empty.asp" title="XSD 复合空元素">XSD 空元素</a></li>
<li class="next"><a href="schema_complex_text.asp" title="XSD 仅含文本复合元素">XSD 仅含文本</a></li>
</ul>
</div>
