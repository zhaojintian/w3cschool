...
<li class="currentLink"><a href="schema_dtypes_misc.asp" title="XSD 杂项数据类型">XSD 杂项</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="schema_dtypes_numeric.asp" title="XSD 数值数据类型">XSD 数值</a></li>
<li class="next"><a href="schema_summary.asp" title="您已经学习了 XML Schema，下一步学习什么呢？">XSD 总结</a></li>
</ul>
</div>
