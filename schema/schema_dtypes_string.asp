...
<h2>数据类型</h2>
<ul>
<li class="currentLink"><a href="schema_dtypes_string.asp" title="XSD 字符串数据类型">XSD 字符串</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="schema_example.asp" title="一个 XSD 实例">XSD 实例</a></li>
<li class="next"><a href="schema_dtypes_date.asp" title="XSD 日期及时间数据类型">XSD 日期</a></li>
</ul>
</div>
