...
<li class="currentLink"><a href="schema_example.asp" title="一个 XSD 实例">XSD 实例</a></li>
</ul>
<h2>数据类型</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="schema_complex_subst.asp" title="XSD 元素替换（Element Substitution）">XSD 元素替换</a></li>
<li class="next"><a href="schema_dtypes_string.asp" title="XSD 字符串数据类型">XSD 字符串</a></li>
</ul>
</div>
