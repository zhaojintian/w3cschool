...
<li class="currentLink"><a href="schema_schema.asp" title="XSD - &lt;schema&gt; 元素">XSD &lt;schema&gt;</a></li>
</ul>
<h2>简单的类型</h2>
<ul>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="schema_howto.asp" title="如何使用 XSD？">XSD 如何使用</a></li>
<li class="next"><a href="schema_simple.asp" title="XSD 简易元素">XSD 元素</a></li>
</ul>
</div>
