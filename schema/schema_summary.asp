...
<li class="currentLink"><a href="schema_summary.asp" title="您已经学习了 XML Schema，下一步学习什么呢？">XSD 总结</a></li>
</ul>
<h2>参考手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="schema_dtypes_misc.asp" title="XSD 杂项数据类型">XSD 杂项</a></li>
<li class="next"><a href="schema_elements_ref.asp" title="XSD 参考手册">XSD 参考手册</a></li>
</ul>
</div>
