...
<li class="currentLink"><a href="schema_facets.asp" title="XSD 限定/Facets">XSD 限定</a></li>
</ul>
<h2>复杂的类型</h2>
<ul>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="schema_simple_attributes.asp" title="XSD 属性">XSD 属性</a></li>
<li class="next"><a href="schema_complex.asp" title="XSD 复合元素">XSD 元素</a></li>
</ul>
</div>
