...
<li class="currentLink"><a href="schema_intro.asp" title="XSD 简介">XSD 简介</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="index.asp" title="XSD 教程">XSD 教程</a></li>
<li class="next"><a href="schema_why.asp" title="为什么要使用 XML Schemas？">XSD 为何使用</a></li>
</ul>
</div>
