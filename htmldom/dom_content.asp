...
<HTML lang=zh-cn><HEAD><TITLE>HTML DOM - 修改 HTML 内容</TITLE>
<META charset=gb2312>
...
<UL>
  ...
  <LI class=currentLink><A title="HTML DOM 内容" href="dom_content.asp">DOM 内容</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="HTML DOM 修改" href="dom_modify.asp">DOM 修改</A> </LI>
  <LI class=next><A title="HTML DOM 元素" href="dom_elements.asp">DOM 元素</A> 
</LI></UL></DIV>
<DIV id=intro>
<P>通过 HTML DOM，JavaScript 能够访问 HTML 文档中的每个元素。</P></DIV>
<DIV>
<H2>改变 HTML 内容</H2>
...
<P class=tiy><A href="../tiy/t.asp@f=dom_changetext">亲自试一试</A></P></DIV>
<DIV>
<H2>改变 HTML 样式</H2>
...
<P class=tiy><A href="../tiy/t.asp@f=dom_changebackground">亲自试一试</A></P>
<P>在本例中，由函数执行相同的代码：</P>
<H3>实例</H3><PRE>&lt;html&gt;
&lt;body&gt;
...
<P class=tiy><A href="../tiy/t.asp@f=dom_changebackground2">亲自试一试</A></P>
...
<P class=tiy><A href="../tiy/t.asp@f=dom_changetext2">亲自试一试</A></P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="HTML DOM 修改" href="dom_modify.asp">DOM 修改</A> </LI>
  <LI class=next><A title="HTML DOM 元素" href="dom_elements.asp">DOM 元素</A> 
