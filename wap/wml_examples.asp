...
<li class="currentLink"><a href="wml_examples.asp" title="WML 实例">WML 实例</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="wml_variables.asp" title="WML 变量">WML 变量</a></li>
<li class="next"><a href="wap_demo.asp" title="WAP 演示">WAP 演示</a></li>
</ul>
</div>
