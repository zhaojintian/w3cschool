...
<li class="currentLink"><a href="wml_dtd.asp" title="WML DTD">WML DTD</a></li>
</ul>
<h2>参考手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="wml_entities.asp" title="WML 实体">WML 实体</a></li>
<li class="next"><a href="wap_forum.asp" title="WAP 论坛 / 开放移动联盟">WAP 论坛/OMA</a></li>
</ul>
</div>
