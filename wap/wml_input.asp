...
<li class="currentLink"><a href="wml_input.asp" title="WML 输入">WML 输入</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="wml_links.asp" title="WML 链接和图像">WML 连接</a></li>
<li class="next"><a href="wml_tasks.asp" title="WML 任务">WML 任务</a></li>
</ul>
</div>
