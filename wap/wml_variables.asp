...
<li class="currentLink"><a href="wml_variables.asp" title="WML 变量">WML 变量</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="wml_timer.asp" title="WML 计时器">WML 计时器</a></li>
<li class="next"><a href="wml_examples.asp" title="WML 实例">WML 实例</a></li>
</ul>
</div>
