...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>DTD 验证</TITLE>
...
<UL>
  ...
  <LI class=currentLink><A title="DTD - 验证" href="dtd_validation.asp">DTD 验证</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="DTD - 实体" href="dtd_entities.asp">DTD 实体</A> </LI>
  <LI class=next><A title="DTD - 来自网络的实例" href="dtd_examples.asp">DTD 实例</A> 
  </LI></UL></DIV>
<DIV id=intro>
<P><STRONG>Internet Explorer 5.0 可根据某个 DTD 来验证您的 XML。</STRONG></P></DIV>
<DIV>
<H2>通过 XML 解析器进行验证</H2>
<P>当您试图打开某个 XML 文档时，XML 解析器有可能会产生错误。通过访问 parseError 
对象，就可以取回引起错误的确切代码、文本甚至所在的行。</P>
<P class=note><SPAN>注释：</SPAN>load( ) 方法用于文件，而 loadXML( ) 方法用于字符串。</P><PRE>var xmlDoc = new ActiveXObject("Microsoft.XMLDOM")
xmlDoc.async="false"
...
或者 <A href="../example/dtde/note_dtd_error.xml">仅仅看一下这个 XML 文件</A>。</P></DIV>
<DIV>
<H2>关闭验证</H2>
<P>通过把 XML 解析器的 validateOnParse 设置为 "false"，就可以关闭验证。</P><PRE>var xmlDoc = new ActiveXObject("Microsoft.XMLDOM")
xmlDoc.async="false"
...
<DIV>
<H2>通用的 XML 验证器</H2>
<P>为了帮助您验证 XML 文件，我们创建了此链接，这样你就可以验证任何 XML 文件了。</P></DIV>
<DIV>
<H2>parseError 对象</H2>
<P>您可以在我们的《<A title="XML DOM 教程" href="../xmldom/index.asp">XML DOM 
教程</A>》中阅读更多有关 parseError 对象的信息。</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="DTD - 实体" href="dtd_entities.asp">DTD 实体</A> </LI>
  <LI class=next><A title="DTD - 来自网络的实例" href="dtd_examples.asp">DTD 实例</A> 
