...
<li class="currentLink"><a href="xpointer_example.asp" title="XPointer 实例">XPointer 实例</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xlink_example.asp" title="XLink 实例">XLink 实例</a></li>
<li class="next"><a href="xlink_summary.asp" title="您已经学习了 XLink，下一步呢？">XLink 总结</a></li>
</ul>
</div>
