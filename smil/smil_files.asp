...
<ul>
<li><a href="index.asp" title="SMIL 教程">SMIL 教程</a></li>
<li><a href="smil_intro.asp" title="SMIL 简介">SMIL 简介</a></li>
<li class="currentLink"><a href="smil_files.asp" title="SMIL 文件">SMIL 文件</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="smil_intro.asp" title="SMIL 简介">SMIL 简介</a></li>
...
<ul>
<li><a href="../../www.realnetworks.com/default.htm" title="RealNetworks_com">RealNetworks</a> 的 <em>RealOne 平台</em>提供了对 SMIL 2.0 的充分支持</li>
<li><a href="../../www.oratrix.com/default.htm" title="GRiNS for SMIL Homepage - Oratrix Development">Oratrix</a> 的 <em>GRiNS for SMIL-2.0</em> 提供了一款 SMIL 2.0 播放器</li>
<li><a href="../../www.inobject.com/default.htm" title="InterObject - Your Source For Fast, Reliable and Cost-Effective Software">InterObject</a> 的 <em>SMIL 播放器</em>支持 SMIL 2.0 的基础框架</li>
</ul>
</div>
