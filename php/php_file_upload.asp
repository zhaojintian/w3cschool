...
<li class="currentLink"><a href="php_file_upload.asp" title="PHP 文件上传">PHP 文件上传</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_file_create.asp" title="PHP 文件上传">PHP 文件创建/写入</a></li>
<li class="next"><a href="php_cookies.asp" title="PHP Cookies">PHP Cookies</a></li>
</ul>
</div>
