...
<li class="currentLink"><a href="php_ref_libxml.asp" title="PHP LibXML 函数">PHP LibXML</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_ref_http.asp" title="PHP HTTP 函数">PHP HTTP</a></li>
<li class="next"><a href="php_ref_mail.asp" title="PHP Mail 函数">PHP Mail</a></li>
</ul>
</div>
...
<div>
<h2>安装</h2>
<p>这些函数需要 libxml 程序包。<a href="../../www.xmlsoft.org/downloads.html" title="Downloads">在 xmlsoft.org 下载</a>。</p>
</div>
