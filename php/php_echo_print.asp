...
<li class="currentLink"><a href="php_echo_print.asp" title="PHP Echo 和 Print 语句">PHP Echo / Print</a></li>
...
<h1>PHP 5 echo 和 print 语句</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_variables.asp" title="PHP 变量">PHP 变量</a></li>
<li class="next"><a href="php_datatypes.asp" title="PHP 数据类型">PHP 数据类型</a></li>
</ul>
</div>


<div id="intro">
<p><strong>在 PHP 中，有两种基本的输出方法：echo 和 print。</strong></p>

<p>在本教程中，我们几乎在每个例子中都会用到 echo 和 print。因此，本节为您讲解更多关于这两条输出语句的知识。</p>
</div>
...
<p class="tip"><span>提示：</span>echo 比 print 稍快，因为它不返回任何值。</p>
</div>
...
<p>下面的例子展示如何用 echo 命令来显示不同的字符串（同时请注意字符串中能包含 HTML 标记）：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_echo1">运行实例</a></p>

<h3>显示变量</h3>

<p>下面的例子展示如何用 echo 命令来显示字符串和变量：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_echo2">运行实例</a></p>
</div>
...
<p>print 也是语言结构，有无括号均可使用：print 或 print()。</p>


<h3>显示字符串</h3>

<p>下面的例子展示如何用 print 命令来显示不同的字符串（同时请注意字符串中能包含 HTML 标记）：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_print">运行实例</a></p>

<h3>显示变量</h3>

<p>下面的例子展示如何用 print 命令来显示字符串和变量：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_print2">运行实例</a></p>
</div>
