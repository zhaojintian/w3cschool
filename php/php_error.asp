...
<li class="currentLink"><a href="php_error.asp" title="PHP 错误处理">PHP Error</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_secure_mail.asp" title="PHP 安全的电子邮件">PHP 安全 E-mail</a></li>
<li class="next"><a href="php_exception.asp" title="PHP 异常处理">PHP Exception</a></li>
</ul>
</div>
