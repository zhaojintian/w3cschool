...
<h2>PHP 表单</h2>
<ul>
<li class="currentLink"><a href="php_forms.asp" title="PHP Date()">PHP 表单处理</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_superglobals.asp" title="PHP 超全局变量">PHP 超全局</a></li>
<li class="next"><a href="php_form_validation.asp" title="PHP Include 文件">PHP 表单验证</a></li>
</ul>
</div>

<div id="intro">
<p><strong>PHP 超全局变量 $_GET 和 $_POST 用于收集表单数据（form-data）。</strong></p>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_form_post">运行实例</a></p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_form_get">运行实例</a></p>
