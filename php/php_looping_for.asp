...
<li class="currentLink"><a href="php_looping_for.asp" title="PHP for 循环">PHP For 循环</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_looping.asp" title="PHP while 循环">PHP While 循环</a></li>
<li class="next"><a href="php_functions.asp" title="PHP 函数">PHP 函数</a></li>
</ul>
</div>


<div id="intro">
<p><strong>PHP for 循环执行代码块指定的次数。</strong></p>
</div>
...
<p>如果您已经提前确定脚本运行的次数，可以使用 for 循环。</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_loop_for">运行实例</a></p>
</div>


<div>
<h2>PHP foreach 循环</h2>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_loop_foreach">运行实例</a></p>

<p>在稍后的章节，您将学到更多有关数组的知识。</p>
</div>
