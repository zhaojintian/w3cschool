...
<ul>
<li class="currentLink"><a href="index.asp" title="PHP 教程">PHP 教程</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="index.asp" title="PHP 教程">PHP 教程</a></li>
<li class="next"><a href="php_intro.asp" title="PHP 简介">PHP 简介</a></li>
</ul>
</div>
...
<p>我们的 “运行实例” 工具降低了 PHP 的学习难度，它可以同时显示出 PHP 源代码以及代码的 HTML 输出。</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_intro">运行实例</a></p>

<p>请点击“运行实例”，看看它是如何工作。</p>
</div>
...
<p>在 W3School 测试您的 PHP 技能！</p>

<p><a href="../quiz/quiz.asp@quiz=php">开始 PHP 测验</a>！</p>
</div>
