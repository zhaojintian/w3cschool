...
<li class="currentLink"><a href="php_file.asp" title="PHP 文件处理">PHP 文件</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_includes.asp" title="PHP Include 文件">PHP Include</a></li>
<li class="next"><a href="php_file_open.asp" title="PHP 文件上传">PHP 文件打开/读取</a></li>
</ul>
</div>
...
<p class="important"><span>注意：</span>请谨慎操作文件！</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_file_readfile">运行实例</a></p>

<p>如果您想做的所有事情就是打开一个文件并读取器内容，那么 readfile() 函数很有用。</p>

<p>下一节会讲解更多有关文件处理的内容。</p>
</div>
