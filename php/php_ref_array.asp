...
<h2>PHP 参考手册</h2>
<ul>
<li class="currentLink"><a href="php_ref_array.asp" title="PHP Array 函数">PHP Array</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_ajax_poll.asp" title="PHP 和 AJAX 投票">AJAX Poll</a></li>
<li class="next"><a href="php_ref_calendar.asp" title="PHP Calendar 函数">PHP Calendar</a></li>
</ul>
</div>
