...
<li class="currentLink"><a href="php_if_else.asp" title="PHP If...Else 语句">PHP If...Else</a></li>
...
<h1>PHP if...else...elseif 语句</h1>

<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_operators.asp" title="PHP 运算符">PHP 运算符</a></li>
<li class="next"><a href="php_switch.asp" title="PHP Switch 语句">PHP Switch</a></li>
</ul>
</div>
...
<p>在您编写代码时，经常会希望为不同的决定执行不同的动作。您可以在代码中使用条件语句来实现这一点。</p>

<p>在 PHP 中，我们可以使用以下条件语句：</p>

<ul>
<li><em>if 语句</em> - 如果指定条件为真，则执行代码</li>
<li><em>if...else 语句</em> - 如果条件为 true，则执行代码；如果条件为 false，则执行另一端代码</li>
<li><em>if...elseif....else 语句</em> - 选择若干段代码块之一来执行</li>
<li><em>switch 语句</em> - 语句多个代码块之一来执行</li>
</ul>
</div>
...
<p>if 语句用于<em>在指定条件为 true 时</em>执行代码。</p>
...
<p>下例将输出 &quot;Have a good day!&quot;，如果当前时间 (HOUR) 小于 20：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_if">运行实例</a></p>
</div>
...
<p>请使用 if....else 语句<em>在条件为 true 时执行代码</em>，<em>在条件为 false 时执行另一段代码</em>。</p>
...
<p>下例将输出 &quot;Have a good day!&quot;，如果当前时间 (HOUR) 小于 20，否则输出 &quot;Have a good night!&quot;：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_if_else">运行实例</a></p>
</div>
...
<p>请使用 if....elseif...else 语句来<em>选择若干代码块之一来执行</em>。</p>
...
<p>下例将输出 &quot;Have a good morning!&quot;，如果当前时间 (HOUR) 小于 10，如果当前时间小于 20，则输出 &quot;Have a good day!&quot;。否则将输出 &quot;Have a good night!&quot;：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_if_elseif">运行实例</a></p>
</div>
