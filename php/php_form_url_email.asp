...
<title>PHP 表单验证 - 验证 E-mail 和 URL</title>
...
<li class="currentLink"><a href="php_form_url_email.asp" title="PHP 文件上传">PHP 表单 URL/E-mail</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_form_required.asp" title="PHP 文件处理">PHP 表单必填</a></li>
<li class="next"><a href="php_form_complete.asp" title="PHP Cookies">PHP 表单完成</a></li>
</ul>
</div>


<div id="intro">
<p><strong>本节展示如何验证名字、电邮和 URL。</strong></p>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_form_validation_special">运行实例</a></p>
