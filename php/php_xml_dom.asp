...
<li class="currentLink"><a href="php_xml_dom.asp" title="PHP XML DOM">XML DOM</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_xml_parser_expat.asp" title="PHP XML Expat 解析器">XML Expat Parser</a></li>
<li class="next"><a href="php_xml_simplexml.asp" title="PHP SimpleXML">XML SimpleXML</a></li>
</ul>
</div>
