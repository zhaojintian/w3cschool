...
<li class="currentLink"><a href="php_mysql_insert.asp" title="PHP MySQL Insert Into">MySQL Insert</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_mysql_create.asp" title="PHP MySQL 创建数据库和表">MySQL Create</a></li>
<li class="next"><a href="php_mysql_select.asp" title="PHP MySQL Select">MySQL Select</a></li>
</ul>
</div>
