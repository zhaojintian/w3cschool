...
<li class="currentLink"><a href="php_ref_mysql.asp" title="PHP MySQL 函数">PHP MySQL</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_ref_math.asp" title="PHP Math 函数">PHP Math</a></li>
<li class="next"><a href="php_ref_mysqli.asp" title="PHP 5 MySQLi 函数">PHP MySQLi</a></li>
</ul>
</div>
...
<h4>PHP 5+</h4>
<p>MySQL 默认未启用，也没有绑定的 MySQL 库。使用 --with-mysql[=DIR] 配置选项来加入 MySQL 的支持。可以从 <a href="../../www.mysql.com/default.htm" title="MySQL  The world's most popular open source database">MySQL</a> 下载头文件和库。</p>
