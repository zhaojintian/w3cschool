...
<li class="currentLink"><a href="php_install.asp" title="PHP 安装">PHP 安装</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_intro.asp" title="PHP 简介">PHP 简介</a></li>
<li class="next"><a href="php_syntax.asp" title="PHP 语法">PHP 语法</a></li>
</ul>
</div>
...
<ul>
<li>使用支持 PHP 和 MySQL 的 web 主机</li>
<li>在您的 PC 上安装 web 服务器，然后安装 PHP 和 MySQL。</li>
</ul>
</div>
...
<p>如果您的服务器支持 PHP，那么您无需做任何事情。</p>

<p>只要创建 .php 文件，然后上传到 web 目录中即可。服务器会自动对它们进行解析。</p>

<p>您无需编译或安装任何额外的工具。</p>

<p>因为 PHP 是免费的，大多数 web 主机都支持 PHP。</p>
</div>


<div>
<h2>在您的 PC 上运行 PHP</h2>

<p>不过如果您的服务器不支持 PHP，那么您必须：</p>
...
<p>官方的 PHP 网站 (PHP.net) 提供了 PHP 的安装说明：<a  href="../../php.net/manual/zh/install.php">http://php.net/manual/zh/install.php</a></p>
</div>
...
<p class="tip"><span>提示：</span>如需在 Windows 平台设置并立即运行 PHP，您还可以：</p>

<p><a  href="../../www.microsoft.com/web/webmatrix/default.htm">下载 WebMatrix</a></p>
</div>
