...
<h2>PHP 高级教程</h2>
<ul>
<li class="currentLink"><a href="php_arrays_multi.asp" title="PHP 多维数组">PHP 多维数组</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_form_complete.asp" title="PHP Cookies">PHP 表单完成</a></li>
<li class="next"><a href="php_date.asp" title="PHP Date()">PHP 日期</a></li>
</ul>
</div>
...
<p class="note"><span>注释：</span>数组的维度指示您需要选择元素的索引数。</p>

<ul>
<li>对于二维数组，您需要两个索引来选取元素</li>
<li>对于三维数组，您需要三个索引来选取元素</li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_array_multi">运行实例</a></p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_array_multi2">运行实例</a></p>
</div>
