...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_file_fopen">运行实例</a></p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_file_fgets">运行实例</a></p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_file_feof">运行实例</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_file_fgetc">运行实例</a></p>
