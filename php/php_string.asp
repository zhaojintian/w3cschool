...
<li class="currentLink"><a href="php_string.asp" title="PHP 字符串函数">PHP 字符串函数</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_datatypes.asp" title="PHP 数据类型">PHP 数据类型</a></li>
<li class="next"><a href="php_constants.asp" title="PHP 常量">PHP 常量</a></li>
</ul>
</div>

<div id="intro">
<p><strong>字符串是字符序列，比如 &quot;Hello world!&quot;。</strong></p>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_datatypes_length">运行实例</a></p>

<p>以上代码的输出是：12</p>

<p class="tip"><span>提示：</span>strlen() 常用于循环和其他函数，在确定字符串何时结束很重要时。（例如，在循环中，我们也许需要在字符串的最后一个字符之后停止循环）。</p>
</div>
...
<p>下例检索字符串 &quot;Hello world!&quot; 中的文本 &quot;world&quot;：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_datatypes_pos">运行实例</a></p>

<p>以上代码的输出是：6。</p>

<p class="tip"><span>提示：</span>上例中字符串 &quot;world&quot; 的位置是 6。是 6（而不是 7）的理由是，字符串中首字符的位置是 0 而不是 1。</p>
</div>
...
<p>如需完整的字符串函数参考手册，请访问我们的 <a href="php_ref_string.asp" title="PHP String 函数">PHP String 参考手册</a>。</p>
