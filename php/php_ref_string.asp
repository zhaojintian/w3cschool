...
<li class="currentLink"><a href="php_ref_string.asp" title="PHP String 函数">PHP String</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_ref_simplexml.asp" title="PHP SimpleXML 函数">PHP SimpleXML</a></li>
<li class="next"><a href="php_ref_xml.asp" title="PHP XML Parser 函数">PHP XML</a></li>
</ul>
</div>
