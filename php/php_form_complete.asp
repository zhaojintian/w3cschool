...
<li class="currentLink"><a href="php_form_complete.asp" title="PHP Cookies">PHP 表单完成</a></li>
</ul>
<h2>PHP 高级教程</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_form_url_email.asp" title="PHP 文件上传">PHP 表单 URL/E-mail</a></li>
<li class="next"><a href="php_arrays_multi.asp" title="PHP 多维数组">PHP 多维数组</a></li>
</ul>
</div>


<div id="intro">
<p><strong>本节展示如何在用户提交表单后保留输入字段中的值。</strong></p>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_form_validation_complete">运行实例</a></p>
</div>
