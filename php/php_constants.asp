...
<li class="currentLink"><a href="php_constants.asp" title="PHP 常量">PHP 常量</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_string.asp" title="PHP 字符串函数">PHP 字符串函数</a></li>
<li class="next"><a href="php_operators.asp" title="PHP 运算符">PHP 运算符</a></li>
</ul>
</div>


<div id="intro">
<p><strong>常量类似变量，但是常量一旦被定义就无法更改或撤销定义。</strong></p>
</div>
...
<p class="note"><span>注释：</span>与变量不同，常量贯穿整个脚本是自动全局的。</p>
</div>
...
<p>下例创建了一个<em>对大小写敏感的常量</em>，值为 &quot;Welcome to W3School.com.cn!&quot;：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_constant1">运行实例</a></p>

<p>下例创建了一个<em>对大小写不敏感的常量</em>，值为 &quot;Welcome to W3School.com.cn!&quot;：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_constant2">运行实例</a></p>
</div>
