...
<li class="currentLink"><a href="php_ref_ftp.asp" title="PHP FTP 函数">PHP FTP</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_ref_filter.asp" title="PHP Filter 函数">PHP Filter</a></li>
<li class="next"><a href="php_ref_http.asp" title="PHP HTTP 函数">PHP HTTP</a></li>
</ul>
</div>
