...
<HTML lang=zh-cn><HEAD><TITLE>PHP FILTER_CALLBACK 过滤器</TITLE>
<META charset=gbk>
...
<UL>
  <LI>Name: "callback" 
  <LI>ID-number: 1024 </LI></UL></DIV>
<DIV>
<H2>提示和注释</H2>
<P class=tip><SPAN>提示：</SPAN>您可以创建自己的函数，或者使用已有的 PHP 函数。</P></DIV>
<DIV>
<H2>例子</H2>
<H3>例子 1</H3><PRE>&lt;?php
...
?&gt;</PRE>
<P>输出：</P><PRE>Peter_is_a_great_guy!</PRE>
<H3>例子 2</H3><PRE>&lt;?php
$string="Peter is a great guy!";
...
?&gt;</PRE>
<P>输出：</P><PRE>PETER IS A GREAT GUY!</PRE></DIV>
<DIV class=backtoreference>
<P><A title="PHP Filter 函数" href="php_ref_filter.asp">PHP Filter 
