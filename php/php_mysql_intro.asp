...
<h2>PHP 数据库</h2>
<ul>
<li class="currentLink"><a href="php_mysql_intro.asp" title="MySQL 简介">MySQL 简介</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_filter.asp" title="PHP 过滤器（Filter）">PHP Filter</a></li>
<li class="next"><a href="php_mysql_connect.asp" title="PHP MySQL 连接数据库">MySQL Connect</a></li>
</ul>
</div>
...
<p>如果您的 PHP 服务器没有 MySQL 数据库，可以在此下载 MySQL：<a href="../../www.mysql.com/downloads/index.html" title="MySQL  MySQL Downloads">http://www.mysql.com/downloads/index.html</a></p>
</div>
...
<p>事实上，对于那些支持巨大数据和访问量的网站，MySQL 是事实上的标准数据库（比如 Friendster, Yahoo, Google）。这个地址提供了使用 MySQL 的公司的概览：<a href="../../www.mysql.com/customers/default.htm" title="MySQL  MySQL Customers by Industry">http://www.mysql.com/customers/</a>。</p>
</div>
