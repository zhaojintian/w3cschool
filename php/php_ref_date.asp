...
<li class="currentLink"><a href="php_ref_date.asp" title="PHP Date / Time 函数">PHP Date</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_ref_calendar.asp" title="PHP Calendar 函数">PHP Calendar</a></li>
<li class="next"><a href="php_ref_directory.asp" title="PHP Directory 函数">PHP Directory</a></li>
</ul>
</div>
