...
<li class="currentLink"><a href="php_mysql_update.asp" title="PHP MySQL Update">MySQL Update</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_mysql_order_by.asp" title="PHP MySQL Order By 关键词">MySQL Order By</a></li>
<li class="next"><a href="php_mysql_delete.asp" title="PHP MySQL Delete From">MySQL Delete</a></li>
</ul>
</div>
