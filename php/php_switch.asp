...
<li class="currentLink"><a href="php_switch.asp" title="PHP Switch 语句">PHP Switch</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_if_else.asp" title="PHP If...Else 语句">PHP If...Else</a></li>
<li class="next"><a href="php_looping.asp" title="PHP while 循环">PHP While 循环</a></li>
</ul>
</div>


<div id="intro">
<p><strong>switch 语句用于基于不同条件执行不同动作。</strong></p>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_switch">运行实例</a></p>
</div>
