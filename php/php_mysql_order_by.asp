...
<li class="currentLink"><a href="php_mysql_order_by.asp" title="PHP MySQL Order By 关键词">MySQL Order By</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_mysql_where.asp" title="PHP MySQL Where 子句">MySQL Where</a></li>
<li class="next"><a href="php_mysql_update.asp" title="PHP MySQL Update">MySQL Update</a></li>
</ul>
</div>
...
<p class="note"><span>注释：</span>SQL 对大小写不敏感。ORDER BY 与 order by 等效。</p>
