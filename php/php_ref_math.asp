...
<li class="currentLink"><a href="php_ref_math.asp" title="PHP Math 函数">PHP Math</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_ref_mail.asp" title="PHP Mail 函数">PHP Mail</a></li>
<li class="next"><a href="php_ref_mysql.asp" title="PHP MySQL 函数">PHP MySQL</a></li>
</ul>
</div>
