...
<li class="currentLink"><a href="php_date.asp" title="PHP Date()">PHP 日期</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_arrays_multi.asp" title="PHP 多维数组">PHP 多维数组</a></li>
<li class="next"><a href="php_includes.asp" title="PHP Include 文件">PHP Include</a></li>
</ul>
</div>
...
<tr>
<td>timestamp</td>
<td>可选。规定时间戳。默认是当前时间和日期。</td>
</tr>
</table>

<p class="note"><span>注释：</span>时间戳是一种字符序列，它表示具体事件发生的日期和事件。</p>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_date1">运行实例</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_date_copyright">运行实例</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_date2">运行实例</a></p>

<p class="note"><span>注释：</span>请注意 PHP date() 函数会返回服务器的当前日期/时间！</p>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_date3">运行实例</a></p>
</div>


<div>
<h2>通过 PHP mktime() 创建日期</h2>
...
<pre>mktime(hour,minute,second,month,day,year)</pre>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_date4">运行实例</a></p>
</div>


<div>
<h2>通过 PHP strtotime() 用字符串来创建日期</h2>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_date5">运行实例</a></p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_date6">运行实例</a></p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_date7">运行实例</a></p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_date8">运行实例</a></p>
</div>


<div>
<h2>完整的 PHP 日期参考手册</h2>

<p>如需所有日期函数的完整手册，请访问我们的 <a href="php_ref_date.asp" title="PHP Date / Time 函数">PHP 日期参考手册</a>。</p>

<p>该手册包含每个函数的简要描述以及使用示例。</p>
</div>
