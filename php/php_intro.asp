...
<li class="currentLink"><a href="php_intro.asp" title="PHP 简介">PHP 简介</a></li>
...
<li class="next"><a href="php_install.asp" title="PHP 安装">PHP 安装</a></li>
</ul>
</div>
...
<div>
<h2>PHP 是一门令人惊叹的流行语言！</h2>

<ul>
<li>它强大到足以成为在网络上最大的博客系统的核心（WordPress）！</li>
<li>它深邃到足以运行最大的社交网络（facebook）！</li>
<li>而它的易用程度足以成为初学者的首选服务器端语言！</li>
</ul>
</div>
...
<li>PHP 支持多种数据库</li>
<li>PHP 是免费的。请从官方 PHP 资源下载：<a  href="../../www.php.net/default.htm">www.php.net</a></li>
