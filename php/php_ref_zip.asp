...
<li class="currentLink"><a href="php_ref_zip.asp" title="PHP Zip File 函数">PHP Zip</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_ref_xml.asp" title="PHP XML Parser 函数">PHP XML</a></li>
<li class="next"><a href="php_ref_misc.asp" title="PHP 杂项函数">PHP 杂项</a></li>
</ul>
</div>
...
<ul>
	<li>Guido Draheim 的 ZZIPlib 库：<a href="../../zziplib.sourceforge.net/download.html">下载 ZZIPlib 库</a></li>
	<li>Zip PELC 扩展：<a href="../../snaps.php.net/default.htm">下载 Zip PELC 扩展</a></li>
</ul>
