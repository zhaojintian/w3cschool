...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_mysql_insert.asp" title="PHP MySQL Insert Into">MySQL Insert</a></li>
<li class="next"><a href="php_mysql_where.asp" title="PHP MySQL Where 子句">MySQL Where</a></li>
</ul>
</div>
