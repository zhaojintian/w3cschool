...
<li class="currentLink"><a href="php_form_validation.asp" title="PHP Include 文件">PHP 表单验证</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_forms.asp" title="PHP Date()">PHP 表单处理</a></li>
<li class="next"><a href="php_form_required.asp" title="PHP 文件处理">PHP 表单必填</a></li>
</ul>
</div>


<div id="intro">
<p><strong>本节和下一节讲解如何使用 PHP 来验证表单数据。</strong></p>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_form_validation_escapechar">运行实例</a></p>
