...
<li class="currentLink"><a href="php_arrays_sort.asp" title="PHP 数组排序">PHP 数组排序</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_arrays.asp" title="PHP 数组">PHP 数组</a></li>
<li class="next"><a href="php_superglobals.asp" title="PHP 超全局变量">PHP 超全局</a></li>
</ul>
</div>


<div id="intro">
<p><strong>数组中的元素能够以字母或数字顺序进行升序或降序排序。</strong></p>
</div>
...
<div>
<h2>对数组进行升序排序 - sort()</h2>

<p>下面的例子按照字母升序对数组 $cars 中的元素进行排序：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_array_sort_alpha">运行实例</a></p>

<p>下面的例子按照数字升序对数组 $numbers 中的元素进行排序：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_array_sort_num">运行实例</a></p>
</div>


<div>
<h2>对数组进行降序排序 - rsort()</h2>

<p>下面的例子按照字母降序对数组 $cars 中的元素进行排序：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_array_rsort_alpha">运行实例</a></p>

<p>下面的例子按照数字降序对数组 $numbers 中的元素进行排序：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_array_rsort_num">运行实例</a></p>
</div>


<div>
<h2>根据值对数组进行升序排序 - asort()</h2>

<p>下面的例子根据值对关联数组进行升序排序：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_array_asort">运行实例</a></p>
</div>


<div>
<h2>根据键对数组进行升序排序 - ksort()</h2>

<p>下面的例子根据键对关联数组进行升序排序：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_array_ksort">运行实例</a></p>
</div>


<div>
<h2>根据值对数组进行降序排序 - arsort()</h2>

<p>下面的例子根据值对关联数组进行降序排序：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_array_arsort">运行实例</a></p>
</div>


<div>
<h2>根据键对数组进行降序排序 - krsort()</h2>

<p>下面的例子根据键对关联数组进行降序排序：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_array_krsort">运行实例</a></p>
</div>


<div>
<h2>完整的 PHP 数组参考手册</h2>

<p>如需完整的数组函数参考手册，请访问我们的 <a href="php_ref_array.asp" title="PHP Array 函数">PHP 数组参考手册</a>。</p>

<p>该参考手册包含每个函数的简要描述、使用示例。</p>
</div>
