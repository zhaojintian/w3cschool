...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_ref_mysql.asp" title="PHP MySQL 函数">PHP MySQL</a></li>
<li class="next"><a href="php_ref_simplexml.asp" title="PHP SimpleXML 函数">PHP SimpleXML</a></li>
</ul>
</div>
...
<p>如需安装细节，请访问：<a href="../../www.php.net/manual/zh/mysqli.installation.php" >http://www.php.net/manual/zh/mysqli.installation.php</a></p>

<p>如需运行时配置细节，请访问：<a href="../../www.php.net/manual/zh/mysqli.configuration.php" >http://www.php.net/manual/zh/mysqli.configuration.php</a></p>
</div>
