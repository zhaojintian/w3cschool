...
<li class="currentLink"><a href="php_ref_error.asp" title="PHP Error 和 Logging 函数">PHP Error</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_ref_directory.asp" title="PHP Directory 函数">PHP Directory</a></li>
<li class="next"><a href="php_ref_filesystem.asp" title="PHP Filesystem 函数">PHP Filesystem</a></li>
</ul>
</div>
