...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_ref_date.asp" title="PHP Date / Time 函数">PHP Date</a></li>
<li class="next"><a href="php_ref_error.asp" title="PHP Error 和 Logging 函数">PHP Error</a></li>
</ul>
</div>
