...
<li class="currentLink"><a href="php_ref_filter.asp" title="PHP Filter 函数">PHP Filter</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_ref_filesystem.asp" title="PHP Filesystem 函数">PHP Filesystem</a></li>
<li class="next"><a href="php_ref_ftp.asp" title="PHP FTP 函数">PHP FTP</a></li>
</ul>
</div>
