...
<li class="currentLink"><a href="php_arrays.asp" title="PHP 数组">PHP 数组</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_functions.asp" title="PHP 函数">PHP 函数</a></li>
<li class="next"><a href="php_arrays_sort.asp" title="PHP 数组排序">PHP 数组排序</a></li>
</ul>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_array_num">运行实例</a></p>
</div>
...
<p>如果您有一个项目列表（例如汽车品牌列表），在单个变量中存储这些品牌名称是这样的：</p>
...
<p>不过，假如您希望对变量进行遍历并找出特定的那个值？或者如果您需要存储 300 个汽车品牌，而不是 3 个呢？</p>

<p>解决方法是创建数组！</p>

<p>数组能够在单一变量名中存储许多值，并且您能够通过引用下标号来访问某个值。</p>
</div>
...
<ul>
<li><em>索引数组</em> - 带有数字索引的数组</li>
<li><em>关联数组</em> - 带有指定键的数组</li>
<li><em>多维数组</em> - 包含一个或多个数组的数组</li>
</ul>
</div>
...
<p>索引是自动分配的（索引从 0 开始）：</p>

<pre>$cars=array(&quot;Volvo&quot;,&quot;BMW&quot;,&quot;SAAB&quot;);</pre>
...
<p>下面的例子创建名为 $cars 的索引数组，为其分配三个元素，然后输出包含数组值的一段文本：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_array_length">运行实例</a></p>
</div>
...
<p>如需遍历并输出索引数组的所有值，您可以使用 for 循环，就像这样：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_array_num_loop">运行实例</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_array_assoc">运行实例</a></p>
</div>
...
<p>如需遍历并输出关联数组的所有值，您可以使用 foreach 循环，就像这样：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_array_assoc_loop">运行实例</a></p>
</div>
