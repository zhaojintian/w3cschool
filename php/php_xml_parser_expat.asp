...
<h2>PHP XML</h2>
<ul>
<li class="currentLink"><a href="php_xml_parser_expat.asp" title="PHP XML Expat 解析器">XML Expat Parser</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_db_odbc.asp" title="PHP Database ODBC">PHP ODBC</a></li>
<li class="next"><a href="php_xml_dom.asp" title="PHP XML DOM">XML DOM</a></li>
</ul>
</div>
