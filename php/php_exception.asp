...
<li class="currentLink"><a href="php_exception.asp" title="PHP 异常处理">PHP Exception</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_error.asp" title="PHP 错误处理">PHP Error</a></li>
<li class="next"><a href="php_filter.asp" title="PHP 过滤器（Filter）">PHP Filter</a></li>
</ul>
</div>
