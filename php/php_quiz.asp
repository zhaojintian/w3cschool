...
<h2>PHP 测验</h2>
<ul>
<li class="currentLink"><a href="php_quiz.asp" title="PHP 测验">PHP 测验</a></li>
</ul>
</div><div id="selected">
<h2>建站手册</h2>
<ul>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_ref_misc.asp" title="PHP 杂项函数">PHP 杂项</a></li>
<li class="next"><a href="index.asp" title="PHP 教程">PHP 教程</a></li>
</ul>
</div>
