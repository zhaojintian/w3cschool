...
<li class="currentLink"><a href="php_datatypes.asp" title="PHP 数据类型">PHP 数据类型</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_echo_print.asp" title="PHP Echo 和 Print 语句">PHP Echo / Print</a></li>
<li class="next"><a href="php_string.asp" title="PHP 字符串函数">PHP 字符串函数</a></li>
</ul>
</div>


<div id="intro">
<p><strong>字符串、整数、浮点数、逻辑、数组、对象、NULL。</strong></p>
</div>
...
<p>字符串可以是引号内的任何文本。您可以使用单引号或双引号：</p>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_datatypes_string">运行实例</a></p>
</div>
...
<p>在下面的例子中，我们将测试不同的数字。PHP var_dump() 会返回变量的数据类型和值：</p>
...
var_dump($x);
echo &quot;&lt;br&gt;&quot;; 
$x = -345; <span class="code_comment">// 负数</span>
var_dump($x);
echo &quot;&lt;br&gt;&quot;; 
$x = 0x8C; <span class="code_comment">// 十六进制数</span>
var_dump($x);
echo &quot;&lt;br&gt;&quot;;
$x = 047; <span class="code_comment">// 八进制数</span>
var_dump($x);
?&gt;
</pre>

<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_datatypes_integer">运行实例</a></p>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_datatypes_float">运行实例</a></p>
</div>
...
<p>逻辑常用于条件测试。您将在本教程稍后的章节学到更多有关条件测试的知识。</p>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_datatypes_array">运行实例</a></p>

<p>您将在本教程稍后的章节学到更多有关数组的知识。</p>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_datatypes_object">运行实例</a></p>

<p>您将在本教程稍后的章节学到更多有关对象的知识。</p>
</div>
...
<p class="tiy"><a  href="../tiy/s.asp@f=demo_php_datatypes_null">运行实例</a></p>
</div>
