...
<li class="currentLink"><a href="php_mysql_where.asp" title="PHP MySQL Where 子句">MySQL Where</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_mysql_select.asp" title="PHP MySQL Select">MySQL Select</a></li>
<li class="next"><a href="php_mysql_order_by.asp" title="PHP MySQL Order By 关键词">MySQL Order By</a></li>
</ul>
</div>
