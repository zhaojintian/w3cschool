...
<li class="currentLink"><a href="xsl_summary.asp" title="您已经学习了 XSLT，下一步呢？">XSLT 教程总结</a></li>
</ul>
<h2>XSLT 参考手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xsl_editors.asp" title="XSLT 编辑器">XSLT 编辑器</a></li>
<li class="next"><a href="xsl_w3celementref.asp" title="XSLT 元素参考手册">XSLT 元素</a></li>
</ul>
</div>
