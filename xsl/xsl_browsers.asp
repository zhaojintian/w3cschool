...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>XSLT 浏览器</TITLE>
...
<UL>
  ...
  <LI class=currentLink><A title="对 XSLT 的浏览器支持" href="xsl_browsers.asp">XSLT 
  浏览器</A> 
...
<DIV id=tpn>
<UL class=prenext>
  <LI class=pre><A title="XSLT 简介" href="xsl_intro.asp">XSLT 简介</A> </LI>
  <LI class=next><A title="XSLT - 转换" href="xsl_transformation.asp">XSLT 转换</A> 
  </LI></UL></DIV>
<DIV id=intro>
<P><STRONG>几乎所有主要的浏览器均支持 XML 和 XSLT。</STRONG></P></DIV>
<DIV>
<H2>Mozilla Firefox</H2>
<P>从 1.0.2 版本开始，Firefox 就已开始支持 XML 和 XSLT（以及 CSS）。</P></DIV>
<DIV>
<H2>Mozilla</H2>
<P>Mozilla 含有用于 XML 解析的 Expat，并支持 XML + CSS。Mozilla 同样支持命名空间。</P>
<P>Mozilla 可执行 XSLT。</P></DIV>
<DIV>
<H2>Netscape</H2>
<P>从版本 8 开始，Netscape 就开始使用 Mozilla 引擎，所以它对 XML / XSLT 的支持与Mozilla是相同的。</P></DIV>
<DIV>
<H2>Opera</H2>
<P>从版本 9 开始，Opera 已开始支持 XML 和 XSLT（以及 CSS）。版本 8 仅支持 XML + CSS。</P></DIV>
<DIV>
<H2>Internet Explorer</H2>
<P>从版本 6 开始，Internet Explorer 已开始 XML、命名空间、CSS、XSLT 以及 XPath。</P>
<P>版本 5 <EM>不兼容</EM>官方的 W3C XSL 标准。</P></DIV>
<DIV id=bpn>
<UL class=prenext>
  <LI class=pre><A title="XSLT 简介" href="xsl_intro.asp">XSLT 简介</A> </LI>
  <LI class=next><A title="XSLT - 转换" href="xsl_transformation.asp">XSLT 转换</A> 
